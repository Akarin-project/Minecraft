...
public final class BiomeFrozenOcean extends BiomeBase {
    ...
    public BiomeFrozenOcean() {
        super((new BiomeBase.a()).a(new WorldGenSurfaceComposite(aD, ai)).a(BiomeBase.Precipitation.SNOW).a(BiomeBase.Geography.OCEAN).a(-1.0F).b(0.1F).c(0.0F).d(0.5F).a(3750089).b(329011).a((String)null));
