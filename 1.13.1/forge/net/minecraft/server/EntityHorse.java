...
public class EntityHorse extends EntityHorseAbstract {
    ...
    protected void x_() {
        super.x_();
        this.datawatcher.register(bN, 0);
        this.datawatcher.register(bO, EnumHorseArmor.NONE.a());
    }
    ...
    public void setVariant(int i) {
        this.datawatcher.set(bN, i);
        this.eg();
    }

    public int getVariant() {
        return this.datawatcher.get(bN);
    }
    ...
    public void h(ItemStack itemstack) {
        ...
        this.datawatcher.set(bO, enumhorsearmor.a());
        this.eg();
        if (!this.world.isClientSide) {
            this.getAttributeInstance(GenericAttributes.h).b(bM);
            int i = enumhorsearmor.c();
            if (i != 0) {
                this.getAttributeInstance(GenericAttributes.h).b((new AttributeModifier(bM, "Horse armor bonus", (double)i, 0)).a(false));
            }
        }
    ...
    public EnumHorseArmor dH() {
        return EnumHorseArmor.a(this.datawatcher.get(bO));
    }
    ...
    protected void initAttributes() {
        ...
        this.getAttributeInstance(attributeJumpStrength).setValue(this.ed());
    }
    ...
    public boolean mate(EntityAnimal entityanimal) {
        if (entityanimal == this) {
            return false;
        } else if (!(entityanimal instanceof EntityHorseDonkey) && !(entityanimal instanceof EntityHorse)) {
            return false;
        } else {
            return this.eb() && ((EntityHorseAbstract)entityanimal).eb();
        }
    }
    ...
    public EntityAgeable createChild(EntityAgeable entityageable) {
        ...
        if (entityageable instanceof EntityHorseDonkey) {
            ...
            if (k < 2) {
                ...
                i = i | entityhorse1.getVariant() & '\uff00';
            } else {
                i = i | this.random.nextInt(5) << 8 & '\uff00';
            }

            ((EntityHorse)object).setVariant(i);
        }
