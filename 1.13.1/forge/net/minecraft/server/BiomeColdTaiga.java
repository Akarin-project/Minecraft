...
public final class BiomeColdTaiga extends BiomeBase {
    public BiomeColdTaiga() {
        super((new BiomeBase.a()).a(new WorldGenSurfaceComposite(au, ai)).a(BiomeBase.Precipitation.SNOW).a(BiomeBase.Geography.TAIGA).a(0.2F).b(0.2F).c(-0.5F).d(0.4F).a(4020182).b(329011).a((String)null));
        this.a(WorldGenerator.j, new WorldGenFeatureIglooConfiguration());
        ...
        this.a(WorldGenStage.Decoration.VEGETAL_DECORATION, a(WorldGenerator.L, WorldGenFeatureConfiguration.e, j, new WorldGenDecoratorFrequencyConfiguration(1)));
        this.a(WorldGenStage.Decoration.VEGETAL_DECORATION, a(WorldGenerator.ah, new WorldGenFeatureMushroomConfiguration(Blocks.BROWN_MUSHROOM), y, new WorldGenDecoratorFrequencyChanceConfiguration(1, 0.25F)));
        this.a(WorldGenStage.Decoration.VEGETAL_DECORATION, a(WorldGenerator.ah, new WorldGenFeatureMushroomConfiguration(Blocks.RED_MUSHROOM), z, new WorldGenDecoratorFrequencyChanceConfiguration(1, 0.125F)));
