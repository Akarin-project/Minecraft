...
public final class BiomeIcePlainsSpikes extends BiomeBase {
    public BiomeIcePlainsSpikes() {
        super((new BiomeBase.a()).a(new WorldGenSurfaceComposite(au, new WorldGenSurfaceConfigurationBase(Blocks.SNOW_BLOCK.getBlockData(), Blocks.DIRT.getBlockData(), Blocks.GRAVEL.getBlockData()))).a(BiomeBase.Precipitation.SNOW).a(BiomeBase.Geography.ICY).a(0.425F).b(0.45000002F).c(0.0F).d(0.5F).a(4159204).b(329011).a("snowy_tundra"));
        ...
        this.a(WorldGenStage.Decoration.SURFACE_STRUCTURES, a(WorldGenerator.V, WorldGenFeatureConfiguration.e, g, new WorldGenDecoratorFrequencyConfiguration(3)));
        this.a(WorldGenStage.Decoration.SURFACE_STRUCTURES, a(WorldGenerator.al, new WorldGenFeatureRadiusConfiguration(2), g, new WorldGenDecoratorFrequencyConfiguration(2)));
        ...
        this.a(WorldGenStage.Decoration.VEGETAL_DECORATION, a(WorldGenerator.A, WorldGenFeatureConfiguration.e, s, new WorldGenDecoratorFrequencyExtraChanceConfiguration(0, 0.1F, 1)));
