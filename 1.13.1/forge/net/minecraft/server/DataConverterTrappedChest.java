            ...
            if (!(type4 instanceof ListType)) {
                ...
                return TypeRewriteRule.seq((new DataConverterAddChoices(this.getOutputSchema(), "AddTrappedChestFix", DataConverterTypes.j)).makeRule(), this.fixTypeEverywhereTyped("Trapped Chest fix", type3, (typed) -> {
                    return typed.updateTyped(opticfinder1, (typed1) -> {
                        Optional optional = typed1.getOptionalTyped(opticfinder2);
                        if (!optional.isPresent()) {
                            ...
                            for(Typed typed2 : list) {
                                DataConverterTrappedChest.a dataconvertertrappedchest$a = new DataConverterTrappedChest.a(typed2, this.getInputSchema());
                                if (!dataconvertertrappedchest$a.b()) {
                                    for(int i = 0; i < 4096; ++i) {
                                        int j = dataconvertertrappedchest$a.c(i);
                                        if (dataconvertertrappedchest$a.a(j)) {
                                            intopenhashset.add(dataconvertertrappedchest$a.c() << 12 | i);
                                        }
                                    }
                                }
                            }
                            ...
                            return typed1.updateTyped(opticfinder, (typed3) -> {
                                return typed3.updateTyped(taggedchoicetype.finder(), (typed4) -> {
                                    ...
                                    int i2 = dynamic1.getInt("x") - (k << 4);
                                    int j2 = dynamic1.getInt("y");
                                    int k2 = dynamic1.getInt("z") - (l << 4);
                                    return intopenhashset.contains(DataConverterLeaves.a(i2, j2, k2)) ? typed4.update(taggedchoicetype.finder(), (pair) -> {
