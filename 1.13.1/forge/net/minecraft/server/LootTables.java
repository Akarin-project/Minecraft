...
public class LootTables {
    ...
    private static final Set<MinecraftKey> aU = Collections.unmodifiableSet(aT);
    ...
    private static MinecraftKey a(String sx) {
        return a(new MinecraftKey(sx));
    }

    public static MinecraftKey a(MinecraftKey minecraftkey) {
        if (aT.add(minecraftkey)) {
            return minecraftkey;
        } else {
