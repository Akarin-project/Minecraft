...
public class WorldGenStrongholdPieces {
    ...
    public static void b() {
        ...
        for(WorldGenStrongholdPieces.WorldGenStrongholdPieceWeight worldgenstrongholdpieces$worldgenstrongholdpieceweight : a) {
            worldgenstrongholdpieces$worldgenstrongholdpieceweight.c = 0;
            b.add(worldgenstrongholdpieces$worldgenstrongholdpieceweight);
        }
    ...
    private static boolean d() {
        ...
        for(WorldGenStrongholdPieces.WorldGenStrongholdPieceWeight worldgenstrongholdpieces$worldgenstrongholdpieceweight : b) {
            ...
            d += worldgenstrongholdpieces$worldgenstrongholdpieceweight.b;
        }
    ...
    private static WorldGenStrongholdPieces.WorldGenStrongholdPiece b(WorldGenStrongholdPieces.WorldGenStrongholdStart worldgenstrongholdpieces$worldgenstrongholdstart, List<StructurePiece> list, Random random, int i, int j, int k, EnumDirection enumdirection, int l) {
        if (!d()) {
            return null;
        } else {
            if (c != null) {
                WorldGenStrongholdPieces.WorldGenStrongholdPiece worldgenstrongholdpieces$worldgenstrongholdpiece = a(c, list, random, i, j, k, enumdirection, l);
                c = null;
            ...
            while(j1 < 5) {
                ++j1;
                int i1 = random.nextInt(d);

                for(WorldGenStrongholdPieces.WorldGenStrongholdPieceWeight worldgenstrongholdpieces$worldgenstrongholdpieceweight : b) {
                    i1 -= worldgenstrongholdpieces$worldgenstrongholdpieceweight.b;
                    if (i1 < 0) {
                        if (!worldgenstrongholdpieces$worldgenstrongholdpieceweight.a(l) || worldgenstrongholdpieces$worldgenstrongholdpieceweight == worldgenstrongholdpieces$worldgenstrongholdstart.a) {
                            break;
                        }

                        WorldGenStrongholdPieces.WorldGenStrongholdPiece worldgenstrongholdpieces$worldgenstrongholdpiece1 = a(worldgenstrongholdpieces$worldgenstrongholdpieceweight.a, list, random, i, j, k, enumdirection, l);
                        if (worldgenstrongholdpieces$worldgenstrongholdpiece1 != null) {
                            ++worldgenstrongholdpieces$worldgenstrongholdpieceweight.c;
                            worldgenstrongholdpieces$worldgenstrongholdstart.a = worldgenstrongholdpieces$worldgenstrongholdpieceweight;
                            if (!worldgenstrongholdpieces$worldgenstrongholdpieceweight.a()) {
                                b.remove(worldgenstrongholdpieces$worldgenstrongholdpieceweight);
                            }
    ...
    private static StructurePiece c(WorldGenStrongholdPieces.WorldGenStrongholdStart worldgenstrongholdpieces$worldgenstrongholdstart, List<StructurePiece> list, Random random, int i, int j, int k, @Nullable EnumDirection enumdirection, int l) {
        if (l > 50) {
            return null;
        } else if (Math.abs(i - worldgenstrongholdpieces$worldgenstrongholdstart.d().a) <= 112 && Math.abs(k - worldgenstrongholdpieces$worldgenstrongholdstart.d().c) <= 112) {
            WorldGenStrongholdPieces.WorldGenStrongholdPiece worldgenstrongholdpieces$worldgenstrongholdpiece = b(worldgenstrongholdpieces$worldgenstrongholdstart, list, random, i, j, k, enumdirection, l + 1);
            if (worldgenstrongholdpieces$worldgenstrongholdpiece != null) {
                list.add(worldgenstrongholdpieces$worldgenstrongholdpiece);
                worldgenstrongholdpieces$worldgenstrongholdstart.c.add(worldgenstrongholdpieces$worldgenstrongholdpiece);
            }
    ...
    public static class WorldGenStrongholdChestCorridor extends WorldGenStrongholdPieces.WorldGenStrongholdPiece {
        ...
        public boolean a(GeneratorAccess generatoraccess, Random random, StructureBoundingBox structureboundingbox, ChunkCoordIntPair var4) {
            ...
            if (!this.a && structureboundingbox.b(new BlockPosition(this.a(3, 3), this.d(2), this.b(3, 3)))) {
                this.a = true;
    ...
    public static class WorldGenStrongholdCorridor extends WorldGenStrongholdPieces.WorldGenStrongholdPiece {
        ...
        public WorldGenStrongholdCorridor(int i, Random var2, StructureBoundingBox structureboundingbox, EnumDirection enumdirection) {
            super(i);
            this.a(enumdirection);
            this.n = structureboundingbox;
    ...
    public static class WorldGenStrongholdCrossing extends WorldGenStrongholdPieces.WorldGenStrongholdPiece {
        ...
        public boolean a(GeneratorAccess generatoraccess, Random random, StructureBoundingBox structureboundingbox, ChunkCoordIntPair var4) {
            ...
            if (this.a) {
                this.a(generatoraccess, structureboundingbox, 0, 3, 1, 0, 5, 3, m, m, false);
            }

            if (this.c) {
                this.a(generatoraccess, structureboundingbox, 9, 3, 1, 9, 5, 3, m, m, false);
            }

            if (this.b) {
                this.a(generatoraccess, structureboundingbox, 0, 5, 7, 0, 7, 9, m, m, false);
            }

            if (this.e) {
                this.a(generatoraccess, structureboundingbox, 9, 5, 7, 9, 7, 9, m, m, false);
            }

            this.a(generatoraccess, structureboundingbox, 5, 1, 10, 7, 3, 10, m, m, false);
    ...
    public static class WorldGenStrongholdLeftTurn extends WorldGenStrongholdPieces.WorldGenStrongholdPiece {
        ...
        public boolean a(GeneratorAccess generatoraccess, Random random, StructureBoundingBox structureboundingbox, ChunkCoordIntPair var4) {
            ...
            EnumDirection enumdirection = this.f();
            if (enumdirection != EnumDirection.NORTH && enumdirection != EnumDirection.EAST) {
                this.a(generatoraccess, structureboundingbox, 4, 1, 1, 4, 3, 3, m, m, false);
            } else {
                this.a(generatoraccess, structureboundingbox, 0, 1, 1, 0, 3, 3, m, m, false);
            }
    ...
    public static class WorldGenStrongholdLibrary extends WorldGenStrongholdPieces.WorldGenStrongholdPiece {
        ...
        public boolean a(GeneratorAccess generatoraccess, Random random, StructureBoundingBox structureboundingbox, ChunkCoordIntPair var4) {
            ...
            for(int k = 3; k < 12; k += 2) {
                this.a(generatoraccess, structureboundingbox, 3, 1, k, 4, 3, k, Blocks.BOOKSHELF.getBlockData(), Blocks.BOOKSHELF.getBlockData(), false);
                this.a(generatoraccess, structureboundingbox, 6, 1, k, 7, 3, k, Blocks.BOOKSHELF.getBlockData(), Blocks.BOOKSHELF.getBlockData(), false);
                this.a(generatoraccess, structureboundingbox, 9, 1, k, 10, 3, k, Blocks.BOOKSHELF.getBlockData(), Blocks.BOOKSHELF.getBlockData(), false);
            }
            ...
            if (this.a) {
                ...
                IBlockData iblockdata5 = (IBlockData)((IBlockData)Blocks.OAK_FENCE.getBlockData().set(BlockFence.WEST, Boolean.valueOf(true))).set(BlockFence.EAST, Boolean.valueOf(true));
                IBlockData iblockdata = (IBlockData)((IBlockData)Blocks.OAK_FENCE.getBlockData().set(BlockFence.NORTH, Boolean.valueOf(true))).set(BlockFence.SOUTH, Boolean.valueOf(true));
                this.a(generatoraccess, structureboundingbox, 3, 6, 3, 3, 6, 11, iblockdata, iblockdata, false);
                this.a(generatoraccess, structureboundingbox, 10, 6, 3, 10, 6, 9, iblockdata, iblockdata, false);
                this.a(generatoraccess, structureboundingbox, 4, 6, 2, 9, 6, 2, iblockdata5, iblockdata5, false);
                this.a(generatoraccess, structureboundingbox, 4, 6, 12, 7, 6, 12, iblockdata5, iblockdata5, false);
                this.a(generatoraccess, (IBlockData)((IBlockData)Blocks.OAK_FENCE.getBlockData().set(BlockFence.NORTH, Boolean.valueOf(true))).set(BlockFence.EAST, Boolean.valueOf(true)), 3, 6, 2, structureboundingbox);
                this.a(generatoraccess, (IBlockData)((IBlockData)Blocks.OAK_FENCE.getBlockData().set(BlockFence.SOUTH, Boolean.valueOf(true))).set(BlockFence.EAST, Boolean.valueOf(true)), 3, 6, 12, structureboundingbox);
                this.a(generatoraccess, (IBlockData)((IBlockData)Blocks.OAK_FENCE.getBlockData().set(BlockFence.NORTH, Boolean.valueOf(true))).set(BlockFence.WEST, Boolean.valueOf(true)), 10, 6, 2, structureboundingbox);

                for(int j = 0; j <= 2; ++j) {
                    this.a(generatoraccess, (IBlockData)((IBlockData)Blocks.OAK_FENCE.getBlockData().set(BlockFence.SOUTH, Boolean.valueOf(true))).set(BlockFence.WEST, Boolean.valueOf(true)), 8 + j, 6, 12 - j, structureboundingbox);
                    if (j != 2) {
                        this.a(generatoraccess, (IBlockData)((IBlockData)Blocks.OAK_FENCE.getBlockData().set(BlockFence.NORTH, Boolean.valueOf(true))).set(BlockFence.EAST, Boolean.valueOf(true)), 8 + j, 6, 11 - j, structureboundingbox);
                    }
                }

                IBlockData iblockdata6 = (IBlockData)Blocks.LADDER.getBlockData().set(BlockLadder.FACING, EnumDirection.SOUTH);
                this.a(generatoraccess, iblockdata6, 10, 1, 13, structureboundingbox);
                this.a(generatoraccess, iblockdata6, 10, 2, 13, structureboundingbox);
                this.a(generatoraccess, iblockdata6, 10, 3, 13, structureboundingbox);
                this.a(generatoraccess, iblockdata6, 10, 4, 13, structureboundingbox);
                this.a(generatoraccess, iblockdata6, 10, 5, 13, structureboundingbox);
                this.a(generatoraccess, iblockdata6, 10, 6, 13, structureboundingbox);
                this.a(generatoraccess, iblockdata6, 10, 7, 13, structureboundingbox);
                boolean flag2 = true;
                boolean flag3 = true;
                IBlockData iblockdata1 = (IBlockData)Blocks.OAK_FENCE.getBlockData().set(BlockFence.EAST, Boolean.valueOf(true));
                this.a(generatoraccess, iblockdata1, 6, 9, 7, structureboundingbox);
                IBlockData iblockdata2 = (IBlockData)Blocks.OAK_FENCE.getBlockData().set(BlockFence.WEST, Boolean.valueOf(true));
                this.a(generatoraccess, iblockdata2, 7, 9, 7, structureboundingbox);
                this.a(generatoraccess, iblockdata1, 6, 8, 7, structureboundingbox);
                this.a(generatoraccess, iblockdata2, 7, 8, 7, structureboundingbox);
                IBlockData iblockdata3 = (IBlockData)((IBlockData)iblockdata.set(BlockFence.WEST, Boolean.valueOf(true))).set(BlockFence.EAST, Boolean.valueOf(true));
                this.a(generatoraccess, iblockdata3, 6, 7, 7, structureboundingbox);
                this.a(generatoraccess, iblockdata3, 7, 7, 7, structureboundingbox);
                this.a(generatoraccess, iblockdata1, 5, 7, 7, structureboundingbox);
                this.a(generatoraccess, iblockdata2, 8, 7, 7, structureboundingbox);
                this.a(generatoraccess, (IBlockData)iblockdata1.set(BlockFence.NORTH, Boolean.valueOf(true)), 6, 7, 6, structureboundingbox);
                this.a(generatoraccess, (IBlockData)iblockdata1.set(BlockFence.SOUTH, Boolean.valueOf(true)), 6, 7, 8, structureboundingbox);
                this.a(generatoraccess, (IBlockData)iblockdata2.set(BlockFence.NORTH, Boolean.valueOf(true)), 7, 7, 6, structureboundingbox);
                this.a(generatoraccess, (IBlockData)iblockdata2.set(BlockFence.SOUTH, Boolean.valueOf(true)), 7, 7, 8, structureboundingbox);
                IBlockData iblockdata4 = Blocks.TORCH.getBlockData();
                this.a(generatoraccess, iblockdata4, 5, 8, 7, structureboundingbox);
                this.a(generatoraccess, iblockdata4, 8, 8, 7, structureboundingbox);
                this.a(generatoraccess, iblockdata4, 6, 8, 6, structureboundingbox);
                this.a(generatoraccess, iblockdata4, 6, 8, 8, structureboundingbox);
                this.a(generatoraccess, iblockdata4, 7, 8, 6, structureboundingbox);
                this.a(generatoraccess, iblockdata4, 7, 8, 8, structureboundingbox);
            }

            this.a(generatoraccess, structureboundingbox, random, 3, 3, 5, LootTables.h);
            if (this.a) {
                this.a(generatoraccess, m, 12, 9, 1, structureboundingbox);
    ...
    abstract static class WorldGenStrongholdPiece extends StructurePiece {
        ...
        protected void a(GeneratorAccess generatoraccess, Random var2, StructureBoundingBox structureboundingbox, WorldGenStrongholdPieces.WorldGenStrongholdPiece.WorldGenStrongholdDoorType worldgenstrongholdpieces$worldgenstrongholdpiece$worldgenstrongholddoortype, int i, int j, int k) {
            switch(worldgenstrongholdpieces$worldgenstrongholdpiece$worldgenstrongholddoortype) {
            case OPENING:
                this.a(generatoraccess, structureboundingbox, i, j, k, i + 3 - 1, j + 3 - 1, k, m, m, false);
                break;
            case WOOD_DOOR:
            ...
            case GRATES:
                ...
                this.a(generatoraccess, (IBlockData)Blocks.IRON_BARS.getBlockData().set(BlockIronBars.WEST, Boolean.valueOf(true)), i, j, k, structureboundingbox);
                this.a(generatoraccess, (IBlockData)Blocks.IRON_BARS.getBlockData().set(BlockIronBars.WEST, Boolean.valueOf(true)), i, j + 1, k, structureboundingbox);
                this.a(generatoraccess, (IBlockData)((IBlockData)Blocks.IRON_BARS.getBlockData().set(BlockIronBars.EAST, Boolean.valueOf(true))).set(BlockIronBars.WEST, Boolean.valueOf(true)), i, j + 2, k, structureboundingbox);
                this.a(generatoraccess, (IBlockData)((IBlockData)Blocks.IRON_BARS.getBlockData().set(BlockIronBars.EAST, Boolean.valueOf(true))).set(BlockIronBars.WEST, Boolean.valueOf(true)), i + 1, j + 2, k, structureboundingbox);
                this.a(generatoraccess, (IBlockData)((IBlockData)Blocks.IRON_BARS.getBlockData().set(BlockIronBars.EAST, Boolean.valueOf(true))).set(BlockIronBars.WEST, Boolean.valueOf(true)), i + 2, j + 2, k, structureboundingbox);
                this.a(generatoraccess, (IBlockData)Blocks.IRON_BARS.getBlockData().set(BlockIronBars.EAST, Boolean.valueOf(true)), i + 2, j + 1, k, structureboundingbox);
                this.a(generatoraccess, (IBlockData)Blocks.IRON_BARS.getBlockData().set(BlockIronBars.EAST, Boolean.valueOf(true)), i + 2, j, k, structureboundingbox);
                break;
            case IRON_DOOR:
                this.a(generatoraccess, Blocks.STONE_BRICKS.getBlockData(), i, j, k, structureboundingbox);
                this.a(generatoraccess, Blocks.STONE_BRICKS.getBlockData(), i, j + 1, k, structureboundingbox);
        ...
        @Nullable
        protected StructurePiece a(WorldGenStrongholdPieces.WorldGenStrongholdStart worldgenstrongholdpieces$worldgenstrongholdstart, List<StructurePiece> list, Random random, int i, int j) {
            EnumDirection enumdirection = this.f();
            if (enumdirection != null) {
                switch(enumdirection) {
                case NORTH:
                    return WorldGenStrongholdPieces.c(worldgenstrongholdpieces$worldgenstrongholdstart, list, random, this.n.a + i, this.n.b + j, this.n.c - 1, enumdirection, this.e());
                case SOUTH:
                    return WorldGenStrongholdPieces.c(worldgenstrongholdpieces$worldgenstrongholdstart, list, random, this.n.a + i, this.n.b + j, this.n.f + 1, enumdirection, this.e());
                case WEST:
                    return WorldGenStrongholdPieces.c(worldgenstrongholdpieces$worldgenstrongholdstart, list, random, this.n.a - 1, this.n.b + j, this.n.c + i, enumdirection, this.e());
                case EAST:
                    return WorldGenStrongholdPieces.c(worldgenstrongholdpieces$worldgenstrongholdstart, list, random, this.n.d + 1, this.n.b + j, this.n.c + i, enumdirection, this.e());
                }
            }
        ...
        @Nullable
        protected StructurePiece b(WorldGenStrongholdPieces.WorldGenStrongholdStart worldgenstrongholdpieces$worldgenstrongholdstart, List<StructurePiece> list, Random random, int i, int j) {
            EnumDirection enumdirection = this.f();
            if (enumdirection != null) {
                switch(enumdirection) {
                case NORTH:
                    return WorldGenStrongholdPieces.c(worldgenstrongholdpieces$worldgenstrongholdstart, list, random, this.n.a - 1, this.n.b + i, this.n.c + j, EnumDirection.WEST, this.e());
                case SOUTH:
                    return WorldGenStrongholdPieces.c(worldgenstrongholdpieces$worldgenstrongholdstart, list, random, this.n.a - 1, this.n.b + i, this.n.c + j, EnumDirection.WEST, this.e());
                case WEST:
                    return WorldGenStrongholdPieces.c(worldgenstrongholdpieces$worldgenstrongholdstart, list, random, this.n.a + j, this.n.b + i, this.n.c - 1, EnumDirection.NORTH, this.e());
                case EAST:
                    return WorldGenStrongholdPieces.c(worldgenstrongholdpieces$worldgenstrongholdstart, list, random, this.n.a + j, this.n.b + i, this.n.c - 1, EnumDirection.NORTH, this.e());
                }
            }
        ...
        @Nullable
        protected StructurePiece c(WorldGenStrongholdPieces.WorldGenStrongholdStart worldgenstrongholdpieces$worldgenstrongholdstart, List<StructurePiece> list, Random random, int i, int j) {
            EnumDirection enumdirection = this.f();
            if (enumdirection != null) {
                switch(enumdirection) {
                case NORTH:
                    return WorldGenStrongholdPieces.c(worldgenstrongholdpieces$worldgenstrongholdstart, list, random, this.n.d + 1, this.n.b + i, this.n.c + j, EnumDirection.EAST, this.e());
                case SOUTH:
                    return WorldGenStrongholdPieces.c(worldgenstrongholdpieces$worldgenstrongholdstart, list, random, this.n.d + 1, this.n.b + i, this.n.c + j, EnumDirection.EAST, this.e());
                case WEST:
                    return WorldGenStrongholdPieces.c(worldgenstrongholdpieces$worldgenstrongholdstart, list, random, this.n.a + j, this.n.b + i, this.n.f + 1, EnumDirection.SOUTH, this.e());
                case EAST:
                    return WorldGenStrongholdPieces.c(worldgenstrongholdpieces$worldgenstrongholdstart, list, random, this.n.a + j, this.n.b + i, this.n.f + 1, EnumDirection.SOUTH, this.e());
                }
            }
    ...
    public static class WorldGenStrongholdPortalRoom extends WorldGenStrongholdPieces.WorldGenStrongholdPiece {
        ...
        public WorldGenStrongholdPortalRoom(int i, Random var2, StructureBoundingBox structureboundingbox, EnumDirection enumdirection) {
            super(i);
            this.a(enumdirection);
            this.n = structureboundingbox;
        }
        ...
        public void a(StructurePiece structurepiece, List<StructurePiece> var2, Random var3) {
            if (structurepiece != null) {
        ...
        public boolean a(GeneratorAccess generatoraccess, Random random, StructureBoundingBox structureboundingbox, ChunkCoordIntPair var4) {
            ...
            int i = 6;
            this.a(generatoraccess, structureboundingbox, 1, i, 1, 1, i, 14, false, random, WorldGenStrongholdPieces.e);
            this.a(generatoraccess, structureboundingbox, 9, i, 1, 9, i, 14, false, random, WorldGenStrongholdPieces.e);
            this.a(generatoraccess, structureboundingbox, 2, i, 1, 8, i, 2, false, random, WorldGenStrongholdPieces.e);
            this.a(generatoraccess, structureboundingbox, 2, i, 14, 8, i, 14, false, random, WorldGenStrongholdPieces.e);
            ...
            IBlockData iblockdata = (IBlockData)((IBlockData)Blocks.IRON_BARS.getBlockData().set(BlockIronBars.NORTH, Boolean.valueOf(true))).set(BlockIronBars.SOUTH, Boolean.valueOf(true));
            IBlockData iblockdata1 = (IBlockData)((IBlockData)Blocks.IRON_BARS.getBlockData().set(BlockIronBars.WEST, Boolean.valueOf(true))).set(BlockIronBars.EAST, Boolean.valueOf(true));

            for(int j = 3; j < 14; j += 2) {
                this.a(generatoraccess, structureboundingbox, 0, 3, j, 0, 4, j, iblockdata, iblockdata, false);
                this.a(generatoraccess, structureboundingbox, 10, 3, j, 10, 4, j, iblockdata, iblockdata, false);
            }

            for(int i1 = 2; i1 < 9; i1 += 2) {
                this.a(generatoraccess, structureboundingbox, i1, 3, 15, i1, 4, 15, iblockdata1, iblockdata1, false);
            }

            IBlockData iblockdata5 = (IBlockData)Blocks.STONE_BRICK_STAIRS.getBlockData().set(BlockStairs.FACING, EnumDirection.NORTH);
            ...
            for(int k = 4; k <= 6; ++k) {
                this.a(generatoraccess, iblockdata5, k, 1, 4, structureboundingbox);
                this.a(generatoraccess, iblockdata5, k, 2, 5, structureboundingbox);
                this.a(generatoraccess, iblockdata5, k, 3, 6, structureboundingbox);
            }

            IBlockData iblockdata6 = (IBlockData)Blocks.END_PORTAL_FRAME.getBlockData().set(BlockEnderPortalFrame.FACING, EnumDirection.NORTH);
            IBlockData iblockdata2 = (IBlockData)Blocks.END_PORTAL_FRAME.getBlockData().set(BlockEnderPortalFrame.FACING, EnumDirection.SOUTH);
            IBlockData iblockdata3 = (IBlockData)Blocks.END_PORTAL_FRAME.getBlockData().set(BlockEnderPortalFrame.FACING, EnumDirection.EAST);
            IBlockData iblockdata4 = (IBlockData)Blocks.END_PORTAL_FRAME.getBlockData().set(BlockEnderPortalFrame.FACING, EnumDirection.WEST);
            boolean flag = true;
            ...
            this.a(generatoraccess, (IBlockData)iblockdata6.set(BlockEnderPortalFrame.EYE, Boolean.valueOf(aboolean[0])), 4, 3, 8, structureboundingbox);
            this.a(generatoraccess, (IBlockData)iblockdata6.set(BlockEnderPortalFrame.EYE, Boolean.valueOf(aboolean[1])), 5, 3, 8, structureboundingbox);
            this.a(generatoraccess, (IBlockData)iblockdata6.set(BlockEnderPortalFrame.EYE, Boolean.valueOf(aboolean[2])), 6, 3, 8, structureboundingbox);
            this.a(generatoraccess, (IBlockData)iblockdata2.set(BlockEnderPortalFrame.EYE, Boolean.valueOf(aboolean[3])), 4, 3, 12, structureboundingbox);
            this.a(generatoraccess, (IBlockData)iblockdata2.set(BlockEnderPortalFrame.EYE, Boolean.valueOf(aboolean[4])), 5, 3, 12, structureboundingbox);
            this.a(generatoraccess, (IBlockData)iblockdata2.set(BlockEnderPortalFrame.EYE, Boolean.valueOf(aboolean[5])), 6, 3, 12, structureboundingbox);
            this.a(generatoraccess, (IBlockData)iblockdata3.set(BlockEnderPortalFrame.EYE, Boolean.valueOf(aboolean[6])), 3, 3, 9, structureboundingbox);
            this.a(generatoraccess, (IBlockData)iblockdata3.set(BlockEnderPortalFrame.EYE, Boolean.valueOf(aboolean[7])), 3, 3, 10, structureboundingbox);
            this.a(generatoraccess, (IBlockData)iblockdata3.set(BlockEnderPortalFrame.EYE, Boolean.valueOf(aboolean[8])), 3, 3, 11, structureboundingbox);
            this.a(generatoraccess, (IBlockData)iblockdata4.set(BlockEnderPortalFrame.EYE, Boolean.valueOf(aboolean[9])), 7, 3, 9, structureboundingbox);
            this.a(generatoraccess, (IBlockData)iblockdata4.set(BlockEnderPortalFrame.EYE, Boolean.valueOf(aboolean[10])), 7, 3, 10, structureboundingbox);
            this.a(generatoraccess, (IBlockData)iblockdata4.set(BlockEnderPortalFrame.EYE, Boolean.valueOf(aboolean[11])), 7, 3, 11, structureboundingbox);
            if (flag) {
    ...
    public static class WorldGenStrongholdPrison extends WorldGenStrongholdPieces.WorldGenStrongholdPiece {
        ...
        public boolean a(GeneratorAccess generatoraccess, Random random, StructureBoundingBox structureboundingbox, ChunkCoordIntPair var4) {
            ...
            this.a(generatoraccess, random, structureboundingbox, this.d, 1, 1, 0);
            this.a(generatoraccess, structureboundingbox, 1, 1, 10, 3, 3, 10, m, m, false);
            ...
            for(int i = 1; i <= 3; ++i) {
                this.a(generatoraccess, (IBlockData)((IBlockData)Blocks.IRON_BARS.getBlockData().set(BlockIronBars.NORTH, Boolean.valueOf(true))).set(BlockIronBars.SOUTH, Boolean.valueOf(true)), 4, i, 4, structureboundingbox);
                this.a(generatoraccess, (IBlockData)((IBlockData)((IBlockData)Blocks.IRON_BARS.getBlockData().set(BlockIronBars.NORTH, Boolean.valueOf(true))).set(BlockIronBars.SOUTH, Boolean.valueOf(true))).set(BlockIronBars.EAST, Boolean.valueOf(true)), 4, i, 5, structureboundingbox);
                this.a(generatoraccess, (IBlockData)((IBlockData)Blocks.IRON_BARS.getBlockData().set(BlockIronBars.NORTH, Boolean.valueOf(true))).set(BlockIronBars.SOUTH, Boolean.valueOf(true)), 4, i, 6, structureboundingbox);
                this.a(generatoraccess, (IBlockData)((IBlockData)Blocks.IRON_BARS.getBlockData().set(BlockIronBars.WEST, Boolean.valueOf(true))).set(BlockIronBars.EAST, Boolean.valueOf(true)), 5, i, 5, structureboundingbox);
                this.a(generatoraccess, (IBlockData)((IBlockData)Blocks.IRON_BARS.getBlockData().set(BlockIronBars.WEST, Boolean.valueOf(true))).set(BlockIronBars.EAST, Boolean.valueOf(true)), 6, i, 5, structureboundingbox);
                this.a(generatoraccess, (IBlockData)((IBlockData)Blocks.IRON_BARS.getBlockData().set(BlockIronBars.WEST, Boolean.valueOf(true))).set(BlockIronBars.EAST, Boolean.valueOf(true)), 7, i, 5, structureboundingbox);
            }

            this.a(generatoraccess, (IBlockData)((IBlockData)Blocks.IRON_BARS.getBlockData().set(BlockIronBars.NORTH, Boolean.valueOf(true))).set(BlockIronBars.SOUTH, Boolean.valueOf(true)), 4, 3, 2, structureboundingbox);
            this.a(generatoraccess, (IBlockData)((IBlockData)Blocks.IRON_BARS.getBlockData().set(BlockIronBars.NORTH, Boolean.valueOf(true))).set(BlockIronBars.SOUTH, Boolean.valueOf(true)), 4, 3, 8, structureboundingbox);
            IBlockData iblockdata1 = (IBlockData)Blocks.IRON_DOOR.getBlockData().set(BlockDoor.FACING, EnumDirection.WEST);
            IBlockData iblockdata = (IBlockData)((IBlockData)Blocks.IRON_DOOR.getBlockData().set(BlockDoor.FACING, EnumDirection.WEST)).set(BlockDoor.HALF, BlockPropertyDoubleBlockHalf.UPPER);
            this.a(generatoraccess, iblockdata1, 4, 1, 2, structureboundingbox);
            this.a(generatoraccess, iblockdata, 4, 2, 2, structureboundingbox);
            this.a(generatoraccess, iblockdata1, 4, 1, 8, structureboundingbox);
            this.a(generatoraccess, iblockdata, 4, 2, 8, structureboundingbox);
            return true;
        }
    }
    ...
    public static class WorldGenStrongholdRoomCrossing extends WorldGenStrongholdPieces.WorldGenStrongholdPiece {
        ...
        public boolean a(GeneratorAccess generatoraccess, Random random, StructureBoundingBox structureboundingbox, ChunkCoordIntPair var4) {
            ...
            this.a(generatoraccess, random, structureboundingbox, this.d, 4, 1, 0);
            this.a(generatoraccess, structureboundingbox, 4, 1, 10, 6, 3, 10, m, m, false);
            this.a(generatoraccess, structureboundingbox, 0, 1, 4, 0, 3, 6, m, m, false);
            this.a(generatoraccess, structureboundingbox, 10, 1, 4, 10, 3, 6, m, m, false);
            switch(this.a) {
            case 0:
            ...
            case 1:
                for(int i1 = 0; i1 < 5; ++i1) {
                    this.a(generatoraccess, Blocks.STONE_BRICKS.getBlockData(), 3, 1, 3 + i1, structureboundingbox);
                    this.a(generatoraccess, Blocks.STONE_BRICKS.getBlockData(), 7, 1, 3 + i1, structureboundingbox);
                    this.a(generatoraccess, Blocks.STONE_BRICKS.getBlockData(), 3 + i1, 1, 3, structureboundingbox);
                    this.a(generatoraccess, Blocks.STONE_BRICKS.getBlockData(), 3 + i1, 1, 7, structureboundingbox);
                }
            ...
            case 2:
                ...
                for(int j = 1; j <= 9; ++j) {
                    this.a(generatoraccess, Blocks.COBBLESTONE.getBlockData(), j, 3, 1, structureboundingbox);
                    this.a(generatoraccess, Blocks.COBBLESTONE.getBlockData(), j, 3, 9, structureboundingbox);
                }
                ...
                for(int k = 1; k <= 3; ++k) {
                    this.a(generatoraccess, Blocks.COBBLESTONE.getBlockData(), 4, k, 4, structureboundingbox);
                    this.a(generatoraccess, Blocks.COBBLESTONE.getBlockData(), 6, k, 4, structureboundingbox);
                    this.a(generatoraccess, Blocks.COBBLESTONE.getBlockData(), 4, k, 6, structureboundingbox);
                    this.a(generatoraccess, Blocks.COBBLESTONE.getBlockData(), 6, k, 6, structureboundingbox);
                }

                this.a(generatoraccess, Blocks.TORCH.getBlockData(), 5, 3, 5, structureboundingbox);

                for(int l = 2; l <= 8; ++l) {
                    this.a(generatoraccess, Blocks.OAK_PLANKS.getBlockData(), 2, 3, l, structureboundingbox);
                    this.a(generatoraccess, Blocks.OAK_PLANKS.getBlockData(), 3, 3, l, structureboundingbox);
                    if (l <= 3 || l >= 7) {
                        this.a(generatoraccess, Blocks.OAK_PLANKS.getBlockData(), 4, 3, l, structureboundingbox);
                        this.a(generatoraccess, Blocks.OAK_PLANKS.getBlockData(), 5, 3, l, structureboundingbox);
                        this.a(generatoraccess, Blocks.OAK_PLANKS.getBlockData(), 6, 3, l, structureboundingbox);
                    }

                    this.a(generatoraccess, Blocks.OAK_PLANKS.getBlockData(), 7, 3, l, structureboundingbox);
                    this.a(generatoraccess, Blocks.OAK_PLANKS.getBlockData(), 8, 3, l, structureboundingbox);
                }
    ...
    public static class WorldGenStrongholdStairs extends WorldGenStrongholdPieces.WorldGenStrongholdPiece {
        ...
        public boolean a(GeneratorAccess generatoraccess, Random random, StructureBoundingBox structureboundingbox, ChunkCoordIntPair var4) {
            ...
            if (this.a) {
                this.a(generatoraccess, structureboundingbox, 0, 1, 2, 0, 3, 4, m, m, false);
            }

            if (this.b) {
                this.a(generatoraccess, structureboundingbox, 4, 1, 2, 4, 3, 4, m, m, false);
            }
    ...
    public static class WorldGenStrongholdStart extends WorldGenStrongholdPieces.WorldGenStrongholdStairs2 {
        ...
        public WorldGenStrongholdStart(int var1, Random random, int i, int j) {
            super(0, random, i, j);
        }
    }
    ...
    static class WorldGenStrongholdStones extends StructurePiece.StructurePieceBlockSelector {
        ...
        public void a(Random random, int var2, int var3, int var4, boolean flag) {
            if (flag) {
