...
public class CommandParticle {
    ...
    public static void a(com.mojang.brigadier.CommandDispatcher<CommandListenerWrapper> commanddispatcher) {
        commanddispatcher.register((LiteralArgumentBuilder)((LiteralArgumentBuilder)CommandDispatcher.a("particle").requires((commandlistenerwrapper) -> {
            return commandlistenerwrapper.hasPermission(2);
        })).then(((RequiredArgumentBuilder)CommandDispatcher.a("name", ArgumentParticle.a()).executes((commandcontext) -> {
            return a((CommandListenerWrapper)commandcontext.getSource(), ArgumentParticle.a(commandcontext, "name"), ((CommandListenerWrapper)commandcontext.getSource()).getPosition(), Vec3D.a, 0.0F, 0, false, ((CommandListenerWrapper)commandcontext.getSource()).getServer().getPlayerList().v());
        })).then(((RequiredArgumentBuilder)CommandDispatcher.a("pos", ArgumentVec3.a()).executes((commandcontext) -> {
            return a((CommandListenerWrapper)commandcontext.getSource(), ArgumentParticle.a(commandcontext, "name"), ArgumentVec3.a(commandcontext, "pos"), Vec3D.a, 0.0F, 0, false, ((CommandListenerWrapper)commandcontext.getSource()).getServer().getPlayerList().v());
        })).then(CommandDispatcher.a("delta", ArgumentVec3.a(false)).then(CommandDispatcher.a("speed", FloatArgumentType.floatArg(0.0F)).then(((RequiredArgumentBuilder)((RequiredArgumentBuilder)CommandDispatcher.a("count", IntegerArgumentType.integer(0)).executes((commandcontext) -> {
            return a((CommandListenerWrapper)commandcontext.getSource(), ArgumentParticle.a(commandcontext, "name"), ArgumentVec3.a(commandcontext, "pos"), ArgumentVec3.a(commandcontext, "delta"), FloatArgumentType.getFloat(commandcontext, "speed"), IntegerArgumentType.getInteger(commandcontext, "count"), false, ((CommandListenerWrapper)commandcontext.getSource()).getServer().getPlayerList().v());
        })).then(((LiteralArgumentBuilder)CommandDispatcher.a("force").executes((commandcontext) -> {
            return a((CommandListenerWrapper)commandcontext.getSource(), ArgumentParticle.a(commandcontext, "name"), ArgumentVec3.a(commandcontext, "pos"), ArgumentVec3.a(commandcontext, "delta"), FloatArgumentType.getFloat(commandcontext, "speed"), IntegerArgumentType.getInteger(commandcontext, "count"), true, ((CommandListenerWrapper)commandcontext.getSource()).getServer().getPlayerList().v());
        })).then(CommandDispatcher.a("viewers", ArgumentEntity.d()).executes((commandcontext) -> {
