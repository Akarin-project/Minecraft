    ...
    public TypeRewriteRule makeRule() {
        ...
        return this.fixTypeEverywhereTyped("ItemSpawnEggFix", type, (typed) -> {
            ...
            if (optional.isPresent() && Objects.equals(((Pair)optional.get()).getSecond(), "minecraft:spawn_egg")) {
                ...
                Optional optional1 = typed.getOptionalTyped(opticfinder2);
                Optional optional2 = optional1.flatMap((typed6) -> {
                    return typed6.getOptionalTyped(opticfinder3);
                });
                Optional optional3 = optional2.flatMap((typed6) -> {
                    return typed6.getOptionalTyped(opticfinder4);
                });
                Optional optional4 = optional3.flatMap((typed6) -> {
                    return typed6.getOptional(opticfinder1);
                });
                Typed typed1 = typed;
                String s = ID_MAPPING[short1 & 255];
