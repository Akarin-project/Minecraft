...
public class CombatTracker {
    ...
    public void trackDamage(DamageSource damagesource, float fx, float f1) {
        this.g();
        this.a();
        CombatEntry combatentry = new CombatEntry(damagesource, this.b.ticksLived, fx, f1, this.h, this.b.fallDistance);
            ...
            if (combatentry != null && combatentry1.a() == DamageSource.FALL) {
                ...
                if (combatentry.a() != DamageSource.FALL && combatentry.a() != DamageSource.OUT_OF_WORLD) {
                    if (ichatbasecomponent1 != null && (ichatbasecomponent == null || !ichatbasecomponent1.equals(ichatbasecomponent))) {
                        ...
                        ItemStack itemstack1 = entity1 instanceof EntityLiving ? ((EntityLiving)entity1).getItemInMainHand() : ItemStack.a;
                        if (!itemstack1.isEmpty() && itemstack1.hasName()) {
                            object = new ChatMessage("death.fell.assist.item", new Object[]{this.b.getScoreboardDisplayName(), ichatbasecomponent1, itemstack1.A()});
                        } else {
                        ...
                        ItemStack itemstack = entity instanceof EntityLiving ? ((EntityLiving)entity).getItemInMainHand() : ItemStack.a;
                        if (!itemstack.isEmpty() && itemstack.hasName()) {
                            object = new ChatMessage("death.fell.finish.item", new Object[]{this.b.getScoreboardDisplayName(), ichatbasecomponent, itemstack.A()});
                        } else {
    ...
    public EntityLiving c() {
        ...
        for(CombatEntry combatentry : this.a) {
            ...
            if (combatentry.a().getEntity() instanceof EntityLiving && (entityliving == null || combatentry.c() > fx)) {
                fx = combatentry.c();
                entityliving = (EntityLiving)combatentry.a().getEntity();
            }
        }

        if (entityhuman != null && f1 >= fx / 3.0F) {
            return entityhuman;
        } else {
            return entityliving;
        }
    ...
    private CombatEntry j() {
        ...
        for(int i = 0; i < this.a.size(); ++i) {
            ...
            if (combatentry2.g() != null && (combatentry1 == null || combatentry2.c() > fx)) {
        ...
        if (f1 > 5.0F && combatentry != null) {
            return combatentry;
        } else if (fx > 5.0F && combatentry1 != null) {
            return combatentry1;
        } else {
            return null;
        }
