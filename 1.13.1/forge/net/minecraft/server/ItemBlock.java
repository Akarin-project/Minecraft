...
public class ItemBlock extends Item {
    ...
    public ItemBlock(Block block, Item.Info item$info) {
        super(item$info);
        this.a = block;
    }
    ...
    protected boolean a(BlockPosition blockposition, World world, @Nullable EntityHuman entityhuman, ItemStack itemstack, IBlockData var5) {
