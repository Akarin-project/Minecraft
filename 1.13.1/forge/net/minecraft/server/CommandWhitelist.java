...
public class CommandWhitelist {
    ...
    public static void a(com.mojang.brigadier.CommandDispatcher<CommandListenerWrapper> commanddispatcher) {
        commanddispatcher.register((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)CommandDispatcher.a("whitelist").requires((commandlistenerwrapper) -> {
        ...
        }))).then(CommandDispatcher.a("add").then(CommandDispatcher.a("targets", ArgumentProfile.a()).suggests((commandcontext, suggestionsbuilder) -> {
        ...
        })))).then(CommandDispatcher.a("remove").then(CommandDispatcher.a("targets", ArgumentProfile.a()).suggests((commandcontext, suggestionsbuilder) -> {
