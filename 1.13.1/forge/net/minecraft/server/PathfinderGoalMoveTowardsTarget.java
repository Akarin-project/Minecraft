...
public class PathfinderGoalMoveTowardsTarget extends PathfinderGoal {
    ...
    public PathfinderGoalMoveTowardsTarget(EntityCreature entitycreature, double d0, float fx) {
    ...
    public boolean b() {
        return !this.a.getNavigation().p() && this.b.isAlive() && this.b.h(this.a) < (double)(this.g * this.g);
    }
