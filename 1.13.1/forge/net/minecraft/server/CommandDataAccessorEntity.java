...
public class CommandDataAccessorEntity implements CommandDataAccessor {
    ...
    public static final CommandData.a a = new CommandData.a() {
        ...
        public ArgumentBuilder<CommandListenerWrapper, ?> a(ArgumentBuilder<CommandListenerWrapper, ?> argumentbuilder, Function<ArgumentBuilder<CommandListenerWrapper, ?>, ArgumentBuilder<CommandListenerWrapper, ?>> function) {
            return argumentbuilder.then(CommandDispatcher.a("entity").then((ArgumentBuilder)function.apply(CommandDispatcher.a("target", ArgumentEntity.a()))));
        }
    };
    ...
    public IChatBaseComponent a(ArgumentNBTKey.c argumentnbtkey$c, double d0, int i) {
        return new ChatMessage("commands.data.entity.get", new Object[]{argumentnbtkey$c, this.c.getScoreboardDisplayName(), String.format(Locale.ROOT, "%.2f", d0), i});
    }
}
