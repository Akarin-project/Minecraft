...
public class CriterionConditionEntity {
    ...
    public boolean a(EntityPlayer entityplayer, @Nullable Entity entity) {
        if (this == a) {
            ...
            return false;
        } else if (!this.c.a(entity.P())) {
            return false;
        } else if (!this.d.a(entityplayer.locX, entityplayer.locY, entityplayer.locZ, entity.locX, entity.locY, entity.locZ)) {
            return false;
        } else if (!this.e.a(entityplayer.getWorldServer(), entity.locX, entity.locY, entity.locZ)) {
            return false;
        } else if (!this.f.a(entity)) {
            return false;
        } else {
            return this.g.a(entity);
        }
    }
    ...
    public static JsonElement a(CriterionConditionEntity[] acriterionconditionentity) {
        if (acriterionconditionentity == b) {
            return JsonNull.INSTANCE;
        } else {
