...
public class DataConverterEntityRename extends DataConverterEntityRenameAbstract {
    ...
    protected String a(String s) {
        ...
        return (String)a.getOrDefault(s, s);
    }
}
