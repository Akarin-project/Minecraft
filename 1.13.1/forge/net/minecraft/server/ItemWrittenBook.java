...
public class ItemWrittenBook extends Item {
    public ItemWrittenBook(Item.Info item$info) {
        super(item$info);
    }
        ...
        if (nbttagcompound != null && !nbttagcompound.getBoolean("resolved")) {
            ...
            if (b(nbttagcompound)) {
                ...
                for(int i = 0; i < nbttaglist.size(); ++i) {
                    ...
                    try {
                        ichatbasecomponent = IChatBaseComponent.ChatSerializer.b(s);
                        ichatbasecomponent = ChatComponentUtils.filterForDisplay(entityhuman.getCommandListener(), ichatbasecomponent, entityhuman);
                    } catch (Exception var9) {
                        ichatbasecomponent = new ChatComponentText(s);
                    }

                    nbttaglist.set(i, (NBTBase)(new NBTTagString(IChatBaseComponent.ChatSerializer.a(ichatbasecomponent))));
                }
