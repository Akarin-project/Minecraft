...
public abstract class EntityAnimal extends EntityAgeable implements IAnimal {
    protected Block bF = Blocks.GRASS_BLOCK;
    private int bC;
    private UUID bD;
    ...
    public boolean mate(EntityAnimal entityanimal1) {
        if (entityanimal1 == this) {
            return false;
        } else if (entityanimal1.getClass() != this.getClass()) {
            return false;
        } else {
            return this.isInLove() && entityanimal1.isInLove();
        }
    }
}
