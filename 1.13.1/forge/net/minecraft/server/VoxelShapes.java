...
public final class VoxelShapes {
    ...
    public static VoxelShape a(AxisAlignedBB axisalignedbb) {
        ...
        if (i >= 0 && j >= 0 && k >= 0) {
            ...
            return new VoxelShapeArray(b.a, new double[]{axisalignedbb.a, axisalignedbb.d}, new double[]{axisalignedbb.b, axisalignedbb.e}, new double[]{axisalignedbb.c, axisalignedbb.f});
        }
    }
    ...
    public static boolean c(VoxelShape voxelshape, VoxelShape voxelshape1, OperatorBoolean operatorboolean) {
        if (operatorboolean.apply(false, false)) {
            ...
            for(EnumDirection.EnumAxis enumdirection$enumaxis : EnumAxisCycle.d) {
                if (voxelshape.c(enumdirection$enumaxis) < voxelshape1.b(enumdirection$enumaxis) - 1.0E-7D) {
                    return flag || flag1;
                }

                if (voxelshape1.c(enumdirection$enumaxis) < voxelshape.b(enumdirection$enumaxis) - 1.0E-7D) {
                    return flag || flag1;
                }
            }
    ...
    private static boolean a(VoxelShapeMerger voxelshapemerger, VoxelShapeMerger voxelshapemerger1, VoxelShapeMerger voxelshapemerger2, VoxelShapeDiscrete voxelshapediscrete, VoxelShapeDiscrete voxelshapediscrete1, OperatorBoolean operatorboolean) {
        return !voxelshapemerger.a((i, j, var7) -> {
            return voxelshapemerger1.a((i1, j1, var8) -> {
                return voxelshapemerger2.a((k2, l2, var9) -> {
                    return !operatorboolean.apply(voxelshapediscrete.c(i, i1, k2), voxelshapediscrete1.c(j, j1, l2));
                });
            });
        });
    }

    public static double a(EnumDirection.EnumAxis enumdirection$enumaxis, AxisAlignedBB axisalignedbb, Stream<VoxelShape> stream, double d0) {
        for(Iterator iterator = stream.iterator(); iterator.hasNext(); d0 = ((VoxelShape)iterator.next()).a(enumdirection$enumaxis, axisalignedbb, d0)) {
    ...
    public static boolean b(VoxelShape voxelshape, VoxelShape voxelshape1, EnumDirection enumdirection) {
        if (voxelshape != b() && voxelshape1 != b()) {
            ...
            VoxelShape voxelshape2 = enumdirection$enumaxisdirection == EnumDirection.EnumAxisDirection.POSITIVE ? voxelshape : voxelshape1;
            VoxelShape voxelshape3 = enumdirection$enumaxisdirection == EnumDirection.EnumAxisDirection.POSITIVE ? voxelshape1 : voxelshape;
            if (!DoubleMath.fuzzyEquals(voxelshape2.c(enumdirection$enumaxis), 1.0D, 1.0E-7D)) {
                voxelshape2 = a();
            }

            if (!DoubleMath.fuzzyEquals(voxelshape3.b(enumdirection$enumaxis), 0.0D, 1.0E-7D)) {
                voxelshape3 = a();
            }

            return !c(b(), b(new VoxelShapeSlice(voxelshape2, enumdirection$enumaxis, voxelshape2.a.c(enumdirection$enumaxis) - 1), new VoxelShapeSlice(voxelshape3, enumdirection$enumaxis, 0), OperatorBoolean.OR), OperatorBoolean.ONLY_FIRST);
        } else {
            return true;
        }
    }
    ...
    protected static VoxelShapeMerger a(int i, DoubleList doublelist, DoubleList doublelist1, boolean flag, boolean flag1) {
        ...
        if (doublelist.getDouble(doublelist.size() - 1) < doublelist1.getDouble(0) - 1.0E-7D) {
            return new VoxelShapeMergerDisjoint(doublelist, doublelist1, false);
        } else if (doublelist1.getDouble(doublelist1.size() - 1) < doublelist.getDouble(0) - 1.0E-7D) {
            return new VoxelShapeMergerDisjoint(doublelist1, doublelist, true);
        } else if (Objects.equals(doublelist, doublelist1)) {
            if (doublelist instanceof VoxelShapeMergerIdentical) {
                return (VoxelShapeMerger)doublelist;
            } else {
                return (VoxelShapeMerger)(doublelist1 instanceof VoxelShapeMergerIdentical ? (VoxelShapeMerger)doublelist1 : new VoxelShapeMergerIdentical(doublelist));
            }
        } else {
