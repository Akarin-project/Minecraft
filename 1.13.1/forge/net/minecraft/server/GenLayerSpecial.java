...
public class GenLayerSpecial {
    public static enum Special1 implements AreaTransformer7 {
        ...
        public int a(WorldGenContext var1, int i, int j, int k, int l, int i1) {
            return i1 != 1 || i != 3 && j != 3 && l != 3 && k != 3 && i != 4 && j != 4 && l != 4 && k != 4 ? i1 : 2;
        }
    }
    ...
    public static enum Special2 implements AreaTransformer7 {
        ...
        public int a(WorldGenContext var1, int i, int j, int k, int l, int i1) {
            return i1 != 4 || i != 1 && j != 1 && l != 1 && k != 1 && i != 2 && j != 2 && l != 2 && k != 2 ? i1 : 3;
        }
    }
