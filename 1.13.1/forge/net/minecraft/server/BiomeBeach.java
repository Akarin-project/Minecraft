...
public final class BiomeBeach extends BiomeBase {
    public BiomeBeach() {
        super((new BiomeBase.a()).a(new WorldGenSurfaceComposite(au, ap)).a(BiomeBase.Precipitation.RAIN).a(BiomeBase.Geography.BEACH).a(0.0F).b(0.025F).c(0.8F).d(0.4F).a(4159204).b(329011).a((String)null));
