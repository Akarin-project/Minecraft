...
public final class BiomeSwamp extends BiomeBase {
    protected BiomeSwamp() {
        super((new BiomeBase.a()).a(new WorldGenSurfaceComposite(az, ai)).a(BiomeBase.Precipitation.RAIN).a(BiomeBase.Geography.SWAMP).a(-0.2F).b(0.1F).c(0.8F).d(0.9F).a(6388580).b(2302743).a((String)null));
        this.a(WorldGenerator.l, new WorldGenFeatureSwampHutConfiguration());
        ...
        this.a(WorldGenStage.Decoration.VEGETAL_DECORATION, a(WorldGenerator.B, WorldGenFeatureConfiguration.e, s, new WorldGenDecoratorFrequencyExtraChanceConfiguration(2, 0.1F, 1)));
        this.a(WorldGenStage.Decoration.VEGETAL_DECORATION, a(WorldGenerator.J, i, new WorldGenDecoratorFrequencyConfiguration(1)));
        this.a(WorldGenStage.Decoration.VEGETAL_DECORATION, a(WorldGenerator.M, new WorldGenFeatureTallGrassConfiguration(Blocks.GRASS.getBlockData()), j, new WorldGenDecoratorFrequencyConfiguration(5)));
        ...
        this.a(WorldGenStage.Decoration.VEGETAL_DECORATION, a(WorldGenerator.ac, WorldGenFeatureConfiguration.e, j, new WorldGenDecoratorFrequencyConfiguration(4)));
        this.a(WorldGenStage.Decoration.VEGETAL_DECORATION, a(WorldGenerator.ah, new WorldGenFeatureMushroomConfiguration(Blocks.BROWN_MUSHROOM), y, new WorldGenDecoratorFrequencyChanceConfiguration(8, 0.25F)));
        this.a(WorldGenStage.Decoration.VEGETAL_DECORATION, a(WorldGenerator.ah, new WorldGenFeatureMushroomConfiguration(Blocks.RED_MUSHROOM), z, new WorldGenDecoratorFrequencyChanceConfiguration(8, 0.125F)));
        ...
        this.a(WorldGenStage.Decoration.VEGETAL_DECORATION, a(WorldGenerator.Z, WorldGenFeatureConfiguration.e, j, new WorldGenDecoratorFrequencyConfiguration(20)));
        ...
        this.a(WorldGenStage.Decoration.VEGETAL_DECORATION, a(WorldGenerator.ay, new WorldGenFeatureSeaGrassConfiguration(64, 0.6D), B, WorldGenFeatureDecoratorConfiguration.e));
        this.a(WorldGenStage.Decoration.UNDERGROUND_DECORATION, a(WorldGenerator.R, WorldGenFeatureConfiguration.e, q, new WorldGenDecoratorChanceConfiguration(64)));
