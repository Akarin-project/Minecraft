...
public class WorldGenFeatureIceburg extends WorldGenerator<WorldGenFeatureIceburgConfiguration> {
    public WorldGenFeatureIceburg() {
    }

    public boolean a(GeneratorAccess generatoraccess, ChunkGenerator<? extends GeneratorSettings> var2, Random random, BlockPosition blockposition, WorldGenFeatureIceburgConfiguration worldgenfeatureiceburgconfiguration) {
        ...
        for(int k1 = -j1; k1 < j1; ++k1) {
            for(int l1 = -j1; l1 < j1; ++l1) {
                for(int i2 = 0; i2 < k; ++i2) {
                    int j2 = flag1 ? this.b(i2, k, i1) : this.a(random, i2, k, i1);
                    if (flag1 || k1 < j2) {
        ...
        for(int l2 = -j1; l2 < j1; ++l2) {
            for(int i3 = -j1; i3 < j1; ++i3) {
                for(int j3 = -1; j3 > -l; --j3) {
                    int k3 = flag1 ? MathHelper.f((float)j1 * (1.0F - (float)Math.pow((double)j3, 2.0D) / ((float)l * 8.0F))) : j1;
                    int k2 = this.b(random, -j3, l, i1);
                    if (l2 < k2) {
                        this.a(generatoraccess, random, blockposition, l, l2, j3, i3, k2, k3, flag1, j, d0, flag, iblockdata);
                    }
                }
            }
        }
    ...
    private void a(Random random, GeneratorAccess generatoraccess, int i, int j, BlockPosition blockposition, boolean flag, int k, double d0, int l) {
        ...
        BlockPosition blockposition1 = (new BlockPosition(0, 0, 0)).a(i1 * k1, 0, j1 * l1);
        double d1 = flag ? d0 + (Math.PI / 2D) : random.nextDouble() * 2.0D * Math.PI;

        for(int i2 = 0; i2 < j - 3; ++i2) {
            int j2 = this.a(random, i2, j, i);
            this.a(j2, i2, blockposition, generatoraccess, false, d1, blockposition1, k, l);
        }

        for(int k2 = -1; k2 > -j + random.nextInt(5); --k2) {
            int l2 = this.b(random, -k2, j, i);
            this.a(l2, k2, blockposition, generatoraccess, true, d1, blockposition1, k, l);
        }
    ...
    private void a(int i, int j, BlockPosition blockposition, GeneratorAccess generatoraccess, boolean flag, double d0, BlockPosition blockposition1, int k, int l) {
        ...
        for(int k1 = -i1; k1 < i1; ++k1) {
            for(int l1 = -i1; l1 < i1; ++l1) {
                ...
                if (d1 < 0.0D) {
                    BlockPosition blockposition2 = blockposition.a(k1, j, l1);
    ...
    private void a(GeneratorAccess generatoraccess, Random random, BlockPosition blockposition, int i, int j, int k, int l, int i1, int j1, boolean flag, int k1, double d0, boolean flag1, IBlockData iblockdata) {
        BlockPosition blockposition1 = new BlockPosition(0, 0, 0);
        double d1 = flag ? this.a(j, l, blockposition1, j1, this.a(k, i, k1), d0) : this.a(j, l, blockposition1, i1, random);
        if (d1 < 0.0D) {
            BlockPosition blockposition2 = blockposition.a(j, k, l);
            double d2 = flag ? -0.5D : (double)(-6 - random.nextInt(3));
            if (d1 > d2 && random.nextDouble() > 0.9D) {
                return;
            }

            this.a(blockposition2, generatoraccess, random, i - k, i, flag, flag1, iblockdata);
        }
        ...
        for(int i1 = -l; i1 <= l; ++i1) {
            for(int j1 = -l; j1 <= l; ++j1) {
                for(int k1 = 0; k1 <= j; ++k1) {
                    BlockPosition blockposition1 = blockposition.a(i1, k1, j1);
