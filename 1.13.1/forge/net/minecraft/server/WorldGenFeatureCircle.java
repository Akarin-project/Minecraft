...
public class WorldGenFeatureCircle extends WorldGenerator<WorldGenFeatureCircleConfiguration> {
    ...
    public boolean a(GeneratorAccess generatoraccess, ChunkGenerator<? extends GeneratorSettings> var2, Random random, BlockPosition blockposition, WorldGenFeatureCircleConfiguration worldgenfeaturecircleconfiguration) {
