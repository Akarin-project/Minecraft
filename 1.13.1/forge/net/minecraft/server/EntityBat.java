...
public class EntityBat extends EntityAmbient {
    ...
    protected void mobTick() {
        ...
        if (this.isAsleep()) {
            ...
            this.motX += (Math.signum(d0) * 0.5D - this.motX) * (double)0.1F;
            this.motY += (Math.signum(d1) * (double)0.7F - this.motY) * (double)0.1F;
            this.motZ += (Math.signum(d2) * 0.5D - this.motZ) * (double)0.1F;
            float f = (float)(MathHelper.c(this.motZ, this.motX) * (double)(180F / (float)Math.PI)) - 90.0F;
    ...
    public void a(NBTTagCompound nbttagcompound) {
        ...
        this.datawatcher.set(a, nbttagcompound.getByte("BatFlags"));
    }

    public void b(NBTTagCompound nbttagcompound) {
        super.b(nbttagcompound);
        nbttagcompound.setByte("BatFlags", this.datawatcher.get(a));
    }
