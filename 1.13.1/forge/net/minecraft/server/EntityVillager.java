...
public class EntityVillager extends EntityAgeable implements NPC, IMerchant {
    ...
    public int getProfession() {
        return Math.max(this.datawatcher.get(bD) % 6, 0);
    }
    ...
    public void populateTrades() {
        EntityVillager.IMerchantRecipeOption[][][] aentityvillager$imerchantrecipeoption = bU[this.getProfession()];
        if (this.careerId != 0 && this.bQ != 0) {
            ++this.bQ;
        } else {
            this.careerId = this.random.nextInt(aentityvillager$imerchantrecipeoption.length) + 1;
            this.bQ = 1;
        }
        ...
        int j = this.bQ - 1;
        if (i >= 0 && i < aentityvillager$imerchantrecipeoption.length) {
            ...
            if (j >= 0 && j < aentityvillager$imerchantrecipeoption1.length) {
                ...
                for(EntityVillager.IMerchantRecipeOption entityvillager$imerchantrecipeoption : aentityvillager$imerchantrecipeoption2) {
                    entityvillager$imerchantrecipeoption.a(this, this.trades, this.random);
                }
            }
    ...
    public EntityVillager b(EntityAgeable var1) {
        EntityVillager entityvillager1 = new EntityVillager(this.world);
        entityvillager1.prepare(this.world.getDamageScaler(new BlockPosition(entityvillager1)), (GroupDataEntity)null, (NBTTagCompound)null);
        return entityvillager1;
    }
    ...
    interface IMerchantRecipeOption {
        void a(IMerchant var1, MerchantRecipeList var2, Random var3);
    }
    ...
    static class MerchantRecipeOptionBook implements EntityVillager.IMerchantRecipeOption {
        ...
        public void a(IMerchant var1, MerchantRecipeList merchantrecipelist, Random random) {
    ...
    static class MerchantRecipeOptionBuy implements EntityVillager.IMerchantRecipeOption {
        ...
        public MerchantRecipeOptionBuy(IMaterial imaterial, EntityVillager.MerchantOptionRandomRange entityvillager$merchantoptionrandomrange) {
            this.a = imaterial.getItem();
            this.b = entityvillager$merchantoptionrandomrange;
        }
    ...
    static class MerchantRecipeOptionEnchant implements EntityVillager.IMerchantRecipeOption {
        ...
        public MerchantRecipeOptionEnchant(Item item, EntityVillager.MerchantOptionRandomRange entityvillager$merchantoptionrandomrange) {
    ...
    static class MerchantRecipeOptionProcess implements EntityVillager.IMerchantRecipeOption {
        ...
        public MerchantRecipeOptionProcess(IMaterial imaterial, EntityVillager.MerchantOptionRandomRange entityvillager$merchantoptionrandomrange, Item item, EntityVillager.MerchantOptionRandomRange entityvillager$merchantoptionrandomrange1) {
            this.a = new ItemStack(imaterial);
            this.b = entityvillager$merchantoptionrandomrange;
            this.c = new ItemStack(item);
            this.d = entityvillager$merchantoptionrandomrange1;
        }
    ...
    static class MerchantRecipeOptionSell implements EntityVillager.IMerchantRecipeOption {
        ...
        public MerchantRecipeOptionSell(Block block, EntityVillager.MerchantOptionRandomRange entityvillager$merchantoptionrandomrange) {
            this(new ItemStack(block), entityvillager$merchantoptionrandomrange);
        }

        public MerchantRecipeOptionSell(Item item, EntityVillager.MerchantOptionRandomRange entityvillager$merchantoptionrandomrange) {
            this(new ItemStack(item), entityvillager$merchantoptionrandomrange);
        }

        public MerchantRecipeOptionSell(ItemStack itemstack, EntityVillager.MerchantOptionRandomRange entityvillager$merchantoptionrandomrange) {
            this.a = itemstack;
            this.b = entityvillager$merchantoptionrandomrange;
        }
    ...
    static class h implements EntityVillager.IMerchantRecipeOption {
        ...
        public h(EntityVillager.MerchantOptionRandomRange entityvillager$merchantoptionrandomrange, String s, MapIcon.Type mapicon$type) {
            this.a = entityvillager$merchantoptionrandomrange;
            this.b = s;
            this.c = mapicon$type;
        }
