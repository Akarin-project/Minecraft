...
public class BlockChest extends BlockTileEntity implements IFluidSource, IFluidContainer {
    ...
    protected BlockChest(Block.Info block$info) {
        super(block$info);
        this.v((IBlockData)((IBlockData)((IBlockData)(this.blockStateList.getBlockData()).set(FACING, EnumDirection.NORTH)).set(b, BlockPropertyChestType.SINGLE)).set(c, Boolean.valueOf(false)));
    }
    ...
    public IBlockData updateState(IBlockData iblockdata, EnumDirection enumdirection, IBlockData iblockdata1, GeneratorAccess generatoraccess, BlockPosition blockposition, BlockPosition blockposition1) {
        ...
        if (iblockdata1.getBlock() == this && enumdirection.k().c()) {
            BlockPropertyChestType blockpropertychesttype = (BlockPropertyChestType)iblockdata1.get(b);
            if (iblockdata.get(b) == BlockPropertyChestType.SINGLE && blockpropertychesttype != BlockPropertyChestType.SINGLE && iblockdata.get(FACING) == iblockdata1.get(FACING) && k(iblockdata1) == enumdirection.opposite()) {
                return (IBlockData)iblockdata.set(b, blockpropertychesttype.a());
            }
        } else if (k(iblockdata) == enumdirection) {
            return (IBlockData)iblockdata.set(b, BlockPropertyChestType.SINGLE);
        }
    ...
    public VoxelShape a(IBlockData iblockdata, IBlockAccess var2, BlockPosition var3) {
        if (iblockdata.get(b) == BlockPropertyChestType.SINGLE) {
            return s;
        } else {
            switch(k(iblockdata)) {
            case NORTH:
    ...
    public static EnumDirection k(IBlockData iblockdata) {
        ...
        return iblockdata.get(b) == BlockPropertyChestType.LEFT ? enumdirection.e() : enumdirection.f();
    }
    ...
    public IBlockData getPlacedState(BlockActionContext blockactioncontext) {
        ...
        return (IBlockData)((IBlockData)((IBlockData)this.getBlockData().set(FACING, enumdirection)).set(b, blockpropertychesttype)).set(c, Boolean.valueOf(fluid.c() == FluidTypes.c));
    }

    public FluidType a(GeneratorAccess generatoraccess, BlockPosition blockposition, IBlockData iblockdata) {
        if (iblockdata.get(c)) {
            generatoraccess.setTypeAndData(blockposition, (IBlockData)iblockdata.set(c, Boolean.valueOf(false)), 3);
            return FluidTypes.c;
        } else {
            return FluidTypes.a;
        }
    ...
    public Fluid h(IBlockData iblockdata) {
        return iblockdata.get(c) ? FluidTypes.c.a(false) : super.h(iblockdata);
    }

    public boolean canPlace(IBlockAccess var1, BlockPosition var2, IBlockData iblockdata, FluidType fluidtype) {
        return !iblockdata.get(c) && fluidtype == FluidTypes.c;
    }

    public boolean place(GeneratorAccess generatoraccess, BlockPosition blockposition, IBlockData iblockdata, Fluid fluid) {
        if (!iblockdata.get(c) && fluid.c() == FluidTypes.c) {
            if (!generatoraccess.e()) {
                generatoraccess.setTypeAndData(blockposition, (IBlockData)iblockdata.set(c, Boolean.valueOf(true)), 3);
                generatoraccess.I().a(blockposition, FluidTypes.c, FluidTypes.c.a(generatoraccess));
            }
    ...
    private EnumDirection a(BlockActionContext blockactioncontext, EnumDirection enumdirection) {
        ...
        return iblockdata.getBlock() == this && iblockdata.get(b) == BlockPropertyChestType.SINGLE ? (EnumDirection)iblockdata.get(FACING) : null;
    }
    ...
    public ITileInventory getInventory(IBlockData iblockdata, World world, BlockPosition blockposition, boolean flag) {
        ...
        if (!(tileentity instanceof TileEntityChest)) {
            ...
            BlockPropertyChestType blockpropertychesttype = (BlockPropertyChestType)iblockdata.get(b);
    ...
    public int a(IBlockData iblockdata, World world, BlockPosition blockposition) {
        return Container.b(this.getInventory(iblockdata, world, blockposition, false));
    }
