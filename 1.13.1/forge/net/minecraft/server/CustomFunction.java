...
public class CustomFunction {
    ...
    public CustomFunction(MinecraftKey minecraftkey, CustomFunction.c[] acustomfunction$c) {
        this.b = minecraftkey;
        this.a = acustomfunction$c;
    }
    ...
    public static class b implements CustomFunction.c {
        ...
        public void a(CustomFunctionData customfunctiondata, CommandListenerWrapper commandlistenerwrapper, ArrayDeque<CustomFunctionData.a> var3, int var4) throws CommandSyntaxException {
    ...
    public interface c {
        void a(CustomFunctionData var1, CommandListenerWrapper var2, ArrayDeque<CustomFunctionData.a> var3, int var4) throws CommandSyntaxException;
    }
    ...
    public static class d implements CustomFunction.c {
        ...
        public void a(CustomFunctionData customfunctiondata, CommandListenerWrapper commandlistenerwrapper, ArrayDeque<CustomFunctionData.a> arraydeque, int i) {
            ...
            if (customfunction != null) {
                ...
                int k = Math.min(acustomfunction$c.length, j);

                for(int l = k - 1; l >= 0; --l) {
                    arraydeque.addFirst(new CustomFunctionData.a(customfunctiondata, commandlistenerwrapper, acustomfunction$c[l]));
                }
            }
