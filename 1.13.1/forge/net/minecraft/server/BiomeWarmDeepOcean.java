...
public class BiomeWarmDeepOcean extends BiomeBase {
    public BiomeWarmDeepOcean() {
        super((new BiomeBase.a()).a(new WorldGenSurfaceComposite(au, an)).a(BiomeBase.Precipitation.RAIN).a(BiomeBase.Geography.OCEAN).a(-1.8F).b(0.1F).c(0.5F).d(0.5F).a(4445678).b(270131).a((String)null));
