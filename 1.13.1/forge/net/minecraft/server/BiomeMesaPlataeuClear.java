...
public final class BiomeMesaPlataeuClear extends BiomeBase {
    public BiomeMesaPlataeuClear() {
        super((new BiomeBase.a()).a(new WorldGenSurfaceComposite(aA, aq)).a(BiomeBase.Precipitation.NONE).a(BiomeBase.Geography.MESA).a(1.5F).b(0.025F).c(2.0F).d(0.0F).a(4159204).b(329011).a((String)null));
