...
public final class BiomeSavannaPlateauMutated extends BiomeBase {
    public BiomeSavannaPlateauMutated() {
        super((new BiomeBase.a()).a(new WorldGenSurfaceComposite(aw, ai)).a(BiomeBase.Precipitation.NONE).a(BiomeBase.Geography.SAVANNA).a(1.05F).b(1.2125001F).c(1.0F).d(0.0F).a(4159204).b(329011).a("savanna_plateau"));
