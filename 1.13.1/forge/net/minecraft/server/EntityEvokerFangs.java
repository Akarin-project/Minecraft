...
public class EntityEvokerFangs extends Entity {
    ...
    public EntityEvokerFangs(World world, double d0, double d1, double d2, float fx, int i, EntityLiving entityliving) {
        this(world);
        this.a = i;
        this.a(entityliving);
        this.yaw = fx * (180F / (float)Math.PI);
    ...
    public void tick() {
        ...
        if (this.world.isClientSide) {
            ...
            if (this.a == -8) {
                for(EntityLiving entityliving : this.world.a(EntityLiving.class, this.getBoundingBox().grow(0.2D, 0.0D, 0.2D))) {
                    this.c(entityliving);
                }
            }
