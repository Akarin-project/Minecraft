...
public enum EnumBannerPatternType {
    ...
    private EnumBannerPatternType(String s1, String s2) {
        this.P = new String[3];
        this.Q = ItemStack.a;
        this.N = s1;
        this.O = s2;
    ...
    private EnumBannerPatternType(String s1, String s2, ItemStack itemstack) {
        this(s1, s2);
        this.Q = itemstack;
    }

    private EnumBannerPatternType(String s1, String s2, String s3, String s4, String s5) {
        this(s1, s2);
        this.P[0] = s3;
        this.P[1] = s4;
        this.P[2] = s5;
