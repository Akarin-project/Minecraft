...
public class CommandWorldBorder {
    ...
    public static void a(com.mojang.brigadier.CommandDispatcher<CommandListenerWrapper> commanddispatcher) {
        commanddispatcher.register((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)CommandDispatcher.a("worldborder").requires((commandlistenerwrapper) -> {
            return commandlistenerwrapper.hasPermission(2);
        })).then(CommandDispatcher.a("add").then(((RequiredArgumentBuilder)CommandDispatcher.a("distance", FloatArgumentType.floatArg(-6.0E7F, 6.0E7F)).executes((commandcontext) -> {
        ...
        }))))).then(CommandDispatcher.a("set").then(((RequiredArgumentBuilder)CommandDispatcher.a("distance", FloatArgumentType.floatArg(-6.0E7F, 6.0E7F)).executes((commandcontext) -> {
        ...
        }))))).then(CommandDispatcher.a("center").then(CommandDispatcher.a("pos", ArgumentVec2.a()).executes((commandcontext) -> {
            return a((CommandListenerWrapper)commandcontext.getSource(), ArgumentVec2.a(commandcontext, "pos"));
        })))).then(((LiteralArgumentBuilder)CommandDispatcher.a("damage").then(CommandDispatcher.a("amount").then(CommandDispatcher.a("damagePerBlock", FloatArgumentType.floatArg(0.0F)).executes((commandcontext) -> {
            return b((CommandListenerWrapper)commandcontext.getSource(), FloatArgumentType.getFloat(commandcontext, "damagePerBlock"));
        })))).then(CommandDispatcher.a("buffer").then(CommandDispatcher.a("distance", FloatArgumentType.floatArg(0.0F)).executes((commandcontext) -> {
        ...
        }))).then(((LiteralArgumentBuilder)CommandDispatcher.a("warning").then(CommandDispatcher.a("distance").then(CommandDispatcher.a("distance", IntegerArgumentType.integer(0)).executes((commandcontext) -> {
            return b((CommandListenerWrapper)commandcontext.getSource(), IntegerArgumentType.getInteger(commandcontext, "distance"));
        })))).then(CommandDispatcher.a("time").then(CommandDispatcher.a("time", IntegerArgumentType.integer(0)).executes((commandcontext) -> {
            return a((CommandListenerWrapper)commandcontext.getSource(), IntegerArgumentType.getInteger(commandcontext, "time"));
        })))));
    }

    private static int a(CommandListenerWrapper commandlistenerwrapper, float fx) throws CommandSyntaxException {
        WorldBorder worldborder = commandlistenerwrapper.getWorld().getWorldBorder();
        if (worldborder.getDamageBuffer() == (double)fx) {
            throw g.create();
        } else {
            worldborder.setDamageBuffer((double)fx);
            commandlistenerwrapper.sendMessage(new ChatMessage("commands.worldborder.damage.buffer.success", new Object[]{String.format(Locale.ROOT, "%.2f", fx)}), true);
            return (int)fx;
        }
    }

    private static int b(CommandListenerWrapper commandlistenerwrapper, float fx) throws CommandSyntaxException {
        WorldBorder worldborder = commandlistenerwrapper.getWorld().getWorldBorder();
        if (worldborder.getDamageAmount() == (double)fx) {
            throw h.create();
        } else {
            worldborder.setDamageAmount((double)fx);
            commandlistenerwrapper.sendMessage(new ChatMessage("commands.worldborder.damage.amount.success", new Object[]{String.format(Locale.ROOT, "%.2f", fx)}), true);
            return (int)fx;
        }
    }
