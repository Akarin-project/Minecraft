...
public class CommandWeather {
    public static void a(com.mojang.brigadier.CommandDispatcher<CommandListenerWrapper> commanddispatcher) {
        commanddispatcher.register((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)CommandDispatcher.a("weather").requires((commandlistenerwrapper) -> {
        ...
        })).then(CommandDispatcher.a("duration", IntegerArgumentType.integer(0, 1000000)).executes((commandcontext) -> {
