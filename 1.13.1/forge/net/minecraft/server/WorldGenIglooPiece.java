...
public class WorldGenIglooPiece {
    ...
    private static final Map<MinecraftKey, BlockPosition> e = ImmutableMap.of(a, new BlockPosition(0, 0, 0), b, new BlockPosition(2, -3, 4), c, new BlockPosition(0, -3, -2));

    public static void a() {
        WorldGenFactory.a(WorldGenIglooPiece.a.class, "Iglu");
    }

    public static void a(DefinedStructureManager definedstructuremanager, BlockPosition blockposition, EnumBlockRotation enumblockrotation, List<StructurePiece> list, Random random, WorldGenFeatureIglooConfiguration var5) {
        if (random.nextDouble() < 0.5D) {
            int i = random.nextInt(8) + 4;
            list.add(new WorldGenIglooPiece.a(definedstructuremanager, c, blockposition, enumblockrotation, i * 3));

            for(int j = 0; j < i - 1; ++j) {
                list.add(new WorldGenIglooPiece.a(definedstructuremanager, b, blockposition, enumblockrotation, j * 3));
            }
        }

        list.add(new WorldGenIglooPiece.a(definedstructuremanager, a, blockposition, enumblockrotation, 0));
    }
    ...
    public static class a extends DefinedStructurePiece {
        ...
        public a(DefinedStructureManager definedstructuremanager, MinecraftKey minecraftkey, BlockPosition blockposition, EnumBlockRotation enumblockrotation, int i) {
            ...
            this.c = blockposition.a(blockposition1.getX(), blockposition1.getY() - i, blockposition1.getZ());
        ...
        private void a(DefinedStructureManager definedstructuremanager) {
            ...
            DefinedStructureInfo definedstructureinfo = (new DefinedStructureInfo()).a(this.e).a(EnumBlockMirror.NONE).a((BlockPosition)WorldGenIglooPiece.d.get(this.d));
        ...
        public boolean a(GeneratorAccess generatoraccess, Random random, StructureBoundingBox structureboundingbox, ChunkCoordIntPair chunkcoordintpair) {
            ...
            BlockPosition blockposition1 = this.c.a(DefinedStructure.a(definedstructureinfo, new BlockPosition(3 - blockposition.getX(), 0, 0 - blockposition.getZ())));
            ...
            this.c = this.c.a(0, i - 90 - 1, 0);
            boolean flag = super.a(generatoraccess, random, structureboundingbox, chunkcoordintpair);
            if (this.d.equals(WorldGenIglooPiece.a)) {
                BlockPosition blockposition3 = this.c.a(DefinedStructure.a(definedstructureinfo, new BlockPosition(3, 0, 5)));
