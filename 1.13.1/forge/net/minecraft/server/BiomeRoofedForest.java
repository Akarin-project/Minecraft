...
public final class BiomeRoofedForest extends BiomeBase {
    public BiomeRoofedForest() {
        super((new BiomeBase.a()).a(new WorldGenSurfaceComposite(au, ai)).a(BiomeBase.Precipitation.RAIN).a(BiomeBase.Geography.FOREST).a(0.1F).b(0.2F).c(0.7F).d(0.8F).a(4159204).b(329011).a((String)null));
        this.a(WorldGenerator.g, new WorldGenMansionConfiguration());
        ...
        this.a(WorldGenStage.Decoration.VEGETAL_DECORATION, a(WorldGenerator.ap, new WorldGenFeatureRandomChoiceConfiguration(new WorldGenerator[]{WorldGenerator.U, WorldGenerator.T, WorldGenerator.y, WorldGenerator.s}, new WorldGenFeatureConfiguration[]{WorldGenFeatureConfiguration.e, WorldGenFeatureConfiguration.e, WorldGenFeatureConfiguration.e, WorldGenFeatureConfiguration.e}, new float[]{0.025F, 0.05F, 0.6666667F, 0.1F}, WorldGenerator.C, WorldGenFeatureConfiguration.e), M, WorldGenFeatureDecoratorConfiguration.e));
        this.a(WorldGenStage.Decoration.VEGETAL_DECORATION, a(WorldGenerator.ao, new WorldGenFeatureRandomConfiguration(new WorldGenerator[]{WorldGenerator.aj, WorldGenerator.aj, WorldGenerator.aj}, new WorldGenFeatureConfiguration[]{new WorldGenFeatureDoublePlantConfiguration(Blocks.LILAC.getBlockData()), new WorldGenFeatureDoublePlantConfiguration(Blocks.ROSE_BUSH.getBlockData()), new WorldGenFeatureDoublePlantConfiguration(Blocks.PEONY.getBlockData())}, 0), i, new WorldGenDecoratorFrequencyConfiguration(5)));
        ...
        this.a(WorldGenStage.Decoration.VEGETAL_DECORATION, a(WorldGenerator.M, new WorldGenFeatureTallGrassConfiguration(Blocks.GRASS.getBlockData()), j, new WorldGenDecoratorFrequencyConfiguration(2)));
