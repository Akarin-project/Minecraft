...
public final class BiomeForestHills extends BiomeBase {
    public BiomeForestHills() {
        super((new BiomeBase.a()).a(new WorldGenSurfaceComposite(au, ai)).a(BiomeBase.Precipitation.RAIN).a(BiomeBase.Geography.FOREST).a(0.45F).b(0.3F).c(0.7F).d(0.8F).a(4159204).b(329011).a((String)null));
        ...
        this.a(WorldGenStage.Decoration.VEGETAL_DECORATION, a(WorldGenerator.ap, new WorldGenFeatureRandomChoiceConfiguration(new WorldGenerator[]{WorldGenerator.t, WorldGenerator.s}, new WorldGenFeatureConfiguration[]{WorldGenFeatureConfiguration.e, WorldGenFeatureConfiguration.e}, new float[]{0.2F, 0.1F}, WorldGenerator.C, WorldGenFeatureConfiguration.e), s, new WorldGenDecoratorFrequencyExtraChanceConfiguration(10, 0.1F, 1)));
