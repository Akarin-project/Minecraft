...
public final class BiomeBirchForestHillsMutated extends BiomeBase {
    public BiomeBirchForestHillsMutated() {
        super((new BiomeBase.a()).a(new WorldGenSurfaceComposite(au, ai)).a(BiomeBase.Precipitation.RAIN).a(BiomeBase.Geography.FOREST).a(0.55F).b(0.5F).c(0.6F).d(0.6F).a(4159204).b(329011).a("birch_forest_hills"));
        ...
        this.a(WorldGenStage.Decoration.VEGETAL_DECORATION, a(WorldGenerator.ap, new WorldGenFeatureRandomChoiceConfiguration(new WorldGenerator[]{WorldGenerator.u}, new WorldGenFeatureConfiguration[]{WorldGenFeatureConfiguration.e}, new float[]{0.5F}, WorldGenerator.t, WorldGenFeatureConfiguration.e), s, new WorldGenDecoratorFrequencyExtraChanceConfiguration(10, 0.1F, 1)));
