...
public class EntityItemFrame extends EntityHanging {
    ...
    protected void x_() {
        this.getDataWatcher().register(e, ItemStack.a);
        this.getDataWatcher().register(f, 0);
    }
    ...
    protected void updateBoundingBox() {
        if (this.direction != null) {
            ...
            EnumDirection.EnumAxis enumdirection$enumaxis = this.direction.k();
    ...
    public boolean survives() {
        if (!this.world.getCubes(this, this.getBoundingBox())) {
            ...
            return iblockdata.getMaterial().isBuildable() || this.direction.k().c() && BlockDiodeAbstract.isDiode(iblockdata) ? this.world.getEntities(this, this.getBoundingBox(), a).isEmpty() : false;
        }
    }
    ...
    public ItemStack getItem() {
        return (ItemStack)this.getDataWatcher().get(e);
    }
    ...
    private void setItem(ItemStack itemstack, boolean flag) {
        ...
        this.getDataWatcher().set(e, itemstack);
        if (!itemstack.isEmpty()) {
    ...
    public void a(NBTTagCompound nbttagcompound) {
        ...
        if (nbttagcompound1 != null && !nbttagcompound1.isEmpty()) {
            ...
            if (itemstack.isEmpty()) {
                d.warn("Unable to load item from: {}", nbttagcompound1);
            }
