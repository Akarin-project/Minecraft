...
public abstract class EntityHuman extends EntityLiving {
    ...
    private ItemStack cd = ItemStack.a;
    private final ItemCooldown ce = this.g();
    @Nullable
    ...
    protected void initAttributes() {
        ...
        this.getAttributeInstance(GenericAttributes.MOVEMENT_SPEED).setValue((double)0.1F);
    ...
    protected void x_() {
        super.x_();
        this.datawatcher.register(a, 0.0F);
        this.datawatcher.register(b, 0);
        this.datawatcher.register(bx, (byte)0);
        this.datawatcher.register(by, (byte)1);
        this.datawatcher.register(bz, new NBTTagCompound());
        this.datawatcher.register(bA, new NBTTagCompound());
    }
    ...
    private void n() {
        IBlockData iblockdata = this.world.a(this.getBoundingBox().grow(0.0D, (double)-0.4F, 0.0D).shrink(0.001D), Blocks.BUBBLE_COLUMN);
        if (iblockdata != null) {
            if (!this.d && !this.justCreated && iblockdata.getBlock() == Blocks.BUBBLE_COLUMN && !this.isSpectator()) {
                boolean flag = iblockdata.get(BlockBubbleColumn.a);
                if (flag) {
    ...
    protected void dh() {
        ...
        if (fx != this.width || f1 != this.length) {
            AxisAlignedBB axisalignedbb = this.getBoundingBox();
            axisalignedbb = new AxisAlignedBB(axisalignedbb.a, axisalignedbb.b, axisalignedbb.c, axisalignedbb.a + (double)fx, axisalignedbb.b + (double)f1, axisalignedbb.c + (double)fx);
    ...
    public void a(SoundEffect soundeffect, float fx, float f1) {
        this.world.a(this, this.locX, this.locY, this.locZ, soundeffect, this.bV(), fx, f1);
    }
    ...
    public void k() {
        ...
        float fx = MathHelper.sqrt(this.motX * this.motX + this.motZ * this.motZ);
        float f1 = (float)(Math.atan(-this.motY * (double)0.2F) * 15.0D);
        if (fx > 0.1F) {
            fx = 0.1F;
        }
    ...
    public void die(DamageSource damagesource) {
        ...
        if (damagesource != null) {
            this.motX = (double)(-MathHelper.cos((this.aD + this.yaw) * ((float)Math.PI / 180F)) * 0.1F);
            this.motZ = (double)(-MathHelper.sin((this.aD + this.yaw) * ((float)Math.PI / 180F)) * 0.1F);
        } else {
            this.motX = 0.0D;
            this.motZ = 0.0D;
        }
    ...
    protected SoundEffect d(DamageSource damagesource) {
        if (damagesource == DamageSource.BURN) {
            return SoundEffects.ENTITY_PLAYER_HURT_ON_FIRE;
        } else {
            return damagesource == DamageSource.DROWN ? SoundEffects.ENTITY_PLAYER_HURT_DROWN : SoundEffects.ENTITY_PLAYER_HURT;
        }
    }
    ...
    public EntityItem a(ItemStack itemstack, boolean flag, boolean flag1) {
        if (itemstack.isEmpty()) {
            ...
            double d0 = this.locY - (double)0.3F + (double)this.getHeadHeight();
            ...
            if (flag) {
                float fx = this.random.nextFloat() * 0.5F;
                float f1 = this.random.nextFloat() * ((float)Math.PI * 2F);
                entityitem.motX = (double)(-MathHelper.sin(f1) * fx);
                entityitem.motZ = (double)(MathHelper.cos(f1) * fx);
                entityitem.motY = (double)0.2F;
            } else {
                float f2 = 0.3F;
                entityitem.motX = (double)(-MathHelper.sin(this.yaw * ((float)Math.PI / 180F)) * MathHelper.cos(this.pitch * ((float)Math.PI / 180F)) * f2);
                entityitem.motZ = (double)(MathHelper.cos(this.yaw * ((float)Math.PI / 180F)) * MathHelper.cos(this.pitch * ((float)Math.PI / 180F)) * f2);
                entityitem.motY = (double)(-MathHelper.sin(this.pitch * ((float)Math.PI / 180F)) * f2 + 0.1F);
    ...
    public float b(IBlockData iblockdata) {
        float fx = this.inventory.a(iblockdata);
        if (fx > 1.0F) {
        ...
        if (MobEffectUtil.a(this)) {
            fx *= 1.0F + (float)(MobEffectUtil.b(this) + 1) * 0.2F;
        }
    ...
    public boolean damageEntity(DamageSource damagesource, float fx) {
        if (this.isInvulnerable(damagesource)) {
            ...
            if (this.getHealth() <= 0.0F) {
                ...
                return fx == 0.0F ? false : super.damageEntity(damagesource, fx);
            }
        }
    }
    ...
    public boolean a(EntityHuman entityhuman1) {
        ...
        ScoreboardTeamBase scoreboardteambase1 = entityhuman1.be();
        if (scoreboardteambase == null) {
            return true;
        } else {
            return !scoreboardteambase.isAlly(scoreboardteambase1) ? true : scoreboardteambase.allowFriendlyFire();
        }
    }

    protected void damageArmor(float fx) {
        this.inventory.a(fx);
    }

    protected void damageShield(float fx) {
        if (fx >= 3.0F && this.activeItem.getItem() == Items.SHIELD) {
            int i = 1 + MathHelper.d(fx);
    ...
    protected void damageEntity0(DamageSource damagesource, float fx) {
        if (!this.isInvulnerable(damagesource)) {
            fx = this.applyArmorModifier(damagesource, fx);
            fx = this.applyMagicModifier(damagesource, fx);
            float f1 = fx;
            fx = Math.max(fx - this.getAbsorptionHearts(), 0.0F);
            this.setAbsorptionHearts(this.getAbsorptionHearts() - (f1 - fx));
            float f2 = f1 - fx;
            ...
            if (fx != 0.0F) {
                ...
                this.setHealth(this.getHealth() - fx);
                this.getCombatTracker().trackDamage(damagesource, f3, fx);
                if (fx < 3.4028235E37F) {
                    this.a(StatisticList.DAMAGE_TAKEN, Math.round(fx * 10.0F));
                }
    ...
    public void a(TileEntityCommand var1) {
    }

    public void a(TileEntityStructure var1) {
    }
    ...
    public void openHorseInventory(EntityHorseAbstract var1, IInventory var2) {
    }
    ...
    public void attack(Entity entity) {
        if (entity.bk()) {
            if (!entity.t(this)) {
                float fx = (float)this.getAttributeInstance(GenericAttributes.ATTACK_DAMAGE).getValue();
                float f1;
                ...
                if (fx > 0.0F || f1 > 0.0F) {
                    ...
                    boolean flag5 = entity.damageEntity(DamageSource.playerAttack(this), fx);
                    if (flag5) {
                        if (i > 0) {
                            if (entity instanceof EntityLiving) {
                                ((EntityLiving)entity).a(this, (float)i * 0.5F, (double)MathHelper.sin(this.yaw * ((float)Math.PI / 180F)), (double)(-MathHelper.cos(this.yaw * ((float)Math.PI / 180F))));
                            } else {
                                entity.f((double)(-MathHelper.sin(this.yaw * ((float)Math.PI / 180F)) * (float)i * 0.5F), 0.1D, (double)(MathHelper.cos(this.yaw * ((float)Math.PI / 180F)) * (float)i * 0.5F));
                            }
                        ...
                        if (flag3) {
                            float f3 = 1.0F + EnchantmentManager.a(this) * fx;
                            ...
                            for(EntityLiving entityliving : this.world.a(EntityLiving.class, entity.getBoundingBox().grow(1.0D, 0.25D, 1.0D))) {
                                if (entityliving != this && entityliving != entity && !this.r(entityliving) && (!(entityliving instanceof EntityArmorStand) || !((EntityArmorStand)entityliving).isMarker()) && this.h(entityliving) < 9.0D) {
                                    entityliving.a(this, 0.4F, (double)MathHelper.sin(this.yaw * ((float)Math.PI / 180F)), (double)(-MathHelper.cos(this.yaw * ((float)Math.PI / 180F))));
                                    entityliving.damageEntity(DamageSource.playerAttack(this), f3);
                                }
                            }
                        ...
                        if (entity instanceof EntityLiving) {
                            float f5 = f4 - ((EntityLiving)entity).getHealth();
    ...
    public void p(boolean flag) {
        float fx = 0.25F + (float)EnchantmentManager.getDigSpeedEnchantmentLevel(this) * 0.05F;
        if (flag) {
            fx += 0.75F;
        }

        if (this.random.nextFloat() < fx) {
    ...
    public void dl() {
        double d0 = (double)(-MathHelper.sin(this.yaw * ((float)Math.PI / 180F)));
        double d1 = (double)MathHelper.cos(this.yaw * ((float)Math.PI / 180F));
    ...
    public EntityHuman.EnumBedResult a(BlockPosition blockposition) {
        ...
        if (!this.world.isClientSide) {
            ...
            if (!this.u()) {
                double d0 = 8.0D;
                double d1 = 5.0D;
                List list = this.world.a(EntityMonster.class, new AxisAlignedBB((double)blockposition.getX() - 8.0D, (double)blockposition.getY() - 5.0D, (double)blockposition.getZ() - 8.0D, (double)blockposition.getX() + 8.0D, (double)blockposition.getY() + 5.0D, (double)blockposition.getZ() + 8.0D), new EntityHuman.c(this));
                if (!list.isEmpty()) {
        ...
        if (this.world.isLoaded(blockposition)) {
            float f1 = 0.5F + (float)enumdirection.getAdjacentX() * 0.4F;
            float fx = 0.5F + (float)enumdirection.getAdjacentZ() * 0.4F;
            this.a(enumdirection);
            this.setPosition((double)((float)blockposition.getX() + f1), (double)((float)blockposition.getY() + 0.6875F), (double)((float)blockposition.getZ() + fx));
        } else {
    ...
    public int a(Collection<IRecipe> var1) {
        return 0;
    }

    public void a(MinecraftKey[] var1) {
    }

    public int b(Collection<IRecipe> var1) {
        return 0;
    }
    ...
    public void a(float fx, float f1, float f2) {
        double d0 = this.locX;
        double d1 = this.locY;
        double d2 = this.locZ;
    ...
    public void checkMovement(double d0, double d1, double d2) {
        if (!this.isPassenger()) {
            if (this.isSwimming()) {
                ...
                int j = Math.round(MathHelper.sqrt(d0 * d0 + d1 * d1 + d2 * d2) * 100.0F);
                if (j > 0) {
                    this.a(StatisticList.WALK_UNDER_WATER_ONE_CM, j);
                    this.applyExhaustion(0.01F * (float)j * 0.01F);
                }
            } else if (this.isInWater()) {
                int k = Math.round(MathHelper.sqrt(d0 * d0 + d2 * d2) * 100.0F);
                if (k > 0) {
                    this.a(StatisticList.WALK_ON_WATER_ONE_CM, k);
                ...
                int l = Math.round(MathHelper.sqrt(d0 * d0 + d2 * d2) * 100.0F);
                if (l > 0) {
                    if (this.isSprinting()) {
                        this.a(StatisticList.SPRINT_ONE_CM, l);
                        this.applyExhaustion(0.1F * (float)l * 0.01F);
                    } else if (this.isSneaking()) {
                        this.a(StatisticList.CROUCH_ONE_CM, l);
                        this.applyExhaustion(0.0F * (float)l * 0.01F);
                    } else {
                        this.a(StatisticList.WALK_ONE_CM, l);
                        this.applyExhaustion(0.0F * (float)l * 0.01F);
                    }
                }
            } else if (this.dc()) {
                int i1 = Math.round(MathHelper.sqrt(d0 * d0 + d1 * d1 + d2 * d2) * 100.0F);
                this.a(StatisticList.AVIATE_ONE_CM, i1);
            } else {
                int j1 = Math.round(MathHelper.sqrt(d0 * d0 + d2 * d2) * 100.0F);
                if (j1 > 25) {
                    this.a(StatisticList.FLY_ONE_CM, j1);
                }
            }
    ...
    public void c(float fx, float f1) {
        if (!this.abilities.canFly) {
            if (fx >= 2.0F) {
                this.a(StatisticList.FALL_ONE_CM, (int)Math.round((double)fx * 100.0D));
            }
    ...
    public void giveExp(int i) {
        ...
        while(this.exp < 0.0F) {
            float fx = this.exp * (float)this.getExpToLevel();
            if (this.expLevel > 0) {
                this.levelDown(-1);
                this.exp = 1.0F + fx / (float)this.getExpToLevel();
            } else {
                this.levelDown(-1);
                this.exp = 0.0F;
            }
    ...
    public void enchantDone(ItemStack var1, int i) {
        this.expLevel -= i;
        if (this.expLevel < 0) {
            this.expLevel = 0;
            this.exp = 0.0F;
    ...
    public void levelDown(int i) {
        ...
        if (i > 0 && this.expLevel % 5 == 0 && (float)this.g < (float)this.ticksLived - 100.0F) {
            float fx = this.expLevel > 30 ? 1.0F : (float)this.expLevel / 30.0F;
            this.world.a((EntityHuman)null, this.locX, this.locY, this.locZ, SoundEffects.ENTITY_PLAYER_LEVELUP, this.bV(), fx * 0.75F, 1.0F);
    ...
    public int getExpToLevel() {
        if (this.expLevel >= 30) {
            ...
            return this.expLevel >= 15 ? 37 + (this.expLevel - 15) * 5 : 7 + this.expLevel * 2;
        }
    }

    public void applyExhaustion(float fx) {
    ...
    public ItemStack getEquipment(EnumItemSlot enumitemslot) {
        if (enumitemslot == EnumItemSlot.MAINHAND) {
            ...
            return enumitemslot.a() == EnumItemSlot.Function.ARMOR ? (ItemStack)this.inventory.armor.get(enumitemslot.b()) : ItemStack.a;
        }
    }
    ...
    public void setAbsorptionHearts(float fx) {
        if (fx < 0.0F) {
            fx = 0.0F;
        }

        this.getDataWatcher().set(a, fx);
    }

    public float getAbsorptionHearts() {
        return this.getDataWatcher().get(a);
    }
    ...
    public EnumMainHand getMainHand() {
        return this.datawatcher.get(by) == 0 ? EnumMainHand.LEFT : EnumMainHand.RIGHT;
    }

    public void a(EnumMainHand enummainhand) {
        this.datawatcher.set(by, (byte)(enummainhand == EnumMainHand.LEFT ? 0 : 1));
    }

    public NBTTagCompound getShoulderEntityLeft() {
        return (NBTTagCompound)this.datawatcher.get(bz);
    }

    public void setShoulderEntityLeft(NBTTagCompound nbttagcompound) {
        this.datawatcher.set(bz, nbttagcompound);
    }

    public NBTTagCompound getShoulderEntityRight() {
        return (NBTTagCompound)this.datawatcher.get(bA);
    }

    public void setShoulderEntityRight(NBTTagCompound nbttagcompound) {
        this.datawatcher.set(bA, nbttagcompound);
    }
    ...
    public float r(float fx) {
        return MathHelper.a(((float)this.aH + fx) / this.dG(), 0.0F, 1.0F);
    }
    ...
    public static enum EnumChatVisibility {
        ...
        private EnumChatVisibility(int j, String s1) {
            this.e = j;
            this.f = s1;
        }
