...
public class ItemBow extends Item {
    public ItemBow(Item.Info item$info) {
        super(item$info);
        this.a(new MinecraftKey("pull"), (itemstack, var1, entityliving) -> {
            if (entityliving == null) {
                return 0.0F;
            } else {
                return entityliving.cW().getItem() != Items.BOW ? 0.0F : (float)(itemstack.k() - entityliving.cX()) / 20.0F;
            }
        });
        this.a(new MinecraftKey("pulling"), (itemstack, var1, entityliving) -> {
        ...
        if (entityliving instanceof EntityHuman) {
            ...
            if (!itemstack1.isEmpty() || flag) {
                ...
                if (!((double)f < 0.1D)) {
                    ...
                    world.a((EntityHuman)null, entityhuman.locX, entityhuman.locY, entityhuman.locZ, SoundEffects.ENTITY_ARROW_SHOOT, SoundCategory.PLAYERS, 1.0F, 1.0F / (i.nextFloat() * 0.4F + 1.2F) + f * 0.5F);
