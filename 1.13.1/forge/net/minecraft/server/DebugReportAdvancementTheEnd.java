...
public class DebugReportAdvancementTheEnd implements Consumer<Consumer<Advancement>> {
    ...
    public void a(Consumer<Advancement> consumer) {
        ...
        Advancement advancement3 = Advancement.SerializedAdvancement.a().a(advancement1).a(Items.END_CRYSTAL, new ChatMessage("advancements.end.respawn_dragon.title", new Object[0]), new ChatMessage("advancements.end.respawn_dragon.description", new Object[0]), (MinecraftKey)null, AdvancementFrameType.GOAL, true, true, false).a("summoned_dragon", CriterionTriggerSummonedEntity.b.a(CriterionConditionEntity.a.a().a(EntityTypes.ENDER_DRAGON))).a(consumer, "end/respawn_dragon");
        Advancement advancement4 = Advancement.SerializedAdvancement.a().a(advancement2).a(Blocks.PURPUR_BLOCK, new ChatMessage("advancements.end.find_end_city.title", new Object[0]), new ChatMessage("advancements.end.find_end_city.description", new Object[0]), (MinecraftKey)null, AdvancementFrameType.TASK, true, true, false).a("in_city", CriterionTriggerLocation.b.a(CriterionConditionLocation.a("EndCity"))).a(consumer, "end/find_end_city");
        Advancement advancement5 = Advancement.SerializedAdvancement.a().a(advancement1).a(Items.DRAGON_BREATH, new ChatMessage("advancements.end.dragon_breath.title", new Object[0]), new ChatMessage("advancements.end.dragon_breath.description", new Object[0]), (MinecraftKey)null, AdvancementFrameType.GOAL, true, true, false).a("dragon_breath", CriterionTriggerInventoryChanged.b.a(Items.DRAGON_BREATH)).a(consumer, "end/dragon_breath");
        Advancement advancement6 = Advancement.SerializedAdvancement.a().a(advancement4).a(Items.SHULKER_SHELL, new ChatMessage("advancements.end.levitate.title", new Object[0]), new ChatMessage("advancements.end.levitate.description", new Object[0]), (MinecraftKey)null, AdvancementFrameType.CHALLENGE, true, true, false).a(AdvancementRewards.a.a(50)).a("levitated", CriterionTriggerLevitation.b.a(CriterionConditionDistance.b(CriterionConditionValue.c.b(50.0F)))).a(consumer, "end/levitate");
        Advancement advancement7 = Advancement.SerializedAdvancement.a().a(advancement4).a(Items.ELYTRA, new ChatMessage("advancements.end.elytra.title", new Object[0]), new ChatMessage("advancements.end.elytra.description", new Object[0]), (MinecraftKey)null, AdvancementFrameType.GOAL, true, true, false).a("elytra", CriterionTriggerInventoryChanged.b.a(Items.ELYTRA)).a(consumer, "end/elytra");
        Advancement advancement8 = Advancement.SerializedAdvancement.a().a(advancement1).a(Blocks.DRAGON_EGG, new ChatMessage("advancements.end.dragon_egg.title", new Object[0]), new ChatMessage("advancements.end.dragon_egg.description", new Object[0]), (MinecraftKey)null, AdvancementFrameType.GOAL, true, true, false).a("dragon_egg", CriterionTriggerInventoryChanged.b.a(Blocks.DRAGON_EGG)).a(consumer, "end/dragon_egg");
    }
