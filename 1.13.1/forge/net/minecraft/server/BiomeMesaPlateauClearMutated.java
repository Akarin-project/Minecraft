...
public final class BiomeMesaPlateauClearMutated extends BiomeBase {
    public BiomeMesaPlateauClearMutated() {
        super((new BiomeBase.a()).a(new WorldGenSurfaceComposite(aA, aq)).a(BiomeBase.Precipitation.NONE).a(BiomeBase.Geography.MESA).a(0.45F).b(0.3F).c(2.0F).d(0.0F).a(4159204).b(329011).a("badlands_plateau"));
