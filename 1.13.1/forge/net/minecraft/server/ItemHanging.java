...
public class ItemHanging extends Item {
    ...
    public ItemHanging(Class<? extends EntityHanging> oclass, Item.Info item$info) {
        super(item$info);
        this.a = oclass;
    }
    ...
    private EntityHanging a(World world, BlockPosition blockposition, EnumDirection enumdirection) {
        if (this.a == EntityPainting.class) {
            ...
            return this.a == EntityItemFrame.class ? new EntityItemFrame(world, blockposition, enumdirection) : null;
        }
    }
}
