...
public class ChatComponentSelector extends ChatBaseComponent {
    ...
    public ChatComponentSelector(String s) {
        ...
        try {
            ...
            b.warn("Invalid selector component: {}", s, commandsyntaxexception.getMessage());
        }
    ...
    public boolean equals(Object object) {
        if (this == object) {
            ...
            ChatComponentSelector chatcomponentselector1 = (ChatComponentSelector)object;
            return this.c.equals(chatcomponentselector1.c) && super.equals(object);
        }
    }
