...
public class CriterionConditionLocation {
    ...
    public CriterionConditionLocation(CriterionConditionValue.c criterionconditionvalue$c, CriterionConditionValue.c criterionconditionvalue$c1, CriterionConditionValue.c criterionconditionvalue$c2, @Nullable BiomeBase biomebase, @Nullable String s, @Nullable DimensionManager dimensionmanager) {
    ...
    public boolean a(WorldServer worldserver, float fx, float f1, float f2) {
        if (!this.b.d(fx)) {
            return false;
        } else if (!this.c.d(f1)) {
            return false;
            ...
            BlockPosition blockposition = new BlockPosition((double)fx, (double)f1, (double)f2);
    ...
    public static CriterionConditionLocation a(@Nullable JsonElement jsonelement) {
        if (jsonelement != null && !jsonelement.isJsonNull()) {
            ...
            CriterionConditionValue.c criterionconditionvalue$c = CriterionConditionValue.c.a(jsonobject1.get("x"));
            CriterionConditionValue.c criterionconditionvalue$c1 = CriterionConditionValue.c.a(jsonobject1.get("y"));
            CriterionConditionValue.c criterionconditionvalue$c2 = CriterionConditionValue.c.a(jsonobject1.get("z"));
            ...
            return new CriterionConditionLocation(criterionconditionvalue$c, criterionconditionvalue$c1, criterionconditionvalue$c2, biomebase, s, dimensionmanager);
        } else {
            return a;
        }
    }
