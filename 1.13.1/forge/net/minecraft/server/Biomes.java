...
public abstract class Biomes {
    ...
    private static BiomeBase a(String sx) {
        BiomeBase biomebase = IRegistry.BIOME.get(new MinecraftKey(sx));
        if (biomebase == null) {
            throw new IllegalStateException("Invalid Biome requested: " + sx);
        } else {
            return biomebase;
        }
    }
