...
public class BlockCrops extends BlockPlant implements IBlockFragilePlantElement {
    ...
    protected BlockCrops(Block.Info block$info) {
        super(block$info);
        this.v((IBlockData)(this.blockStateList.getBlockData()).set(this.d(), Integer.valueOf(0)));
    }

    public VoxelShape a(IBlockData iblockdata, IBlockAccess var2, BlockPosition var3) {
        return a[iblockdata.get(this.d())];
    }
    ...
    public boolean w(IBlockData iblockdata) {
        return iblockdata.get(this.d()) >= this.e();
    }
