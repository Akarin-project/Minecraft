    ...
    public boolean a(GeneratorAccess generatoraccess, Random var2, StructureBoundingBox structureboundingbox, ChunkCoordIntPair var4) {
        if (!this.a(generatoraccess, structureboundingbox, 0)) {
            ...
            if (!this.e) {
                ...
                int i1 = this.d(2);
                int k = this.b(2, 5);
                if (structureboundingbox.b(new BlockPosition(l, i1, k))) {
                    this.e = true;
                    EntityWitch entitywitch = new EntityWitch(generatoraccess.getMinecraftWorld());
                    entitywitch.di();
                    entitywitch.setPositionRotation((double)l + 0.5D, (double)i1, (double)k + 0.5D, 0.0F, 0.0F);
                    entitywitch.prepare(generatoraccess.getDamageScaler(new BlockPosition(l, i1, k)), (GroupDataEntity)null, (NBTTagCompound)null);
