...
public class WorldGenFeatureRandomChoiceConfiguration implements WorldGenFeatureConfiguration {
    ...
    public <FC extends WorldGenFeatureConfiguration> WorldGenFeatureRandomChoiceConfiguration(WorldGenerator<?>[] aworldgenerator, WorldGenFeatureConfiguration[] aworldgenfeatureconfiguration, float[] afloat, WorldGenerator<FC> worldgenerator, FC worldgenfeatureconfiguration) {
        this.a = aworldgenerator;
        this.b = aworldgenfeatureconfiguration;
        this.c = afloat;
        this.d = worldgenerator;
        this.f = worldgenfeatureconfiguration;
    }
}
