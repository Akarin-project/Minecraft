...
public class LootEntityPropertyOnFire implements LootEntityProperty {
    ...
    public boolean a(Random var1, Entity entity) {
    ...
    public static class a extends LootEntityProperty.a<LootEntityPropertyOnFire> {
        ...
        public JsonElement a(LootEntityPropertyOnFire lootentitypropertyonfire, JsonSerializationContext var2) {
            return new JsonPrimitive(lootentitypropertyonfire.a);
        }

        public LootEntityPropertyOnFire b(JsonElement jsonelement, JsonDeserializationContext var2) {
