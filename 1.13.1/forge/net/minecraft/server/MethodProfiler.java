...
public class MethodProfiler {
    ...
    public void e() {
        if (this.d && !this.c.isEmpty()) {
            ...
            long j = this.c.remove(this.c.size() - 1);
            ...
            if (k > 100000000L) {
                a.warn("Something's taking too long! '{}' took aprox {} ms", this.e, (double)k / 1000000.0D);
            }
    ...
    public List<MethodProfiler.ProfilerInfo> b(String s) {
        long i = this.f.containsKey("root") ? this.f.get("root") : 0L;
        long j = this.f.containsKey(s) ? this.f.get(s) : -1L;
        ...
        for(String s4 : this.f.keySet()) {
            this.f.put(s4, this.f.get(s4) * 999L / 1000L);
        }

        if ((float)k > fx) {
            arraylist.add(new MethodProfiler.ProfilerInfo("unspecified", (double)((float)k - fx) * 100.0D / (double)k, (double)((float)k - fx) * 100.0D / (double)i));
        }
    ...
    public static final class ProfilerInfo implements Comparable<MethodProfiler.ProfilerInfo> {
        ...
        public int a(MethodProfiler.ProfilerInfo methodprofiler$profilerinfo1) {
            if (methodprofiler$profilerinfo1.a < this.a) {
                return -1;
            } else {
                return methodprofiler$profilerinfo1.a > this.a ? 1 : methodprofiler$profilerinfo1.c.compareTo(this.c);
            }
        }
