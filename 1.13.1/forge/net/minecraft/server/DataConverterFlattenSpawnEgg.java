    ...
    public TypeRewriteRule makeRule() {
        ...
        return this.fixTypeEverywhereTyped("ItemInstanceSpawnEggFix", type, (typed) -> {
            ...
            if (optional.isPresent() && Objects.equals(((Pair)optional.get()).getSecond(), "minecraft:spawn_egg")) {
                ...
                Optional optional1 = typed2.getOptional(opticfinder1);
                if (optional1.isPresent()) {
                    return typed.set(opticfinder, Pair.of(DataConverterTypes.q.typeName(), a.getOrDefault(optional1.get(), "minecraft:pig_spawn_egg")));
                }
            }
