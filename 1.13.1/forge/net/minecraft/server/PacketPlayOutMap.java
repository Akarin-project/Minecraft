...
public class PacketPlayOutMap implements Packet<PacketListenerPlayOut> {
    ...
    public PacketPlayOutMap(int ix, byte b0, boolean flag, Collection<MapIcon> collection, byte[] abyte, int j, int k, int l, int i1) {
        this.a = ix;
        this.b = b0;
        this.c = flag;
    ...
    public void a(PacketDataSerializer packetdataserializer) throws IOException {
        ...
        for(int ix = 0; ix < this.d.length; ++ix) {
            MapIcon.Type mapicon$type = (MapIcon.Type)packetdataserializer.a(MapIcon.Type.class);
            this.d[ix] = new MapIcon(mapicon$type, packetdataserializer.readByte(), packetdataserializer.readByte(), (byte)(packetdataserializer.readByte() & 15), packetdataserializer.readBoolean() ? packetdataserializer.f() : null);
        }
