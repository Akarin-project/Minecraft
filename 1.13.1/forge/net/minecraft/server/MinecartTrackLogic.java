...
public class MinecartTrackLogic {
    ...
    private void d() {
        for(int i = 0; i < this.f.size(); ++i) {
            MinecartTrackLogic minecarttracklogic1 = this.b((BlockPosition)this.f.get(i));
            if (minecarttracklogic1 != null && minecarttracklogic1.a(this)) {
                this.f.set(i, minecarttracklogic1.b);
            } else {
                this.f.remove(i--);
            }
        }
    ...
    private boolean a(MinecartTrackLogic minecarttracklogic1) {
        return this.c(minecarttracklogic1.b);
    }
    ...
    private boolean b(MinecartTrackLogic minecarttracklogic1) {
        return this.a(minecarttracklogic1) || this.f.size() != 2;
    }

    private void c(MinecartTrackLogic minecarttracklogic1) {
        this.f.add(minecarttracklogic1.b);
    ...
    private boolean d(BlockPosition blockposition) {
        MinecartTrackLogic minecarttracklogic1 = this.b(blockposition);
        if (minecarttracklogic1 == null) {
            return false;
        } else {
            minecarttracklogic1.d();
            return minecarttracklogic1.b(this);
        }
    }
    ...
    public MinecartTrackLogic a(boolean flag, boolean flag1) {
        ...
        if (flag1 || this.a.getType(this.b) != this.d) {
            ...
            for(int i = 0; i < this.f.size(); ++i) {
                ...
                if (minecarttracklogic1 != null) {
                    minecarttracklogic1.d();
                    if (minecarttracklogic1.b(this)) {
                        minecarttracklogic1.c(this);
                    }
                }
            }
        }
