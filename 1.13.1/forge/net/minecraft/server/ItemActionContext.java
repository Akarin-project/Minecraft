...
public class ItemActionContext {
    ...
    public ItemActionContext(EntityHuman entityhuman, ItemStack itemstack, BlockPosition blockposition, EnumDirection enumdirection, float fx, float f1, float f2) {
        this(entityhuman.world, entityhuman, itemstack, blockposition, enumdirection, fx, f1, f2);
    }

    protected ItemActionContext(World world, @Nullable EntityHuman entityhuman, ItemStack itemstack, BlockPosition blockposition, EnumDirection enumdirection, float fx, float f1, float f2) {
        this.b = entityhuman;
