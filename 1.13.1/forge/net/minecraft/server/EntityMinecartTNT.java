...
public class EntityMinecartTNT extends EntityMinecartAbstract {
    ...
    public void a(DamageSource damagesource) {
        double d0 = this.motX * this.motX + this.motZ * this.motZ;
        if (!damagesource.p() && !damagesource.isExplosion() && !(d0 >= (double)0.01F)) {
    ...
    public float a(Explosion explosion, IBlockAccess iblockaccess, BlockPosition blockposition, IBlockData iblockdata, Fluid fluid, float f) {
        return !this.k() || !iblockdata.a(TagsBlock.RAILS) && !iblockaccess.getType(blockposition.up()).a(TagsBlock.RAILS) ? super.a(explosion, iblockaccess, blockposition, iblockdata, fluid, f) : 0.0F;
    }

    public boolean a(Explosion explosion, IBlockAccess iblockaccess, BlockPosition blockposition, IBlockData iblockdata, float f) {
        return !this.k() || !iblockdata.a(TagsBlock.RAILS) && !iblockaccess.getType(blockposition.up()).a(TagsBlock.RAILS) ? super.a(explosion, iblockaccess, blockposition, iblockdata, f) : false;
    }
