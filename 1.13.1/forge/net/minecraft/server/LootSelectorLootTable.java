...
public class LootSelectorLootTable extends LootSelectorEntry {
    ...
    protected void a(JsonObject jsonobject, JsonSerializationContext var2) {
        jsonobject.addProperty("name", this.a.toString());
    }

    public static LootSelectorLootTable a(JsonObject jsonobject, JsonDeserializationContext var1, int i, int j, LootItemCondition[] alootitemcondition) {
