...
public class DebugReportAdvancementAdventure implements Consumer<Consumer<Advancement>> {
    ...
    public void a(Consumer<Advancement> consumer) {
        ...
        Advancement advancement9 = Advancement.SerializedAdvancement.a().a(advancement3).a(Blocks.CARVED_PUMPKIN, new ChatMessage("advancements.adventure.summon_iron_golem.title", new Object[0]), new ChatMessage("advancements.adventure.summon_iron_golem.description", new Object[0]), (MinecraftKey)null, AdvancementFrameType.GOAL, true, true, false).a("summoned_golem", CriterionTriggerSummonedEntity.b.a(CriterionConditionEntity.a.a().a(EntityTypes.IRON_GOLEM))).a(consumer, "adventure/summon_iron_golem");
        Advancement advancement10 = Advancement.SerializedAdvancement.a().a(advancement6).a(Items.ARROW, new ChatMessage("advancements.adventure.sniper_duel.title", new Object[0]), new ChatMessage("advancements.adventure.sniper_duel.description", new Object[0]), (MinecraftKey)null, AdvancementFrameType.CHALLENGE, true, true, false).a(AdvancementRewards.a.a(50)).a("killed_skeleton", CriterionTriggerKilled.b.a(CriterionConditionEntity.a.a().a(EntityTypes.SKELETON).a(CriterionConditionDistance.a(CriterionConditionValue.c.b(50.0F))), CriterionConditionDamageSource.a.a().a(true))).a(consumer, "adventure/sniper_duel");
        Advancement advancement11 = Advancement.SerializedAdvancement.a().a(advancement4).a(Items.TOTEM_OF_UNDYING, new ChatMessage("advancements.adventure.totem_of_undying.title", new Object[0]), new ChatMessage("advancements.adventure.totem_of_undying.description", new Object[0]), (MinecraftKey)null, AdvancementFrameType.GOAL, true, true, false).a("used_totem", CriterionTriggerUsedTotem.b.a(Items.TOTEM_OF_UNDYING)).a(consumer, "adventure/totem_of_undying");
    }
    ...
    private Advancement.SerializedAdvancement a(Advancement.SerializedAdvancement advancement$serializedadvancement) {
        for(EntityTypes entitytypes : b) {
            advancement$serializedadvancement.a(IRegistry.ENTITY_TYPE.getKey(entitytypes).toString(), CriterionTriggerKilled.b.a(CriterionConditionEntity.a.a().a(entitytypes)));
        }
    ...
    private Advancement.SerializedAdvancement b(Advancement.SerializedAdvancement advancement$serializedadvancement) {
        for(BiomeBase biomebase : a) {
            advancement$serializedadvancement.a(IRegistry.BIOME.getKey(biomebase).toString(), CriterionTriggerLocation.b.a(CriterionConditionLocation.a(biomebase)));
        }
