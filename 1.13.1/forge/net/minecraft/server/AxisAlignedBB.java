...
public class AxisAlignedBB {
    ...
    public double a(EnumDirection.EnumAxis enumdirection$enumaxis) {
        return enumdirection$enumaxis.a(this.a, this.b, this.c);
    }

    public double b(EnumDirection.EnumAxis enumdirection$enumaxis) {
        return enumdirection$enumaxis.a(this.d, this.e, this.f);
    }
    ...
    public boolean equals(Object object) {
        if (this == object) {
            ...
            AxisAlignedBB axisalignedbb1 = (AxisAlignedBB)object;
            if (Double.compare(axisalignedbb1.a, this.a) != 0) {
                return false;
            } else if (Double.compare(axisalignedbb1.b, this.b) != 0) {
                return false;
            } else if (Double.compare(axisalignedbb1.c, this.c) != 0) {
                return false;
            } else if (Double.compare(axisalignedbb1.d, this.d) != 0) {
                return false;
            } else if (Double.compare(axisalignedbb1.e, this.e) != 0) {
                return false;
            } else {
                return Double.compare(axisalignedbb1.f, this.f) == 0;
            }
        }
    }
    ...
    public AxisAlignedBB a(AxisAlignedBB axisalignedbb1) {
        double d0 = Math.max(this.a, axisalignedbb1.a);
        double d1 = Math.max(this.b, axisalignedbb1.b);
        double d2 = Math.max(this.c, axisalignedbb1.c);
        double d3 = Math.min(this.d, axisalignedbb1.d);
        double d4 = Math.min(this.e, axisalignedbb1.e);
        double d5 = Math.min(this.f, axisalignedbb1.f);
        return new AxisAlignedBB(d0, d1, d2, d3, d4, d5);
    }

    public AxisAlignedBB b(AxisAlignedBB axisalignedbb1) {
        double d0 = Math.min(this.a, axisalignedbb1.a);
        double d1 = Math.min(this.b, axisalignedbb1.b);
        double d2 = Math.min(this.c, axisalignedbb1.c);
        double d3 = Math.max(this.d, axisalignedbb1.d);
        double d4 = Math.max(this.e, axisalignedbb1.e);
        double d5 = Math.max(this.f, axisalignedbb1.f);
        return new AxisAlignedBB(d0, d1, d2, d3, d4, d5);
    }
    ...
    public boolean c(AxisAlignedBB axisalignedbb1) {
        return this.a(axisalignedbb1.a, axisalignedbb1.b, axisalignedbb1.c, axisalignedbb1.d, axisalignedbb1.e, axisalignedbb1.f);
    }
    ...
    public static MovingObjectPosition a(Iterable<AxisAlignedBB> iterable, Vec3D vec3d, Vec3D vec3d1, BlockPosition blockposition) {
        ...
        for(AxisAlignedBB axisalignedbb : iterable) {
            enumdirection = a(axisalignedbb.a(blockposition), vec3d, adouble, enumdirection, d0, d1, d2);
        }
