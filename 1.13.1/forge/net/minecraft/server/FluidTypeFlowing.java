...
public abstract class FluidTypeFlowing extends FluidType {
    ...
    public Vec3D a(IWorldReader iworldreader, BlockPosition blockposition, Fluid fluid) {
        ...
        try (BlockPosition.b blockposition$b = BlockPosition.b.r()) {
            for(EnumDirection enumdirection : EnumDirection.EnumDirectionLimit.HORIZONTAL) {
                ...
                Fluid fluid1 = iworldreader.b(blockposition$b);
                if (this.g(fluid1)) {
                    float f = fluid1.f();
                    float f1 = 0.0F;
                    if (f == 0.0F) {
                        if (!iworldreader.getType(blockposition$b).getMaterial().isSolid()) {
                            Fluid fluid2 = iworldreader.b(blockposition$b.down());
                            if (this.g(fluid2)) {
                                f = fluid2.f();
                                if (f > 0.0F) {
            ...
            if (fluid.get(FALLING)) {
                for(EnumDirection enumdirection1 : EnumDirection.EnumDirectionLimit.HORIZONTAL) {
                    blockposition$b.j(blockposition).d(enumdirection1);
                    if (this.a(iworldreader, blockposition$b, enumdirection1) || this.a(iworldreader, blockposition$b.up(), enumdirection1)) {
    ...
    private void a(GeneratorAccess generatoraccess, BlockPosition blockposition, Fluid fluid, IBlockData iblockdata) {
        int i = fluid.g() - this.c(generatoraccess);
        if (fluid.get(FALLING)) {
            i = 7;
        }
    ...
    protected Fluid a(IWorldReader iworldreader, BlockPosition blockposition, IBlockData iblockdata) {
        ...
        for(EnumDirection enumdirection : EnumDirection.EnumDirectionLimit.HORIZONTAL) {
            ...
            if (fluid.c().a(this) && this.a(enumdirection, iworldreader, blockposition, iblockdata, blockposition1, iblockdata1)) {
                if (fluid.d()) {
                    ++j;
                }
        ...
        if (!fluid2.e() && fluid2.c().a(this) && this.a(EnumDirection.UP, iworldreader, blockposition, iblockdata, blockposition2, iblockdata3)) {
    ...
    private boolean a(EnumDirection enumdirection, IBlockAccess iblockaccess, BlockPosition blockposition, IBlockData iblockdata, BlockPosition blockposition1, IBlockData iblockdata1) {
        ...
        if (!iblockdata.getBlock().s() && !iblockdata1.getBlock().s()) {
            object2bytelinkedopenhashmap = (Object2ByteLinkedOpenHashMap)e.get();
        } else {
        ...
        if (object2bytelinkedopenhashmap != null) {
            block$a = new Block.a(iblockdata, iblockdata1, enumdirection);
            byte b0 = object2bytelinkedopenhashmap.getAndMoveToFirst(block$a);
            if (b0 != 127) {
                return b0 != 0;
            }
        } else {
        ...
        VoxelShape voxelshape1 = iblockdata.h(iblockaccess, blockposition);
        VoxelShape voxelshape = iblockdata1.h(iblockaccess, blockposition1);
        boolean flag = !VoxelShapes.b(voxelshape1, voxelshape, enumdirection);
        if (object2bytelinkedopenhashmap != null) {
            if (object2bytelinkedopenhashmap.size() == 200) {
                object2bytelinkedopenhashmap.removeLastByte();
            }

            object2bytelinkedopenhashmap.putAndMoveToFirst(block$a, (byte)(flag ? 1 : 0));
        }
    ...
    public Fluid a(int i, boolean flag) {
        return (Fluid)((Fluid)this.e().i().set(LEVEL, Integer.valueOf(i))).set(FALLING, Boolean.valueOf(flag));
    }

    public abstract FluidType f();

    public Fluid a(boolean flag) {
        return (Fluid)this.f().i().set(FALLING, Boolean.valueOf(flag));
    }

    protected abstract boolean g();

    protected void a(GeneratorAccess generatoraccess, BlockPosition blockposition, IBlockData iblockdata, EnumDirection var4, Fluid fluid) {
    ...
    protected int a(IWorldReader iworldreader, BlockPosition blockposition, int i, EnumDirection enumdirection, IBlockData iblockdata, BlockPosition blockposition1, Short2ObjectMap<Pair<IBlockData, Fluid>> short2objectmap, Short2BooleanMap short2booleanmap) {
        ...
        for(EnumDirection enumdirection1 : EnumDirection.EnumDirectionLimit.HORIZONTAL) {
            if (enumdirection1 != enumdirection) {
                ...
                short short1 = a(blockposition1, blockposition2);
                Pair pair = (Pair)short2objectmap.computeIfAbsent(short1, (var2) -> {
                    IBlockData iblockdata2 = iworldreader.getType(blockposition2);
                    return Pair.of(iblockdata2, iblockdata2.s());
                });
                ...
                if (this.a(iworldreader, this.e(), blockposition, iblockdata, enumdirection1, blockposition2, iblockdata1, fluid)) {
                    boolean flag = short2booleanmap.computeIfAbsent(short1, (var4) -> {
                        BlockPosition blockposition4 = blockposition2.down();
                        IBlockData iblockdata3 = iworldreader.getType(blockposition4);
                        return this.a(iworldreader, this.e(), blockposition2, iblockdata1, blockposition4, iblockdata3);
                    });
                    if (flag) {
                        return i;
                    }
    ...
    private boolean a(IBlockAccess iblockaccess, FluidType fluidtype, BlockPosition blockposition, IBlockData iblockdata, BlockPosition blockposition1, IBlockData iblockdata1) {
        if (!this.a(EnumDirection.DOWN, iblockaccess, blockposition, iblockdata, blockposition1, iblockdata1)) {
            return false;
        } else {
            return iblockdata1.s().c().a(this) ? true : this.a(iblockaccess, blockposition1, iblockdata1, fluidtype);
        }
    }
    ...
    protected Map<EnumDirection, Fluid> b(IWorldReader iworldreader, BlockPosition blockposition, IBlockData iblockdata) {
        ...
        for(EnumDirection enumdirection : EnumDirection.EnumDirectionLimit.HORIZONTAL) {
            BlockPosition blockposition1 = blockposition.shift(enumdirection);
            short short1 = a(blockposition, blockposition1);
            Pair pair = (Pair)short2objectopenhashmap.computeIfAbsent(short1, (var2) -> {
                IBlockData iblockdata2 = iworldreader.getType(blockposition1);
                return Pair.of(iblockdata2, iblockdata2.s());
            });
            IBlockData iblockdata1 = (IBlockData)pair.getFirst();
            Fluid fluid = (Fluid)pair.getSecond();
            ...
            if (this.a(iworldreader, fluid1.c(), blockposition, iblockdata, enumdirection, blockposition1, iblockdata1, fluid)) {
                ...
                boolean flag = short2booleanopenhashmap.computeIfAbsent(short1, (var5) -> {
                    IBlockData iblockdata3 = iworldreader.getType(blockposition2);
                    return this.a(iworldreader, this.e(), blockposition1, iblockdata1, blockposition2, iblockdata3);
                });
                int j;
                if (flag) {
                    j = 0;
    ...
    private boolean a(IBlockAccess iblockaccess, BlockPosition blockposition, IBlockData iblockdata, FluidType fluidtype) {
        ...
        if (block instanceof IFluidContainer) {
            ...
            if (material != Material.PORTAL && material != Material.STRUCTURE_VOID && material != Material.WATER_PLANT && material != Material.REPLACEABLE_WATER_PLANT) {
    ...
    protected int a(World world, Fluid var2, Fluid var3) {
        return this.a(world);
    }
    ...
    protected static int e(Fluid fluid) {
        return fluid.d() ? 0 : 8 - Math.min(fluid.g(), 8) + (fluid.get(FALLING) ? 8 : 0);
    }
