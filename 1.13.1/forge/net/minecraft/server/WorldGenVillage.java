...
public class WorldGenVillage extends StructureGenerator<WorldGenFeatureVillageConfiguration> {
    ...
    protected ChunkCoordIntPair a(ChunkGenerator<?> chunkgenerator, Random random, int i, int j, int k, int l) {
        ...
        k2 = k2 * i1;
        l2 = l2 * i1;
        k2 = k2 + random.nextInt(i1 - j1);
        l2 = l2 + random.nextInt(i1 - j1);
    ...
    public static class a extends StructureStart {
        ...
        public a(GeneratorAccess generatoraccess, ChunkGenerator<?> chunkgenerator, SeededRandom seededrandom, int i, int j, BiomeBase biomebase) {
            ...
            WorldGenVillagePieces.WorldGenVillageStartPiece worldgenvillagepieces$worldgenvillagestartpiece = new WorldGenVillagePieces.WorldGenVillageStartPiece(0, seededrandom, (i << 4) + 2, (j << 4) + 2, list, worldgenfeaturevillageconfiguration);
            this.a.add(worldgenvillagepieces$worldgenvillagestartpiece);
            worldgenvillagepieces$worldgenvillagestartpiece.a(worldgenvillagepieces$worldgenvillagestartpiece, this.a, seededrandom);
            List list1 = worldgenvillagepieces$worldgenvillagestartpiece.e;
            List list2 = worldgenvillagepieces$worldgenvillagestartpiece.d;

            while(!list1.isEmpty() || !list2.isEmpty()) {
                if (list1.isEmpty()) {
                    int k = seededrandom.nextInt(list2.size());
                    StructurePiece structurepiece = (StructurePiece)list2.remove(k);
                    structurepiece.a(worldgenvillagepieces$worldgenvillagestartpiece, this.a, seededrandom);
                } else {
                    int l = seededrandom.nextInt(list1.size());
                    StructurePiece structurepiece2 = (StructurePiece)list1.remove(l);
                    structurepiece2.a(worldgenvillagepieces$worldgenvillagestartpiece, this.a, seededrandom);
                }
            }
