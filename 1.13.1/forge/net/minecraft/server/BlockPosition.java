...
public class BlockPosition extends BaseBlockPosition {
    ...
    public BlockPosition(int ix, int jx, int kx) {
        super(ix, jx, kx);
    }
    ...
    public long asLong() {
        return ((long)this.getX() & i) << h | ((long)this.getY() & j) << g | ((long)this.getZ() & k) << 0;
    }

    public static BlockPosition fromLong(long ix) {
        int jx = (int)(ix << 64 - h - c >> 64 - c);
        int kx = (int)(ix << 64 - g - f >> 64 - f);
        int l = (int)(ix << 64 - d >> 64 - d);
        return new BlockPosition(jx, kx, l);
    }
    ...
    public static Iterable<BlockPosition> a(int ix, int jx, int kx, int l, int i1, int j1) {
        return () -> {
    ...
    public static Iterable<BlockPosition.MutableBlockPosition> b(int ix, int jx, int kx, int l, int i1, int j1) {
        return () -> {
    ...
    public static final class b extends BlockPosition.MutableBlockPosition implements AutoCloseable {
        ...
        public static BlockPosition.b e(int i, int j, int k) {
            synchronized(g) {
                if (!g.isEmpty()) {
                    BlockPosition.b blockposition$b = (BlockPosition.b)g.remove(g.size() - 1);
                    if (blockposition$b != null && blockposition$b.f) {
                        blockposition$b.f = false;
                        blockposition$b.f(i, j, k);
