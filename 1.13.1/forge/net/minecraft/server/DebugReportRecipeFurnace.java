...
public class DebugReportRecipeFurnace {
    ...
    public DebugReportRecipeFurnace(RecipeItemStack recipeitemstack, IMaterial imaterial, float fx, int i) {
    ...
    public static DebugReportRecipeFurnace a(RecipeItemStack recipeitemstack, IMaterial imaterial, float fx, int i) {
        return new DebugReportRecipeFurnace(recipeitemstack, imaterial, fx, i);
    }
    ...
    public void a(Consumer<DebugReportRecipeData> consumer, MinecraftKey minecraftkey) {
        this.a(minecraftkey);
        this.f.a(new MinecraftKey("minecraft:recipes/root")).a("has_the_recipe", new CriterionTriggerRecipeUnlocked.b(minecraftkey)).a(AdvancementRewards.a.c(minecraftkey)).a(AdvancementRequirements.OR);
    ...
    public static class a implements DebugReportRecipeData {
        ...
        public a(MinecraftKey minecraftkey, String s, RecipeItemStack recipeitemstack, Item item, float fx, int i, Advancement.SerializedAdvancement advancement$serializedadvancement, MinecraftKey minecraftkey1) {
            this.a = minecraftkey;
            this.b = s;
            this.c = recipeitemstack;
            this.d = item;
            this.e = fx;
            this.f = i;
            this.g = advancement$serializedadvancement;
