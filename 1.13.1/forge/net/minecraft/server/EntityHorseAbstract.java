...
public abstract class EntityHorseAbstract extends EntityAnimal implements IInventoryListener, IJumpable {
    ...
    protected boolean p(int i) {
        return (this.datawatcher.get(bN) & i) != 0;
    }

    protected void d(int i, boolean flag) {
        byte b0 = this.datawatcher.get(bN);
        if (flag) {
            this.datawatcher.set(bN, (byte)(b0 | i));
        } else {
            this.datawatcher.set(bN, (byte)(b0 & ~i));
        }
    ...
    public UUID getOwnerUUID() {
        return (UUID)((Optional)this.datawatcher.get(bO)).orElse((Object)null);
    }
    ...
    protected EntityHorseAbstract a(Entity entity, double d0) {
        ...
        for(Entity entity2 : this.world.getEntities(entity, entity.getBoundingBox().b(d0, d0, d0), bM)) {
    ...
    protected void initAttributes() {
        ...
        this.getAttributeInstance(GenericAttributes.MOVEMENT_SPEED).setValue((double)0.225F);
    }
    ...
    protected void dX() {
        if (this.hasReproduced() && this.isBaby() && !this.dN()) {
            EntityHorseAbstract entityhorseabstract1 = this.a(this, 16.0D);
            if (entityhorseabstract1 != null && this.h(entityhorseabstract1) > 4.0D) {
                this.navigation.a(entityhorseabstract1);
            }
        }
    ...
    public void a(float f, float f1, float f2) {
        if (this.isVehicle() && this.dh() && this.dV()) {
            ...
            if (this.jumpPower > 0.0F && !this.dM() && this.onGround) {
                ...
                this.impulse = true;
                if (f2 > 0.0F) {
                    float f3 = MathHelper.sin(this.yaw * ((float)Math.PI / 180F));
                    float f4 = MathHelper.cos(this.yaw * ((float)Math.PI / 180F));
    ...
    protected void a(EntityAgeable entityageable, EntityHorseAbstract entityhorseabstract1) {
        ...
        entityhorseabstract1.getAttributeInstance(GenericAttributes.maxHealth).setValue(d0 / 3.0D);
        double d1 = this.getAttributeInstance(attributeJumpStrength).b() + entityageable.getAttributeInstance(attributeJumpStrength).b() + this.ed();
        entityhorseabstract1.getAttributeInstance(attributeJumpStrength).setValue(d1 / 3.0D);
        ...
        entityhorseabstract1.getAttributeInstance(GenericAttributes.MOVEMENT_SPEED).setValue(d2 / 3.0D);
    }
    ...
    public void k(Entity entity) {
        ...
        if (this.bW > 0.0F) {
            float f3 = MathHelper.sin(this.aQ * ((float)Math.PI / 180F));
            float f = MathHelper.cos(this.aQ * ((float)Math.PI / 180F));
            float f1 = 0.7F * this.bW;
            float f2 = 0.15F * this.bW;
            entity.setPosition(this.locX + (double)(f1 * f3), this.locY + this.aJ() + entity.aI() + (double)f2, this.locZ - (double)(f1 * f));
