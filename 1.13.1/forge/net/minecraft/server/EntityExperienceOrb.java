...
public class EntityExperienceOrb extends Entity {
    ...
    public EntityExperienceOrb(World world, double d0, double d1, double d2, int i) {
        ...
        this.motX = (double)((float)(Math.random() * (double)0.2F - (double)0.1F) * 2.0F);
        this.motY = (double)((float)(Math.random() * 0.2D) * 2.0F);
        this.motZ = (double)((float)(Math.random() * (double)0.2F - (double)0.1F) * 2.0F);
        this.value = i;
    }
    ...
    private void k() {
        ...
        this.motY = Math.min(this.motY, (double)0.06F);
    ...
    public void d(EntityHuman entityhuman) {
        if (!this.world.isClientSide) {
            if (this.c == 0 && entityhuman.bJ == 0) {
                ...
                ItemStack itemstack = EnchantmentManager.b(Enchantments.G, entityhuman);
