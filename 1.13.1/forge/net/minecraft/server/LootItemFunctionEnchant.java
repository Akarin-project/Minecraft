...
public class LootItemFunctionEnchant extends LootItemFunction {
    ...
    public ItemStack a(ItemStack itemstack, Random random, LootTableInfo var3) {
        ...
        if (this.b.isEmpty()) {
            ...
            if (arraylist.isEmpty()) {
                a.warn("Couldn't find a compatible enchantment for {}", itemstack);
                return itemstack;
            }
    ...
    public static class a extends LootItemFunction.a<LootItemFunctionEnchant> {
        ...
        public void a(JsonObject jsonobject, LootItemFunctionEnchant lootitemfunctionenchant, JsonSerializationContext var3) {
        ...
        public LootItemFunctionEnchant a(JsonObject jsonobject, JsonDeserializationContext var2, LootItemCondition[] alootitemcondition) {
            ArrayList arraylist = Lists.newArrayList();
            if (jsonobject.has("enchantments")) {
                for(JsonElement jsonelement : ChatDeserializer.u(jsonobject, "enchantments")) {
                    String s = ChatDeserializer.a(jsonelement, "enchantment");
                    Enchantment enchantment = IRegistry.ENCHANTMENT.get(new MinecraftKey(s));
                    if (enchantment == null) {
