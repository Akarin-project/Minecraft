...
public class PacketPlayOutCombatEvent implements Packet<PacketListenerPlayOut> {
    ...
    public PacketPlayOutCombatEvent(CombatTracker combattracker, PacketPlayOutCombatEvent.EnumCombatEventType packetplayoutcombatevent$enumcombateventtype) {
        this(combattracker, packetplayoutcombatevent$enumcombateventtype, new ChatComponentText(""));
    }

    public PacketPlayOutCombatEvent(CombatTracker combattracker, PacketPlayOutCombatEvent.EnumCombatEventType packetplayoutcombatevent$enumcombateventtype, IChatBaseComponent ichatbasecomponent) {
        this.a = packetplayoutcombatevent$enumcombateventtype;
        EntityLiving entityliving = combattracker.c();
        switch(packetplayoutcombatevent$enumcombateventtype) {
        case END_COMBAT:
