...
public class ArgumentParserItemStack {
    ...
    public void e() throws CommandSyntaxException {
        int ix = this.d.getCursor();
        MinecraftKey minecraftkey = MinecraftKey.a(this.d);
        if (IRegistry.ITEM.c(minecraftkey)) {
            this.g = IRegistry.ITEM.get(minecraftkey);
        } else {
            this.d.setCursor(ix);
            throw b.createWithContext(this.d, minecraftkey.toString());
        }
    }
    ...
    private CompletableFuture<Suggestions> c(SuggestionsBuilder suggestionsbuilder) {
        return ICompletionProvider.a(TagsItem.a().a(), suggestionsbuilder.createOffset(this.j));
    }

    private CompletableFuture<Suggestions> d(SuggestionsBuilder suggestionsbuilder) {
        if (this.e) {
            ICompletionProvider.a(TagsItem.a().a(), suggestionsbuilder, String.valueOf('#'));
        }
