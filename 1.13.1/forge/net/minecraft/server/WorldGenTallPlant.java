...
public class WorldGenTallPlant extends WorldGenerator<WorldGenFeatureDoublePlantConfiguration> {
    ...
    public boolean a(GeneratorAccess generatoraccess, ChunkGenerator<? extends GeneratorSettings> var2, Random random, BlockPosition blockposition, WorldGenFeatureDoublePlantConfiguration worldgenfeaturedoubleplantconfiguration) {
        boolean flag = false;
