...
public class Paintings {
    ...
    public Paintings(int ix, int jx, int kx, int lx) {
        this.A = ix;
        this.B = jx;
        this.C = kx;
        this.D = lx;
    ...
    public static Paintings a(String sx, int ix, int jx, int kx, int lx) {
        Paintings paintings = new Paintings(ix, jx, kx, lx);
        IRegistry.MOTIVE.a(new MinecraftKey(sx), paintings);
        return paintings;
    }
}
