...
public abstract class EntityHanging extends Entity {
    ...
    protected void updateBoundingBox() {
        if (this.direction != null) {
            ...
            d0 = d0 - (double)this.direction.getAdjacentX() * 0.46875D;
            d2 = d2 - (double)this.direction.getAdjacentZ() * 0.46875D;
            d1 = d1 + d5;
            EnumDirection enumdirection = this.direction.f();
            d0 = d0 + d4 * (double)enumdirection.getAdjacentX();
            d2 = d2 + d4 * (double)enumdirection.getAdjacentZ();
            this.locX = d0;
            this.locY = d1;
            this.locZ = d2;
        ...
        if (!this.world.getCubes(this, this.getBoundingBox())) {
            ...
            for(int k = 0; k < i; ++k) {
                for(int l = 0; l < j; ++l) {
                    int i1 = (i - 1) / -2;
                    int j1 = (j - 1) / -2;
                    blockposition$mutableblockposition.g(blockposition).c(enumdirection, k + i1).c(EnumDirection.UP, l + j1);
            ...
            return this.world.getEntities(this, this.getBoundingBox(), a).isEmpty();
        }
    }
    ...
    public void move(EnumMoveType var1, double d0, double d1, double d2) {
