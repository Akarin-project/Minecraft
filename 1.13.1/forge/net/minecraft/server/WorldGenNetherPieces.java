...
public class WorldGenNetherPieces {
    ...
    private static WorldGenNetherPieces.WorldGenNetherPiece b(WorldGenNetherPieces.WorldGenNetherPieceWeight worldgennetherpieces$worldgennetherpieceweight, List<StructurePiece> list, Random random, int i, int j, int k, EnumDirection enumdirection, int l) {
        Class oclass = worldgennetherpieces$worldgennetherpieceweight.a;
        Object object = null;
    ...
    abstract static class WorldGenNetherPiece extends StructurePiece {
        ...
        private int a(List<WorldGenNetherPieces.WorldGenNetherPieceWeight> list) {
            ...
            for(WorldGenNetherPieces.WorldGenNetherPieceWeight worldgennetherpieces$worldgennetherpieceweight : list) {
        ...
        private WorldGenNetherPieces.WorldGenNetherPiece a(WorldGenNetherPieces.WorldGenNetherPiece15 worldgennetherpieces$worldgennetherpiece15, List<WorldGenNetherPieces.WorldGenNetherPieceWeight> list, List<StructurePiece> list1, Random random, int i, int j, int k, EnumDirection enumdirection, int l) {
            int i1 = this.a(list);
            ...
            while(j1 < 5 && flag) {
                ...
                for(WorldGenNetherPieces.WorldGenNetherPieceWeight worldgennetherpieces$worldgennetherpieceweight : list) {
                    k1 -= worldgennetherpieces$worldgennetherpieceweight.b;
                    if (k1 < 0) {
                        if (!worldgennetherpieces$worldgennetherpieceweight.a(l) || worldgennetherpieces$worldgennetherpieceweight == worldgennetherpieces$worldgennetherpiece15.a && !worldgennetherpieces$worldgennetherpieceweight.e) {
                            break;
                        }

                        WorldGenNetherPieces.WorldGenNetherPiece worldgennetherpieces$worldgennetherpiece1 = WorldGenNetherPieces.b(worldgennetherpieces$worldgennetherpieceweight, list1, random, i, j, k, enumdirection, l);
                        if (worldgennetherpieces$worldgennetherpiece1 != null) {
                            ++worldgennetherpieces$worldgennetherpieceweight.c;
                            worldgennetherpieces$worldgennetherpiece15.a = worldgennetherpieces$worldgennetherpieceweight;
                            if (!worldgennetherpieces$worldgennetherpieceweight.a()) {
                                list.remove(worldgennetherpieces$worldgennetherpieceweight);
                            }

                            return worldgennetherpieces$worldgennetherpiece1;
                        }
                    }
                }
            }
        ...
        private StructurePiece a(WorldGenNetherPieces.WorldGenNetherPiece15 worldgennetherpieces$worldgennetherpiece15, List<StructurePiece> list, Random random, int i, int j, int k, @Nullable EnumDirection enumdirection, int l, boolean flag) {
            if (Math.abs(i - worldgennetherpieces$worldgennetherpiece15.d().a) <= 112 && Math.abs(k - worldgennetherpieces$worldgennetherpiece15.d().c) <= 112) {
                List list1 = worldgennetherpieces$worldgennetherpiece15.b;
                if (flag) {
                    list1 = worldgennetherpieces$worldgennetherpiece15.c;
                }

                WorldGenNetherPieces.WorldGenNetherPiece worldgennetherpieces$worldgennetherpiece1 = this.a(worldgennetherpieces$worldgennetherpiece15, list1, list, random, i, j, k, enumdirection, l + 1);
                if (worldgennetherpieces$worldgennetherpiece1 != null) {
                    list.add(worldgennetherpieces$worldgennetherpiece1);
                    worldgennetherpieces$worldgennetherpiece15.d.add(worldgennetherpieces$worldgennetherpiece1);
                }
        ...
        @Nullable
        protected StructurePiece a(WorldGenNetherPieces.WorldGenNetherPiece15 worldgennetherpieces$worldgennetherpiece15, List<StructurePiece> list, Random random, int i, int j, boolean flag) {
            EnumDirection enumdirection = this.f();
            if (enumdirection != null) {
                switch(enumdirection) {
                case NORTH:
                    return this.a(worldgennetherpieces$worldgennetherpiece15, list, random, this.n.a + i, this.n.b + j, this.n.c - 1, enumdirection, this.e(), flag);
                case SOUTH:
                    return this.a(worldgennetherpieces$worldgennetherpiece15, list, random, this.n.a + i, this.n.b + j, this.n.f + 1, enumdirection, this.e(), flag);
                case WEST:
                    return this.a(worldgennetherpieces$worldgennetherpiece15, list, random, this.n.a - 1, this.n.b + j, this.n.c + i, enumdirection, this.e(), flag);
                case EAST:
                    return this.a(worldgennetherpieces$worldgennetherpiece15, list, random, this.n.d + 1, this.n.b + j, this.n.c + i, enumdirection, this.e(), flag);
                }
            }
        ...
        @Nullable
        protected StructurePiece b(WorldGenNetherPieces.WorldGenNetherPiece15 worldgennetherpieces$worldgennetherpiece15, List<StructurePiece> list, Random random, int i, int j, boolean flag) {
            EnumDirection enumdirection = this.f();
            if (enumdirection != null) {
                switch(enumdirection) {
                case NORTH:
                    return this.a(worldgennetherpieces$worldgennetherpiece15, list, random, this.n.a - 1, this.n.b + i, this.n.c + j, EnumDirection.WEST, this.e(), flag);
                case SOUTH:
                    return this.a(worldgennetherpieces$worldgennetherpiece15, list, random, this.n.a - 1, this.n.b + i, this.n.c + j, EnumDirection.WEST, this.e(), flag);
                case WEST:
                    return this.a(worldgennetherpieces$worldgennetherpiece15, list, random, this.n.a + j, this.n.b + i, this.n.c - 1, EnumDirection.NORTH, this.e(), flag);
                case EAST:
                    return this.a(worldgennetherpieces$worldgennetherpiece15, list, random, this.n.a + j, this.n.b + i, this.n.c - 1, EnumDirection.NORTH, this.e(), flag);
                }
            }
        ...
        @Nullable
        protected StructurePiece c(WorldGenNetherPieces.WorldGenNetherPiece15 worldgennetherpieces$worldgennetherpiece15, List<StructurePiece> list, Random random, int i, int j, boolean flag) {
            EnumDirection enumdirection = this.f();
            if (enumdirection != null) {
                switch(enumdirection) {
                case NORTH:
                    return this.a(worldgennetherpieces$worldgennetherpiece15, list, random, this.n.d + 1, this.n.b + i, this.n.c + j, EnumDirection.EAST, this.e(), flag);
                case SOUTH:
                    return this.a(worldgennetherpieces$worldgennetherpiece15, list, random, this.n.d + 1, this.n.b + i, this.n.c + j, EnumDirection.EAST, this.e(), flag);
                case WEST:
                    return this.a(worldgennetherpieces$worldgennetherpiece15, list, random, this.n.a + j, this.n.b + i, this.n.f + 1, EnumDirection.SOUTH, this.e(), flag);
                case EAST:
                    return this.a(worldgennetherpieces$worldgennetherpiece15, list, random, this.n.a + j, this.n.b + i, this.n.f + 1, EnumDirection.SOUTH, this.e(), flag);
                }
            }
    ...
    public static class WorldGenNetherPiece1 extends WorldGenNetherPieces.WorldGenNetherPiece {
        ...
        public WorldGenNetherPiece1(int i, Random var2, StructureBoundingBox structureboundingbox, EnumDirection enumdirection) {
            super(i);
        ...
        public boolean a(GeneratorAccess generatoraccess, Random var2, StructureBoundingBox structureboundingbox, ChunkCoordIntPair var4) {
            ...
            for(int k = 0; k <= 2; ++k) {
                for(int l = 7; l <= 11; ++l) {
                    this.b(generatoraccess, Blocks.NETHER_BRICKS.getBlockData(), k, -1, l, structureboundingbox);
                    this.b(generatoraccess, Blocks.NETHER_BRICKS.getBlockData(), 18 - k, -1, l, structureboundingbox);
                }
            }
    ...
    public static class WorldGenNetherPiece10 extends WorldGenNetherPieces.WorldGenNetherPiece {
        ...
        public boolean a(GeneratorAccess generatoraccess, Random random, StructureBoundingBox structureboundingbox, ChunkCoordIntPair var4) {
            ...
            if (this.a && structureboundingbox.b(new BlockPosition(this.a(1, 3), this.d(2), this.b(1, 3)))) {
                this.a = false;
    ...
    public static class WorldGenNetherPiece11 extends WorldGenNetherPieces.WorldGenNetherPiece {
        ...
        public WorldGenNetherPiece11(int i, Random var2, StructureBoundingBox structureboundingbox, EnumDirection enumdirection) {
            super(i);
            this.a(enumdirection);
            this.n = structureboundingbox;
        }
        ...
        public boolean a(GeneratorAccess generatoraccess, Random var2, StructureBoundingBox structureboundingbox, ChunkCoordIntPair var4) {
            ...
            for(int j1 = 3; j1 <= 9; j1 += 2) {
                this.a(generatoraccess, structureboundingbox, 1, 7, j1, 1, 8, j1, iblockdata2, iblockdata2, false);
                this.a(generatoraccess, structureboundingbox, 11, 7, j1, 11, 8, j1, iblockdata3, iblockdata3, false);
            }
            ...
            for(int j = 0; j <= 6; ++j) {
                ...
                for(int l = 5; l <= 7; ++l) {
                    this.a(generatoraccess, iblockdata4, l, 5 + j, k, structureboundingbox);
                }

                if (k >= 5 && k <= 8) {
                    this.a(generatoraccess, structureboundingbox, 5, 5, k, 7, j + 4, k, Blocks.NETHER_BRICKS.getBlockData(), Blocks.NETHER_BRICKS.getBlockData(), false);
                } else if (k >= 9 && k <= 10) {
                    this.a(generatoraccess, structureboundingbox, 5, 8, k, 7, j + 4, k, Blocks.NETHER_BRICKS.getBlockData(), Blocks.NETHER_BRICKS.getBlockData(), false);
                }

                if (j >= 1) {
                    this.a(generatoraccess, structureboundingbox, 5, 6 + j, k, 7, 9 + j, k, Blocks.AIR.getBlockData(), Blocks.AIR.getBlockData(), false);
                }
            }

            for(int k1 = 5; k1 <= 7; ++k1) {
                this.a(generatoraccess, iblockdata4, k1, 12, 11, structureboundingbox);
            }
            ...
            for(int l1 = 4; l1 <= 8; ++l1) {
                for(int i1 = 0; i1 <= 2; ++i1) {
                    this.b(generatoraccess, Blocks.NETHER_BRICKS.getBlockData(), l1, -1, i1, structureboundingbox);
                    this.b(generatoraccess, Blocks.NETHER_BRICKS.getBlockData(), l1, -1, 12 - i1, structureboundingbox);
                }
            }

            for(int i2 = 0; i2 <= 2; ++i2) {
                for(int j2 = 4; j2 <= 8; ++j2) {
                    this.b(generatoraccess, Blocks.NETHER_BRICKS.getBlockData(), i2, -1, j2, structureboundingbox);
                    this.b(generatoraccess, Blocks.NETHER_BRICKS.getBlockData(), 12 - i2, -1, j2, structureboundingbox);
                }
            }
    ...
    public static class WorldGenNetherPiece12 extends WorldGenNetherPieces.WorldGenNetherPiece {
        ...
        public WorldGenNetherPiece12(int i, Random var2, StructureBoundingBox structureboundingbox, EnumDirection enumdirection) {
            super(i);
            this.a(enumdirection);
            this.n = structureboundingbox;
        }
    ...
    public static class WorldGenNetherPiece13 extends WorldGenNetherPieces.WorldGenNetherPiece {
        ...
        public WorldGenNetherPiece13(int i, Random var2, StructureBoundingBox structureboundingbox, EnumDirection enumdirection) {
            super(i);
            this.a(enumdirection);
            this.n = structureboundingbox;
        }
    ...
    public static class WorldGenNetherPiece14 extends WorldGenNetherPieces.WorldGenNetherPiece {
        ...
        public WorldGenNetherPiece14(int i, Random var2, StructureBoundingBox structureboundingbox, EnumDirection enumdirection) {
            super(i);
            this.a(enumdirection);
            this.n = structureboundingbox;
        }
    ...
    public static class WorldGenNetherPiece15 extends WorldGenNetherPieces.WorldGenNetherPiece1 {
        ...
        public WorldGenNetherPiece15(Random random, int i, int j) {
            ...
            for(WorldGenNetherPieces.WorldGenNetherPieceWeight worldgennetherpieces$worldgennetherpieceweight : WorldGenNetherPieces.a) {
                ...
                this.b.add(worldgennetherpieces$worldgennetherpieceweight);
            }
            ...
            for(WorldGenNetherPieces.WorldGenNetherPieceWeight worldgennetherpieces$worldgennetherpieceweight1 : WorldGenNetherPieces.b) {
                ...
                this.c.add(worldgennetherpieces$worldgennetherpieceweight1);
            }
    ...
    public static class WorldGenNetherPiece2 extends WorldGenNetherPieces.WorldGenNetherPiece {
        ...
        public boolean a(GeneratorAccess generatoraccess, Random var2, StructureBoundingBox structureboundingbox, ChunkCoordIntPair var4) {
            Random random = new Random((long)this.a);
            ...
            this.a(generatoraccess, structureboundingbox, 0, 5, 0, 0, 5, l, Blocks.NETHER_BRICKS.getBlockData(), Blocks.NETHER_BRICKS.getBlockData(), false);
            l = random.nextInt(8);
            this.a(generatoraccess, structureboundingbox, 4, 5, 0, 4, 5, l, Blocks.NETHER_BRICKS.getBlockData(), Blocks.NETHER_BRICKS.getBlockData(), false);

            for(int i1 = 0; i1 <= 4; ++i1) {
                int k1 = random.nextInt(5);
                this.a(generatoraccess, structureboundingbox, i1, 2, 0, i1, 2, k1, Blocks.NETHER_BRICKS.getBlockData(), Blocks.NETHER_BRICKS.getBlockData(), false);
            }

            for(int j1 = 0; j1 <= 4; ++j1) {
                for(int l1 = 0; l1 <= 1; ++l1) {
                    int i2 = random.nextInt(3);
                    this.a(generatoraccess, structureboundingbox, j1, l1, 0, j1, l1, i2, Blocks.NETHER_BRICKS.getBlockData(), Blocks.NETHER_BRICKS.getBlockData(), false);
                }
            }
    ...
    public static class WorldGenNetherPiece3 extends WorldGenNetherPieces.WorldGenNetherPiece {
        ...
        public WorldGenNetherPiece3(int i, Random var2, StructureBoundingBox structureboundingbox, EnumDirection enumdirection) {
            super(i);
            this.a(enumdirection);
            this.n = structureboundingbox;
        }
        ...
        public boolean a(GeneratorAccess generatoraccess, Random var2, StructureBoundingBox structureboundingbox, ChunkCoordIntPair var4) {
            ...
            IBlockData iblockdata1 = (IBlockData)((IBlockData)Blocks.NETHER_BRICK_FENCE.getBlockData().set(BlockFence.NORTH, Boolean.valueOf(true))).set(BlockFence.SOUTH, Boolean.valueOf(true));
            IBlockData iblockdata2 = (IBlockData)iblockdata1.set(BlockFence.EAST, Boolean.valueOf(true));
            IBlockData iblockdata = (IBlockData)iblockdata1.set(BlockFence.WEST, Boolean.valueOf(true));
            this.a(generatoraccess, structureboundingbox, 0, 1, 1, 0, 4, 1, iblockdata2, iblockdata2, false);
            this.a(generatoraccess, structureboundingbox, 0, 3, 4, 0, 4, 4, iblockdata2, iblockdata2, false);
            this.a(generatoraccess, structureboundingbox, 0, 3, 14, 0, 4, 14, iblockdata2, iblockdata2, false);
            this.a(generatoraccess, structureboundingbox, 0, 1, 17, 0, 4, 17, iblockdata2, iblockdata2, false);
            this.a(generatoraccess, structureboundingbox, 4, 1, 1, 4, 4, 1, iblockdata, iblockdata, false);
            this.a(generatoraccess, structureboundingbox, 4, 3, 4, 4, 4, 4, iblockdata, iblockdata, false);
            this.a(generatoraccess, structureboundingbox, 4, 3, 14, 4, 4, 14, iblockdata, iblockdata, false);
            this.a(generatoraccess, structureboundingbox, 4, 1, 17, 4, 4, 17, iblockdata, iblockdata, false);
            return true;
        }
    }
    ...
    public static class WorldGenNetherPiece4 extends WorldGenNetherPieces.WorldGenNetherPiece {
        ...
        public WorldGenNetherPiece4(int i, Random var2, StructureBoundingBox structureboundingbox, EnumDirection enumdirection) {
            super(i);
            this.a(enumdirection);
            this.n = structureboundingbox;
        }
    ...
    public static class WorldGenNetherPiece5 extends WorldGenNetherPieces.WorldGenNetherPiece {
        ...
        public WorldGenNetherPiece5(int i, Random var2, StructureBoundingBox structureboundingbox, EnumDirection enumdirection) {
            super(i);
            this.a(enumdirection);
            this.n = structureboundingbox;
        }
    ...
    public static class WorldGenNetherPiece6 extends WorldGenNetherPieces.WorldGenNetherPiece {
        ...
        public WorldGenNetherPiece6(int i, Random var2, StructureBoundingBox structureboundingbox, EnumDirection enumdirection) {
            super(i);
            this.a(enumdirection);
            this.n = structureboundingbox;
        }
        ...
        public boolean a(GeneratorAccess generatoraccess, Random var2, StructureBoundingBox structureboundingbox, ChunkCoordIntPair var4) {
            ...
            for(int k = 3; k <= 9; k += 2) {
                this.a(generatoraccess, structureboundingbox, 1, 7, k, 1, 8, k, (IBlockData)iblockdata1.set(BlockFence.WEST, Boolean.valueOf(true)), (IBlockData)iblockdata1.set(BlockFence.WEST, Boolean.valueOf(true)), false);
                this.a(generatoraccess, structureboundingbox, 11, 7, k, 11, 8, k, (IBlockData)iblockdata1.set(BlockFence.EAST, Boolean.valueOf(true)), (IBlockData)iblockdata1.set(BlockFence.EAST, Boolean.valueOf(true)), false);
            }
            ...
            for(int l = 4; l <= 8; ++l) {
                for(int j = 0; j <= 2; ++j) {
                    this.b(generatoraccess, Blocks.NETHER_BRICKS.getBlockData(), l, -1, j, structureboundingbox);
                    this.b(generatoraccess, Blocks.NETHER_BRICKS.getBlockData(), l, -1, 12 - j, structureboundingbox);
                }
            }

            for(int i1 = 0; i1 <= 2; ++i1) {
                for(int j1 = 4; j1 <= 8; ++j1) {
                    this.b(generatoraccess, Blocks.NETHER_BRICKS.getBlockData(), i1, -1, j1, structureboundingbox);
                    this.b(generatoraccess, Blocks.NETHER_BRICKS.getBlockData(), 12 - i1, -1, j1, structureboundingbox);
                }
            }
    ...
    public static class WorldGenNetherPiece7 extends WorldGenNetherPieces.WorldGenNetherPiece {
        ...
        public WorldGenNetherPiece7(int i, Random var2, StructureBoundingBox structureboundingbox, EnumDirection enumdirection) {
            super(i);
            this.a(enumdirection);
            this.n = structureboundingbox;
        }
    ...
    public static class WorldGenNetherPiece9 extends WorldGenNetherPieces.WorldGenNetherPiece {
        ...
        public WorldGenNetherPiece9(int i, Random var2, StructureBoundingBox structureboundingbox, EnumDirection enumdirection) {
            super(i);
            this.a(enumdirection);
            this.n = structureboundingbox;
        }
