...
public abstract class MobSpawnerAbstract {
    ...
    public MinecraftKey getMobName() {
        ...
        try {
            ...
            a.warn("Invalid entity id '{}' at spawner {}:[{},{},{}]", s, this.a().worldProvider.getDimensionManager(), blockposition.getX(), blockposition.getY(), blockposition.getZ());
            return null;
        }
    }
    ...
    public void c() {
        if (!this.h()) {
            ...
            if (this.a().isClientSide) {
                double d3 = (double)((float)blockposition.getX() + this.a().random.nextFloat());
                double d4 = (double)((float)blockposition.getY() + this.a().random.nextFloat());
                double d5 = (double)((float)blockposition.getZ() + this.a().random.nextFloat());
                this.a().addParticle(Particles.M, d3, d4, d5, 0.0D, 0.0D, 0.0D);
                this.a().addParticle(Particles.y, d3, d4, d5, 0.0D, 0.0D, 0.0D);
                ...
                for(int i = 0; i < this.spawnCount; ++i) {
                    ...
                    World world = this.a();
                    int jx = nbttaglist.size();
                    double d0 = jx >= 1 ? nbttaglist.k(0) : (double)blockposition.getX() + (world.random.nextDouble() - world.random.nextDouble()) * (double)this.spawnRange + 0.5D;
                    double d1 = jx >= 2 ? nbttaglist.k(1) : (double)(blockposition.getY() + world.random.nextInt(3) - 1);
                    double d2 = jx >= 3 ? nbttaglist.k(2) : (double)blockposition.getZ() + (world.random.nextDouble() - world.random.nextDouble()) * (double)this.spawnRange + 0.5D;
                    Entity entity = ChunkRegionLoader.a(nbttagcompound, world, d0, d1, d2, false);
                    if (entity == null) {
                        this.i();
                        return;
                    }
