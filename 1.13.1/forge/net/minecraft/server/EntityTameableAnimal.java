...
public abstract class EntityTameableAnimal extends EntityAnimal implements EntityOwnable {
    ...
    public boolean isTamed() {
        return (this.datawatcher.get(bC) & 4) != 0;
    }

    public void setTamed(boolean flag) {
        byte b0 = this.datawatcher.get(bC);
        if (flag) {
            this.datawatcher.set(bC, (byte)(b0 | 4));
        } else {
            this.datawatcher.set(bC, (byte)(b0 & -5));
        }
    ...
    public boolean isSitting() {
        return (this.datawatcher.get(bC) & 1) != 0;
    }

    public void setSitting(boolean flag) {
        byte b0 = this.datawatcher.get(bC);
        if (flag) {
            this.datawatcher.set(bC, (byte)(b0 | 1));
        } else {
    ...
    public UUID getOwnerUUID() {
        return (UUID)((Optional)this.datawatcher.get(bD)).orElse((Object)null);
    }
