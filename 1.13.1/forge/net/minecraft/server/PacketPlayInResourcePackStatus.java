...
public class PacketPlayInResourcePackStatus implements Packet<PacketListenerPlayIn> {
    ...
    public PacketPlayInResourcePackStatus(PacketPlayInResourcePackStatus.EnumResourcePackStatus packetplayinresourcepackstatus$enumresourcepackstatus) {
        this.status = packetplayinresourcepackstatus$enumresourcepackstatus;
    }
