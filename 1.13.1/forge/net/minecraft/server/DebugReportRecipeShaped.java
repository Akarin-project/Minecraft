...
public class DebugReportRecipeShaped {
    ...
    class a implements DebugReportRecipeData {
        ...
        public a(MinecraftKey minecraftkey, Item item, int ix, String s, List list, Map map, Advancement.SerializedAdvancement advancement$serializedadvancement, MinecraftKey minecraftkey1) {
            this.b = minecraftkey;
            this.c = item;
            this.d = ix;
            this.e = s;
            this.f = list;
            this.g = map;
            this.h = advancement$serializedadvancement;
