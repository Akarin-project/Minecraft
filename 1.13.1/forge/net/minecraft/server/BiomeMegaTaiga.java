...
public final class BiomeMegaTaiga extends BiomeBase {
    public BiomeMegaTaiga() {
        super((new BiomeBase.a()).a(new WorldGenSurfaceComposite(ay, ai)).a(BiomeBase.Precipitation.RAIN).a(BiomeBase.Geography.TAIGA).a(0.2F).b(0.2F).c(0.3F).d(0.8F).a(4159204).b(329011).a((String)null));
