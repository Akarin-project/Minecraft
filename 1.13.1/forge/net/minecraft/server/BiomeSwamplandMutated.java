...
public final class BiomeSwamplandMutated extends BiomeBase {
    protected BiomeSwamplandMutated() {
        super((new BiomeBase.a()).a(new WorldGenSurfaceComposite(az, ai)).a(BiomeBase.Precipitation.RAIN).a(BiomeBase.Geography.SWAMP).a(-0.1F).b(0.3F).c(0.8F).d(0.9F).a(6388580).b(2302743).a("swamp"));
