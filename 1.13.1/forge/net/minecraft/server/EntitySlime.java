...
public class EntitySlime extends EntityInsentient implements IMonster {
    ...
    protected void x_() {
        super.x_();
        this.datawatcher.register(bC, 1);
    }
    ...
    public void die() {
        ...
        if (!this.world.isClientSide && i > 1 && this.getHealth() <= 0.0F) {
            ...
            for(int k = 0; k < j; ++k) {
                ...
                EntitySlime entityslime1 = (EntitySlime)this.P().a(this.world);
                if (this.hasCustomName()) {
                    entityslime1.setCustomName(this.getCustomName());
                }
                ...
                entityslime1.setSize(i / 2, true);
                entityslime1.setPositionRotation(this.locX + (double)f, this.locY + 0.5D, this.locZ + (double)f1, this.random.nextFloat() * 360.0F, 0.0F);
                this.world.addEntity(entityslime1);
            }
        }
    ...
    static class ControllerMoveSlime extends ControllerMove {
        ...
        public ControllerMoveSlime(EntitySlime entityslime) {
            super(entityslime);
            this.k = entityslime;
            this.i = 180.0F * entityslime.yaw / (float)Math.PI;
        }
