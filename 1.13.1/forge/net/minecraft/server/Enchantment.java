...
public abstract class Enchantment {
    ...
    protected Enchantment(Enchantment.Rarity enchantment$rarity, EnchantmentSlotType enchantmentslottype, EnumItemSlot[] aenumitemslot) {
        this.d = enchantment$rarity;
    ...
    public final boolean b(Enchantment enchantment1) {
        return this.a(enchantment1) && enchantment1.a(this);
    }

    protected boolean a(Enchantment enchantment1) {
    ...
    private static void a(String s, Enchantment enchantment) {
        IRegistry.ENCHANTMENT.a(new MinecraftKey(s), enchantment);
    }
