...
public class AutoRecipe implements AutoRecipeAbstract<Integer> {
    ...
    protected void a(IRecipe irecipe, boolean flag) {
        ...
        if (flag1) {
            for(int j = 0; j < this.d.g() * this.d.f() + 1; ++j) {
                if (j != this.d.e()) {
        ...
        int j1 = this.a(flag, i, flag1);
        IntArrayList intarraylist = new IntArrayList();
        if (this.b.a(irecipe, intarraylist, j1)) {
            int k = j1;
    ...
    public void a(Iterator<Integer> iterator, int i, int j, int var4, int var5) {
        Slot slot = this.d.getSlot(i);
        ItemStack itemstack = AutoRecipeStackManager.b(iterator.next());
        if (!itemstack.isEmpty()) {
            for(int k = 0; k < j; ++k) {
    ...
    private int c() {
        ...
        for(ItemStack itemstack : this.c.items) {
            if (itemstack.isEmpty()) {
                ++i;
            }
        }
