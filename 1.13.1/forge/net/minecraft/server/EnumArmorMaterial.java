...
public enum EnumArmorMaterial implements ArmorMaterial {
    ...
    private EnumArmorMaterial(String s1, int jx, int[] aint, int kx, SoundEffect soundeffect, float f, Supplier supplier) {
        this.h = s1;
        this.i = jx;
        this.j = aint;
        this.k = kx;
        this.l = soundeffect;
        this.m = f;
        this.n = new LazyInitVar<RecipeItemStack>(supplier);
    }

    public int a(EnumItemSlot enumitemslot) {
        return g[enumitemslot.b()] * this.i;
    }
