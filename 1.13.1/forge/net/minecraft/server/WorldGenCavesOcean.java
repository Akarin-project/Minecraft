                ...
                for(int l2 = l1; l2 < i2; ++l2) {
                    ...
                    if (!(d7 * d7 + d8 * d8 >= 1.0D)) {
                        for(int j3 = k1; j3 > j1; --j3) {
                            ...
                            if (!(d9 <= -0.7D) && !(d7 * d7 + d9 * d9 + d8 * d8 >= 1.0D) && j3 < generatoraccess.getSeaLevel()) {
                                int k3 = j2 | l2 << 4 | j3 << 8;
                                if (!bitset.get(k3)) {
                                    bitset.set(k3);
                                    blockposition$mutableblockposition.c(k2, j3, i3);
                                    IBlockData iblockdata = generatoraccess.getType(blockposition$mutableblockposition);
                                    if (this.a(iblockdata)) {
                                        if (j3 == 10) {
                                            float f = random.nextFloat();
                                            if ((double)f < 0.25D) {
                                                generatoraccess.setTypeAndData(blockposition$mutableblockposition, Blocks.MAGMA_BLOCK.getBlockData(), 2);
                                                generatoraccess.J().a(blockposition$mutableblockposition, Blocks.MAGMA_BLOCK, 0);
                                                flag = true;
                                            } else {
                                                generatoraccess.setTypeAndData(blockposition$mutableblockposition, Blocks.OBSIDIAN.getBlockData(), 2);
                                                flag = true;
                                            }
                                        } else if (j3 < 10) {
                                            generatoraccess.setTypeAndData(blockposition$mutableblockposition, Blocks.LAVA.getBlockData(), 2);
                                        } else {
                                            boolean flag1 = false;

                                            for(EnumDirection enumdirection : EnumDirection.EnumDirectionLimit.HORIZONTAL) {
                                                IBlockData iblockdata1 = generatoraccess.getType(blockposition$mutableblockposition.c(k2 + enumdirection.getAdjacentX(), j3, i3 + enumdirection.getAdjacentZ()));
                                                if (iblockdata1.isAir()) {
                                                    generatoraccess.setTypeAndData(blockposition$mutableblockposition, c.i(), 2);
                                                    generatoraccess.I().a(blockposition$mutableblockposition, c.c(), 0);
                                                    flag = true;
                                                    flag1 = true;
                                                    break;
                                                }
