...
public class PacketPlayOutWorldBorder implements Packet<PacketListenerPlayOut> {
    ...
    public PacketPlayOutWorldBorder(WorldBorder worldborder, PacketPlayOutWorldBorder.EnumWorldBorderAction packetplayoutworldborder$enumworldborderaction) {
        this.a = packetplayoutworldborder$enumworldborderaction;
