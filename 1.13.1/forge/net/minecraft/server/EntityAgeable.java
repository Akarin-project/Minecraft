...
public abstract class EntityAgeable extends EntityCreature {
    ...
    public boolean a(EntityHuman entityhuman, EnumHand enumhand) {
        ...
        if (item instanceof ItemMonsterEgg && ((ItemMonsterEgg)item).a(itemstack.getTag(), this.P())) {
            if (!this.world.isClientSide) {
                EntityAgeable entityageable1 = this.createChild(this);
                if (entityageable1 != null) {
                    entityageable1.setAgeRaw(-24000);
                    entityageable1.setPositionRotation(this.locX, this.locY, this.locZ, 0.0F, 0.0F);
                    this.world.addEntity(entityageable1);
                    if (itemstack.hasName()) {
                        entityageable1.setCustomName(itemstack.getName());
                    }
    ...
    public int getAge() {
        if (this.world.isClientSide) {
            return this.datawatcher.get(bC) ? -1 : 1;
        } else {
            return this.a;
        }
    }
