...
public final class BiomeDesert extends BiomeBase {
    public BiomeDesert() {
        super((new BiomeBase.a()).a(new WorldGenSurfaceComposite(au, ap)).a(BiomeBase.Precipitation.NONE).a(BiomeBase.Geography.DESERT).a(0.125F).b(0.05F).c(2.0F).d(0.0F).a(4159204).b(329011).a((String)null));
        this.a(WorldGenerator.e, new WorldGenFeatureVillageConfiguration(0, WorldGenVillagePieces.Material.SANDSTONE));
        this.a(WorldGenerator.i, new WorldGenFeatureDesertPyramidConfiguration());
        ...
        this.a(WorldGenStage.Decoration.VEGETAL_DECORATION, a(WorldGenerator.P, WorldGenFeatureConfiguration.e, j, new WorldGenDecoratorFrequencyConfiguration(2)));
        ...
        this.a(WorldGenStage.Decoration.VEGETAL_DECORATION, a(WorldGenerator.Z, WorldGenFeatureConfiguration.e, j, new WorldGenDecoratorFrequencyConfiguration(60)));
        ...
        this.a(WorldGenStage.Decoration.VEGETAL_DECORATION, a(WorldGenerator.O, WorldGenFeatureConfiguration.e, j, new WorldGenDecoratorFrequencyConfiguration(10)));
        ...
        this.a(WorldGenStage.Decoration.SURFACE_STRUCTURES, a(WorldGenerator.Q, WorldGenFeatureConfiguration.e, o, new WorldGenDecoratorChanceConfiguration(1000)));
