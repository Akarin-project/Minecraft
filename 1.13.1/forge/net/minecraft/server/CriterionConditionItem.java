...
public class CriterionConditionItem {
    ...
    public CriterionConditionItem(@Nullable Tag<Item> tag, @Nullable Item item, CriterionConditionValue.d criterionconditionvalue$d, CriterionConditionValue.d criterionconditionvalue$d1, CriterionConditionEnchantments[] acriterionconditionenchantments, @Nullable PotionRegistry potionregistry, CriterionConditionNBT criterionconditionnbt) {
        this.b = tag;
        this.c = item;
        this.d = criterionconditionvalue$d;
        this.e = criterionconditionvalue$d1;
    ...
    public static CriterionConditionItem a(@Nullable JsonElement jsonelement) {
        if (jsonelement != null && !jsonelement.isJsonNull()) {
            ...
            CriterionConditionValue.d criterionconditionvalue$d = CriterionConditionValue.d.a(jsonobject.get("count"));
            CriterionConditionValue.d criterionconditionvalue$d1 = CriterionConditionValue.d.a(jsonobject.get("durability"));
            if (jsonobject.has("data")) {
                ...
                if (jsonobject.has("potion")) {
                    ...
                    potionregistry = IRegistry.POTION.getOrDefault(minecraftkey2);
                }

                return new CriterionConditionItem(tag, item, criterionconditionvalue$d, criterionconditionvalue$d1, acriterionconditionenchantments, potionregistry, criterionconditionnbt);
            }
        } else {
            return a;
        }
    ...
    public static class a {
        ...
        @Nullable
        private Tag<Item> c;
        private CriterionConditionValue.d d = CriterionConditionValue.d.e;
        private CriterionConditionValue.d e = CriterionConditionValue.d.e;
        @Nullable
        ...
        public CriterionConditionItem.a a(CriterionConditionValue.d criterionconditionvalue$d) {
            this.d = criterionconditionvalue$d;
            return this;
        }
