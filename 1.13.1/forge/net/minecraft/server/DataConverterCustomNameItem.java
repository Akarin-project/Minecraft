    ...
    private Dynamic<?> a(Dynamic<?> dynamic) {
        ...
        if (optional.isPresent()) {
            ...
            if (optional1.isPresent()) {
                dynamic1 = dynamic1.set("Name", dynamic1.createString(IChatBaseComponent.ChatSerializer.a(new ChatComponentText((String)optional1.get()))));
            } else {
                Optional optional2 = dynamic1.get("LocName").flatMap(Dynamic::getStringValue);
                if (optional2.isPresent()) {
                    dynamic1 = dynamic1.set("Name", dynamic1.createString(IChatBaseComponent.ChatSerializer.a(new ChatMessage((String)optional2.get(), new Object[0]))));
