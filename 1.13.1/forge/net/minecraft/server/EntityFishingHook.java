...
public class EntityFishingHook extends Entity {
    ...
    private void k() {
        ...
        this.setPositionRotation(d0, d1, d2, f1, fx);
        this.motX = (double)(-f3);
        ...
        this.pitch = (float)(MathHelper.c(this.motY, (double)f7) * (double)(180F / (float)Math.PI));
        this.lastYaw = this.yaw;
        this.lastPitch = this.pitch;
    }

    protected void x_() {
        this.getDataWatcher().register(b, 0);
    }

    public void a(DataWatcherObject<?> datawatcherobject) {
        if (b.equals(datawatcherobject)) {
            int i = this.getDataWatcher().get(b);
        ...
        if (this.owner == null) {
            ...
            if (this.ay == EntityFishingHook.HookState.FLYING) {
                ...
                if (this.ay == EntityFishingHook.HookState.HOOKED_IN_ENTITY) {
                    if (this.hooked != null) {
                        if (this.hooked.dead) {
                            ...
                            double d2 = (double)this.hooked.length;
                            this.locY = this.hooked.getBoundingBox().b + d2 * 0.8D;
                ...
                if (this.ay == EntityFishingHook.HookState.BOBBING) {
                    this.motX *= 0.9D;
                    this.motZ *= 0.9D;
                    double d0 = this.locY + this.motY - (double)blockposition.getY() - (double)fx;
                    if (Math.abs(d0) < 0.01D) {
                        d0 += Math.signum(d0) * 0.1D;
                    }

                    this.motY -= d0 * (double)this.random.nextFloat() * 0.2D;
                    if (!this.world.isClientSide && fx > 0.0F) {
    ...
    private void m() {
        ...
        for(this.pitch = (float)(MathHelper.c(this.motY, (double)fx) * (double)(180F / (float)Math.PI)); this.pitch - this.lastPitch < -180.0F; this.lastPitch -= 360.0F) {
            ;
        }
    ...
    private void o() {
        this.getDataWatcher().set(b, this.hooked.getId() + 1);
    }
    ...
    private void a(BlockPosition blockposition) {
        ...
        if (this.g > 0) {
            ...
            if (this.aw > 0) {
                ...
                float fx = this.ax * ((float)Math.PI / 180F);
                float f1 = MathHelper.sin(fx);
                float f2 = MathHelper.cos(fx);
                double d0 = this.locX + (double)(f1 * (float)this.aw * 0.1F);
                double d1 = (double)((float)MathHelper.floor(this.getBoundingBox().b) + 1.0F);
                double d2 = this.locZ + (double)(f2 * (float)this.aw * 0.1F);
                Block block = worldserver.getType(new BlockPosition(d0, d1 - 1.0D, d2)).getBlock();
                if (block == Blocks.WATER) {
                    if (this.random.nextFloat() < 0.15F) {
                        worldserver.a(Particles.e, d0, d1 - (double)0.1F, d2, 1, (double)f1, 0.1D, (double)f2, 0.0D);
                    }
                ...
                worldserver.a(Particles.e, this.locX, d3, this.locZ, (int)(1.0F + this.width * 20.0F), (double)this.width, 0.0D, (double)this.width, (double)0.2F);
                worldserver.a(Particles.x, this.locX, d3, this.locZ, (int)(1.0F + this.width * 20.0F), (double)this.width, 0.0D, (double)this.width, (double)0.2F);
            ...
            float f5 = 0.15F;
            if (this.h < 20) {
                f5 = (float)((double)f5 + (double)(20 - this.h) * 0.05D);
            } else if (this.h < 40) {
                f5 = (float)((double)f5 + (double)(40 - this.h) * 0.02D);
            } else if (this.h < 60) {
                f5 = (float)((double)f5 + (double)(60 - this.h) * 0.01D);
            }

            if (this.random.nextFloat() < f5) {
                float f6 = MathHelper.a(this.random, 0.0F, 360.0F) * ((float)Math.PI / 180F);
                float f7 = MathHelper.a(this.random, 25.0F, 60.0F);
                double d4 = this.locX + (double)(MathHelper.sin(f6) * f7 * 0.1F);
                double d5 = (double)((float)MathHelper.floor(this.getBoundingBox().b) + 1.0F);
                double d6 = this.locZ + (double)(MathHelper.cos(f6) * f7 * 0.1F);
                Block block1 = worldserver.getType(new BlockPosition((int)d4, (int)d5 - 1, (int)d6)).getBlock();
                if (block1 == Blocks.WATER) {
                    worldserver.a(Particles.R, d4, d5, d6, 2 + this.random.nextInt(2), (double)0.1F, 0.0D, (double)0.1F, 0.0D);
                }
            }
    ...
    public int b(ItemStack itemstack) {
        if (!this.world.isClientSide && this.owner != null) {
            ...
            if (this.hooked != null) {
                ...
                loottableinfo$builder.luck((float)this.az + this.owner.dJ());
                List list = this.world.getMinecraftServer().getLootTableRegistry().getLootTable(LootTables.aO).a(this.random, loottableinfo$builder.build());
