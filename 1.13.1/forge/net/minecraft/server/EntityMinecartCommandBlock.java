...
public class EntityMinecartCommandBlock extends EntityMinecartAbstract {
    ...
    protected void x_() {
        super.x_();
        this.getDataWatcher().register(COMMAND, "");
        this.getDataWatcher().register(b, new ChatComponentText(""));
    }

    protected void a(NBTTagCompound nbttagcompound) {
        super.a(nbttagcompound);
        this.c.b(nbttagcompound);
        this.getDataWatcher().set(COMMAND, this.getCommandBlock().getCommand());
        this.getDataWatcher().set(b, this.getCommandBlock().j());
    }
    ...
    public void a(DataWatcherObject<?> datawatcherobject) {
        ...
        if (b.equals(datawatcherobject)) {
            try {
                this.c.c((IChatBaseComponent)this.getDataWatcher().get(b));
            } catch (Throwable var3) {
                ;
            }
        } else if (COMMAND.equals(datawatcherobject)) {
            this.c.setCommand((String)this.getDataWatcher().get(COMMAND));
        }
