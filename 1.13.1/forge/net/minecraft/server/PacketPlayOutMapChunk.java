...
public class PacketPlayOutMapChunk implements Packet<PacketListenerPlayOut> {
    ...
    public void b(PacketDataSerializer packetdataserializer) throws IOException {
        ...
        for(NBTTagCompound nbttagcompound : this.e) {
    ...
    public int a(PacketDataSerializer packetdataserializer, Chunk chunk, boolean flag, int i) {
        ...
        if (this.f()) {
            ...
            for(int i1 = 0; i1 < abiomebase.length; ++i1) {
                packetdataserializer.writeInt(IRegistry.BIOME.a(abiomebase[i1]));
            }
        }
    ...
    protected int a(Chunk chunk, boolean flag, int i) {
        ...
        for(int l = achunksection.length; k < l; ++k) {
            ChunkSection chunksection = achunksection[k];
            if (chunksection != Chunk.a && (!this.f() || !chunksection.a()) && (i & 1 << k) != 0) {
                j = j + chunksection.getBlocks().a();
                j = j + chunksection.getEmittedLightArray().asBytes().length;
                if (flag) {
