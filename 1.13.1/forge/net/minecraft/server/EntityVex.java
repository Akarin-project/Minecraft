...
public class EntityVex extends EntityMonster {
    ...
    class a extends PathfinderGoal {
        ...
        public boolean a() {
            if (EntityVex.this.getGoalTarget() != null && !EntityVex.this.getControllerMove().b() && EntityVex.this.random.nextInt(7) == 0) {
                return EntityVex.this.h(EntityVex.this.getGoalTarget()) > 4.0D;
            } else {
                return false;
            }
        }
            ...
            if (this.h == ControllerMove.Operation.MOVE_TO) {
                ...
                if (d3 < EntityVex.this.getBoundingBox().a()) {
                    ...
                    if (EntityVex.this.getGoalTarget() == null) {
                        EntityVex.this.yaw = -((float)MathHelper.c(EntityVex.this.motX, EntityVex.this.motZ)) * (180F / (float)Math.PI);
                        ...
                        EntityVex.this.yaw = -((float)MathHelper.c(d4, d5)) * (180F / (float)Math.PI);
                        EntityVex.this.aQ = EntityVex.this.yaw;
                    }
                }
