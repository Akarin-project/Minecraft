...
public final class BiomeExtremeHillsWithTreesMutated extends BiomeBase {
    protected BiomeExtremeHillsWithTreesMutated() {
        super((new BiomeBase.a()).a(new WorldGenSurfaceComposite(ax, ai)).a(BiomeBase.Precipitation.RAIN).a(BiomeBase.Geography.EXTREME_HILLS).a(1.0F).b(0.5F).c(0.2F).d(0.3F).a(4159204).b(329011).a("wooded_mountains"));
