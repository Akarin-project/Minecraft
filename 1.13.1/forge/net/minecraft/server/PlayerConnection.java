...
public class PlayerConnection implements PacketListenerPlayIn, ITickable {
    ...
    private int j;
    private final IntHashMap<Short> k = new IntHashMap<Short>();
    private double l;
    private double m;
    private double n;
    private double o;
    ...
    public void disconnect(IChatBaseComponent ichatbasecomponent) {
        this.networkManager.sendPacket(new PacketPlayOutKickDisconnect(ichatbasecomponent), (var2) -> {
            this.networkManager.close(ichatbasecomponent);
        });
        this.networkManager.stopReading();
        Futures.getUnchecked(this.minecraftServer.postToMainThread(this.networkManager::handleDisconnection));
    }
    ...
    private static boolean b(PacketPlayInFlying packetplayinflying) {
        if (Doubles.isFinite(packetplayinflying.a(0.0D)) && Doubles.isFinite(packetplayinflying.b(0.0D)) && Doubles.isFinite(packetplayinflying.c(0.0D)) && Floats.isFinite(packetplayinflying.b(0.0F)) && Floats.isFinite(packetplayinflying.a(0.0F))) {
            return Math.abs(packetplayinflying.a(0.0D)) > 3.0E7D || Math.abs(packetplayinflying.b(0.0D)) > 3.0E7D || Math.abs(packetplayinflying.c(0.0D)) > 3.0E7D;
        } else {
            return true;
        }
    }
    ...
    public void a(PacketPlayInVehicleMove packetplayinvehiclemove) {
        ...
        if (b(packetplayinvehiclemove)) {
            ...
            if (entity != this.player && entity.bO() == this.player && entity == this.r) {
                ...
                float fx = packetplayinvehiclemove.getYaw();
                ...
                if (d10 - d9 > 100.0D && (!this.minecraftServer.H() || !this.minecraftServer.G().equals(entity.getDisplayName().getString()))) {
                    LOGGER.warn("{} (vehicle of {}) moved too quickly! {},{},{}", entity.getDisplayName().getString(), this.player.getDisplayName().getString(), d6, d7, d8);
                ...
                if (d10 > 0.0625D) {
                    flag1 = true;
                    LOGGER.warn("{} moved wrongly!", entity.getDisplayName().getString());
                }

                entity.setLocation(d3, d4, d5, fx, f1);
                boolean flag2 = worldserver.getCubes(entity, entity.getBoundingBox().shrink(0.0625D));
                if (flag && (flag1 || !flag2)) {
                    entity.setLocation(d0, d1, d2, fx, f1);
                    this.networkManager.sendPacket(new PacketPlayOutVehicleMove(entity));
                    return;
                }
    ...
    public void a(PacketPlayInSetCommandBlock packetplayinsetcommandblock) {
        ...
        if (!this.minecraftServer.getEnableCommandBlock()) {
            ...
            String sx = packetplayinsetcommandblock.c();
            ...
            if (commandblocklistenerabstract != null) {
                ...
                case SEQUENCE:
                    IBlockData iblockdata1 = Blocks.CHAIN_COMMAND_BLOCK.getBlockData();
                    this.player.world.setTypeAndData(blockposition, (IBlockData)((IBlockData)iblockdata1.set(BlockCommand.a, enumdirection)).set(BlockCommand.b, Boolean.valueOf(packetplayinsetcommandblock.e())), 2);
                    break;
                case AUTO:
                    IBlockData iblockdata = Blocks.REPEATING_COMMAND_BLOCK.getBlockData();
                ...
                case REDSTONE:
                default:
                    IBlockData iblockdata2 = Blocks.COMMAND_BLOCK.getBlockData();
                    this.player.world.setTypeAndData(blockposition, (IBlockData)((IBlockData)iblockdata2.set(BlockCommand.a, enumdirection)).set(BlockCommand.b, Boolean.valueOf(packetplayinsetcommandblock.e())), 2);
                }

                tileentity.z();
                this.player.world.setTileEntity(blockposition, tileentity);
                commandblocklistenerabstract.setCommand(sx);
                ...
                if (!UtilColor.b(sx)) {
                    this.player.sendMessage(new ChatMessage("advMode.setCommand.success", new Object[]{sx}));
                }
            }
    ...
    public void a(PacketPlayInItemName packetplayinitemname) {
        ...
        if (this.player.activeContainer instanceof ContainerAnvil) {
            ...
            String sx = SharedConstants.a(packetplayinitemname.b());
            if (sx.length() <= 35) {
                containeranvil.a(sx);
            }
        }
        ...
        if (this.player.isCreativeAndOp()) {
            ...
            if (tileentity instanceof TileEntityStructure) {
                ...
                if (tileentitystructure.d()) {
                    String sx = tileentitystructure.getStructureName();
                    if (packetplayinstruct.c() == TileEntityStructure.UpdateType.SAVE_AREA) {
                        if (tileentitystructure.q()) {
                            this.player.a(new ChatMessage("structure_block.save_success", new Object[]{sx}), false);
                        } else {
                            this.player.a(new ChatMessage("structure_block.save_failure", new Object[]{sx}), false);
                        }
                    } else if (packetplayinstruct.c() == TileEntityStructure.UpdateType.LOAD_AREA) {
                        if (!tileentitystructure.D()) {
                            this.player.a(new ChatMessage("structure_block.load_not_found", new Object[]{sx}), false);
                        } else if (tileentitystructure.r()) {
                            this.player.a(new ChatMessage("structure_block.load_success", new Object[]{sx}), false);
                        } else {
                            this.player.a(new ChatMessage("structure_block.load_prepare", new Object[]{sx}), false);
                        }
                    } else if (packetplayinstruct.c() == TileEntityStructure.UpdateType.SCAN_AREA) {
                        if (tileentitystructure.p()) {
                            this.player.a(new ChatMessage("structure_block.size_success", new Object[]{sx}), false);
                        } else {
                ...
                if (!itemstack1.isEmpty()) {
                    if (itemstack.getItem() == Items.WRITABLE_BOOK && itemstack1.getItem() == Items.WRITABLE_BOOK) {
                        if (packetplayinbedit.c()) {
                            ...
                            itemstack2.a("author", new NBTTagString(this.player.getDisplayName().getString()));
                            ...
                            for(int i = 0; i < nbttaglist.size(); ++i) {
                                String sx = nbttaglist.getString(i);
                                ChatComponentText chatcomponenttext = new ChatComponentText(sx);
                                sx = IChatBaseComponent.ChatSerializer.a(chatcomponenttext);
                                nbttaglist.set(i, (NBTBase)(new NBTTagString(sx)));
                            }
            ...
            if (!this.player.viewingCredits) {
                ...
                if (this.teleportPos != null) {
                    ...
                    if (this.player.isPassenger()) {
                        ...
                        float fx = packetplayinflying.a(this.player.yaw);
                        ...
                        if (this.player.isSleeping()) {
                            ...
                            if (i > 5) {
                                LOGGER.debug("{} is sending move packets too frequently ({} packets since last tick)", this.player.getDisplayName().getString(), i);
                                i = 1;
                            }
                            ...
                            if (!this.player.H() && (!this.player.getWorldServer().getGameRules().getBoolean("disableElytraMovementCheck") || !this.player.dc())) {
                                ...
                                if (d11 - d10 > (double)(f2 * (float)i) && (!this.minecraftServer.H() || !this.minecraftServer.G().equals(this.player.getProfile().getName()))) {
                                    LOGGER.warn("{} moved too quickly! {},{},{}", this.player.getDisplayName().getString(), d7, d8, d9);
                            ...
                            this.player.setLocation(d4, d5, d6, fx, f1);
                            this.player.checkMovement(this.player.locX - d0, this.player.locY - d1, this.player.locZ - d2);
                            if (!this.player.noclip && !this.player.isSleeping()) {
                                boolean flag1 = worldserver.getCubes(this.player, this.player.getBoundingBox().shrink(0.0625D));
                                if (flag2 && (flag || !flag1)) {
                                    this.a(d0, d1, d2, fx, f1);
                                    return;
                                }
                            }
    ...
    public void a(double d0, double d1, double d2, float fx, float f1) {
        this.a(d0, d1, d2, fx, f1, Collections.emptySet());
    }

    public void a(double d0, double d1, double d2, float fx, float f1, Set<PacketPlayOutPosition.EnumPlayerTeleportFlags> set) {
        ...
        this.A = this.e;
        this.player.setLocation(d0, d1, d2, fx, f1);
        this.player.playerConnection.sendPacket(new PacketPlayOutPosition(d0 - d3, d1 - d4, d2 - d5, fx - f2, f1 - f3, set, this.teleportAwait));
    }
    ...
    public void a(PacketPlayInUseItem packetplayinuseitem) {
        ...
        if (blockposition.getY() < this.minecraftServer.getMaxBuildHeight() - 1 || enumdirection != EnumDirection.UP && blockposition.getY() < this.minecraftServer.getMaxBuildHeight()) {
            if (this.teleportPos == null && this.player.d((double)blockposition.getX() + 0.5D, (double)blockposition.getY() + 0.5D, (double)blockposition.getZ() + 0.5D) < 64.0D && !this.minecraftServer.a(worldserver, blockposition, this.player) && worldserver.getWorldBorder().a(blockposition)) {
    ...
    public void a(Packet<?> packet, @Nullable GenericFutureListener<? extends Future<? super Void>> genericfuturelistener) {
        if (packet instanceof PacketPlayOutChat) {
            ...
            if (entityhuman$enumchatvisibility == EntityHuman.EnumChatVisibility.HIDDEN && packetplayoutchat.d() != ChatMessageType.GAME_INFO) {
                return;
            }

            if (entityhuman$enumchatvisibility == EntityHuman.EnumChatVisibility.SYSTEM && !packetplayoutchat.c()) {
                return;
            }
        }
    ...
    public void a(PacketPlayInChat packetplayinchat) {
        ...
        if (this.player.getChatFlags() == EntityHuman.EnumChatVisibility.HIDDEN) {
            ...
            this.player.resetIdleTimer();
            String sx = packetplayinchat.b();
            sx = StringUtils.normalizeSpace(sx);

            for(int i = 0; i < sx.length(); ++i) {
                if (!SharedConstants.isAllowedChatCharacter(sx.charAt(i))) {
            ...
            if (sx.startsWith("/")) {
                this.handleCommand(sx);
            } else {
                ChatMessage chatmessage = new ChatMessage("chat.type.text", new Object[]{this.player.getScoreboardDisplayName(), sx});
    ...
    private void handleCommand(String sx) {
        this.minecraftServer.getCommandDispatcher().a(this.player.getCommandListener(), sx);
    }
    ...
    public void a(PacketPlayInEntityAction packetplayinentityaction) {
        ...
        case START_RIDING_JUMP:
            if (this.player.getVehicle() instanceof IJumpable) {
                IJumpable ijumpable1 = (IJumpable)this.player.getVehicle();
                int i = packetplayinentityaction.d();
                if (ijumpable1.G_() && i > 0) {
                    ijumpable1.b(i);
                }
            }
            break;
        ...
        case OPEN_INVENTORY:
            if (this.player.getVehicle() instanceof EntityHorseAbstract) {
                ((EntityHorseAbstract)this.player.getVehicle()).c(this.player);
            }
            break;
        ...
        if (entity != null) {
            ...
            if (this.player.h(entity) < d0) {
                if (packetplayinuseentity.b() == PacketPlayInUseEntity.EnumEntityUseAction.INTERACT) {
                    ...
                    EnumHand enumhand1 = packetplayinuseentity.c();
                    entity.a(this.player, packetplayinuseentity.d(), enumhand1);
    ...
    public void a(PacketPlayInClientCommand packetplayinclientcommand) {
        ...
        this.player.resetIdleTimer();
        PacketPlayInClientCommand.EnumClientCommand packetplayinclientcommand$enumclientcommand = packetplayinclientcommand.b();
        switch(packetplayinclientcommand$enumclientcommand) {
    ...
    public void a(PacketPlayInWindowClick packetplayinwindowclick) {
        ...
        if (this.player.activeContainer.windowId == packetplayinwindowclick.b() && this.player.activeContainer.c(this.player)) {
            if (this.player.isSpectator()) {
                ...
                ItemStack itemstack1 = this.player.activeContainer.a(packetplayinwindowclick.c(), packetplayinwindowclick.d(), packetplayinwindowclick.g(), this.player);
                if (ItemStack.matches(packetplayinwindowclick.f(), itemstack1)) {
                    ...
                    for(int jx = 0; jx < this.player.activeContainer.slots.size(); ++jx) {
                        ItemStack itemstack = ((Slot)this.player.activeContainer.slots.get(jx)).getItem();
                        nonnulllist1.add(itemstack.isEmpty() ? ItemStack.a : itemstack);
                    }
