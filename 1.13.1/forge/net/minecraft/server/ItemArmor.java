...
public class ItemArmor extends Item {
    ...
    public ItemArmor(ArmorMaterial armormaterial, EnumItemSlot enumitemslot, Item.Info item$info) {
        super(item$info.b(armormaterial.a(enumitemslot)));
    ...
    public Multimap<String, AttributeModifier> a(EnumItemSlot enumitemslot) {
        ...
        if (enumitemslot == this.b) {
            multimap.put(GenericAttributes.h.getName(), new AttributeModifier(k[enumitemslot.b()], "Armor modifier", (double)this.c, 0));
            multimap.put(GenericAttributes.i.getName(), new AttributeModifier(k[enumitemslot.b()], "Armor toughness", (double)this.d, 0));
        }
