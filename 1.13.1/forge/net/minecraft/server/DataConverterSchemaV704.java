...
public class DataConverterSchemaV704 extends Schema {
    ...
    protected static final HookFunction b = new HookFunction() {
        public <T> T apply(DynamicOps<T> dynamicops, T object) {
            return (T)DataConverterSchemaV99.a(new Dynamic(dynamicops, object), DataConverterSchemaV704.a, "ArmorStand");
        }
    };
    ...
    public Map<String, Supplier<TypeTemplate>> registerBlockEntities(Schema schema) {
        ...
        schema.register(hashmap, "minecraft:flower_pot", (var1) -> {
