...
public class DataConverterSchemaV1460 extends DataConverterSchemaNamed {
    ...
    public Map<String, Supplier<TypeTemplate>> registerEntities(Schema schema) {
        ...
        schema.register(hashmap, "minecraft:arrow", (var1) -> {
        ...
        schema.register(hashmap, "minecraft:chest_minecart", (var1) -> {
        ...
        schema.register(hashmap, "minecraft:commandblock_minecart", (var1) -> {
        ...
        schema.register(hashmap, "minecraft:donkey", (var1) -> {
        ...
        schema.register(hashmap, "minecraft:enderman", (var1) -> {
        ...
        schema.register(hashmap, "minecraft:falling_block", (var1) -> {
        ...
        schema.register(hashmap, "minecraft:fireworks_rocket", (var1) -> {
            return DSL.optionalFields("FireworksItem", DataConverterTypes.ITEM_STACK.in(schema));
        });
        schema.register(hashmap, "minecraft:furnace_minecart", (var1) -> {
            return DSL.optionalFields("DisplayState", DataConverterTypes.l.in(schema));
        });
        a(schema, hashmap, "minecraft:ghast");
        a(schema, hashmap, "minecraft:giant");
        a(schema, hashmap, "minecraft:guardian");
        schema.register(hashmap, "minecraft:hopper_minecart", (var1) -> {
            return DSL.optionalFields("DisplayState", DataConverterTypes.l.in(schema), "Items", DSL.list(DataConverterTypes.ITEM_STACK.in(schema)));
        });
        schema.register(hashmap, "minecraft:horse", (var1) -> {
        ...
        schema.register(hashmap, "minecraft:item", (var1) -> {
            return DSL.optionalFields("Item", DataConverterTypes.ITEM_STACK.in(schema));
        });
        schema.register(hashmap, "minecraft:item_frame", (var1) -> {
            return DSL.optionalFields("Item", DataConverterTypes.ITEM_STACK.in(schema));
        });
        schema.registerSimple(hashmap, "minecraft:leash_knot");
        schema.register(hashmap, "minecraft:llama", (var1) -> {
        ...
        schema.register(hashmap, "minecraft:minecart", (var1) -> {
            return DSL.optionalFields("DisplayState", DataConverterTypes.l.in(schema));
        });
        a(schema, hashmap, "minecraft:mooshroom");
        schema.register(hashmap, "minecraft:mule", (var1) -> {
            return DSL.optionalFields("Items", DSL.list(DataConverterTypes.ITEM_STACK.in(schema)), "SaddleItem", DataConverterTypes.ITEM_STACK.in(schema), DataConverterSchemaV100.a(schema));
        });
        ...
        schema.register(hashmap, "minecraft:potion", (var1) -> {
        ...
        schema.register(hashmap, "minecraft:skeleton_horse", (var1) -> {
        ...
        schema.register(hashmap, "minecraft:spawner_minecart", (var1) -> {
            return DSL.optionalFields("DisplayState", DataConverterTypes.l.in(schema), DataConverterTypes.r.in(schema));
        });
        schema.register(hashmap, "minecraft:spectral_arrow", (var1) -> {
            return DSL.optionalFields("inBlockState", DataConverterTypes.l.in(schema));
        });
        ...
        schema.register(hashmap, "minecraft:tnt_minecart", (var1) -> {
            return DSL.optionalFields("DisplayState", DataConverterTypes.l.in(schema));
        });
        a(schema, hashmap, "minecraft:vex");
        schema.register(hashmap, "minecraft:villager", (var1) -> {
        ...
        schema.register(hashmap, "minecraft:zombie_horse", (var1) -> {
            return DSL.optionalFields("SaddleItem", DataConverterTypes.ITEM_STACK.in(schema), DataConverterSchemaV100.a(schema));
        });
    ...
    public Map<String, Supplier<TypeTemplate>> registerBlockEntities(Schema schema) {
        ...
        schema.register(hashmap, "minecraft:jukebox", (var1) -> {
        ...
        schema.register(hashmap, "minecraft:mob_spawner", (var1) -> {
            return DataConverterTypes.r.in(schema);
        });
        schema.register(hashmap, "minecraft:piston", (var1) -> {
