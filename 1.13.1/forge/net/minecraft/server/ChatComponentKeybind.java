...
public class ChatComponentKeybind extends ChatBaseComponent {
    ...
    public String getText() {
        if (this.d == null) {
            this.d = (Supplier)b.apply(this.c);
        }
    ...
    public boolean equals(Object object) {
        if (this == object) {
            ...
            ChatComponentKeybind chatcomponentkeybind1 = (ChatComponentKeybind)object;
            return this.c.equals(chatcomponentkeybind1.c) && super.equals(object);
        }
    }
