...
public class Particles {
    ...
    private static <T extends Particle<?>> T a(String sx) {
        Particle particle = IRegistry.PARTICLE_TYPE.get(new MinecraftKey(sx));
        if (particle == null) {
            throw new IllegalStateException("Invalid or unknown particle type: " + sx);
        } else {
            return (T)particle;
        }
    }
