...
public class EntityPotion extends EntityProjectile {
    ...
    protected void x_() {
        this.getDataWatcher().register(f, ItemStack.a);
    }

    public ItemStack getItem() {
        ItemStack itemstack = (ItemStack)this.getDataWatcher().get(f);
        if (itemstack.getItem() != Items.SPLASH_POTION && itemstack.getItem() != Items.LINGERING_POTION) {
            if (this.world != null) {
                g.error("ThrownPotion entity {} has no item?!", this.getId());
            }
    ...
    public void setItem(ItemStack itemstack) {
        this.getDataWatcher().set(f, itemstack);
    }
    ...
    private void l() {
        ...
        List list = this.world.a(EntityLiving.class, axisalignedbb, e);
        if (!list.isEmpty()) {
