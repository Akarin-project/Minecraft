...
public abstract class EntityCreature extends EntityInsentient {
    ...
    public float a(BlockPosition var1, IWorldReader var2) {
        return 0.0F;
    }

    public boolean a(GeneratorAccess generatoraccess, boolean flag) {
        return super.a(generatoraccess, flag) && this.a(new BlockPosition(this.locX, this.getBoundingBox().b, this.locZ), generatoraccess) >= 0.0F;
    }
    ...
    public boolean f(BlockPosition blockposition) {
        if (this.b == -1.0F) {
            ...
            return this.a.n(blockposition) < (double)(this.b * this.b);
        }
    }
