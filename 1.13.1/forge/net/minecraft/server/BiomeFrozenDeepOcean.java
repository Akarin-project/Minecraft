...
public class BiomeFrozenDeepOcean extends BiomeBase {
    ...
    public BiomeFrozenDeepOcean() {
        super((new BiomeBase.a()).a(new WorldGenSurfaceComposite(aD, ai)).a(BiomeBase.Precipitation.RAIN).a(BiomeBase.Geography.OCEAN).a(-1.8F).b(0.1F).c(0.5F).d(0.5F).a(3750089).b(329011).a((String)null));
        this.a(WorldGenerator.o, new WorldGenFeatureOceanRuinConfiguration(WorldGenFeatureOceanRuin.Temperature.COLD, 0.3F, 0.9F));
        this.a(WorldGenerator.n, new WorldGenMonumentConfiguration());
        this.a(WorldGenerator.f, new WorldGenMineshaftConfiguration(0.004D, WorldGenMineshaft.Type.NORMAL));
        this.a(WorldGenerator.k, new WorldGenFeatureShipwreckConfiguration(false));
        this.a(WorldGenStage.Features.AIR, a(b, new WorldGenFeatureConfigurationChance(0.06666667F)));
        this.a(WorldGenStage.Features.AIR, a(d, new WorldGenFeatureConfigurationChance(0.02F)));
        this.a(WorldGenStage.Features.LIQUID, a(e, new WorldGenFeatureConfigurationChance(0.02F)));
        this.a(WorldGenStage.Features.LIQUID, a(f, new WorldGenFeatureConfigurationChance(0.06666667F)));
        this.a();
        ...
        this.a(WorldGenStage.Decoration.LOCAL_MODIFICATIONS, a(WorldGenerator.af, new WorldGenFeatureIceburgConfiguration(Blocks.PACKED_ICE.getBlockData()), N, new WorldGenDecoratorChanceConfiguration(16)));
        this.a(WorldGenStage.Decoration.LOCAL_MODIFICATIONS, a(WorldGenerator.af, new WorldGenFeatureIceburgConfiguration(Blocks.BLUE_ICE.getBlockData()), N, new WorldGenDecoratorChanceConfiguration(200)));
        ...
        this.a(WorldGenStage.Decoration.SURFACE_STRUCTURES, a(WorldGenerator.ae, WorldGenFeatureConfiguration.e, w, new WorldGenFeatureChanceDecoratorCountConfiguration(20, 30, 32, 64)));
    ...
    public float c(BlockPosition blockposition) {
        ...
        double d0 = aZ.a((double)blockposition.getX() * 0.05D, (double)blockposition.getZ() * 0.05D);
        double d1 = aJ.a((double)blockposition.getX() * 0.2D, (double)blockposition.getZ() * 0.2D);
        double d2 = d0 + d1;
        if (d2 < 0.3D) {
            double d3 = aJ.a((double)blockposition.getX() * 0.09D, (double)blockposition.getZ() * 0.09D);
            if (d3 < 0.8D) {
                f = 0.2F;
            }
        }
        ...
        if (blockposition.getY() > 64) {
            float f1 = (float)(aI.a((double)((float)blockposition.getX() / 8.0F), (double)((float)blockposition.getZ() / 8.0F)) * 4.0D);
