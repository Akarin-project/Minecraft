...
public class Potions {
    ...
    private static PotionRegistry a(String sx) {
        PotionRegistry potionregistry = IRegistry.POTION.getOrDefault(new MinecraftKey(sx));
        if (!Q.add(potionregistry)) {
            throw new IllegalStateException("Invalid Potion requested: " + sx);
        } else {
