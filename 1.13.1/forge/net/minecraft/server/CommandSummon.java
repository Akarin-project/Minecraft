...
public class CommandSummon {
    ...
    public static void a(com.mojang.brigadier.CommandDispatcher<CommandListenerWrapper> commanddispatcher) {
        commanddispatcher.register((LiteralArgumentBuilder)((LiteralArgumentBuilder)CommandDispatcher.a("summon").requires((commandlistenerwrapper) -> {
            return commandlistenerwrapper.hasPermission(2);
        })).then(((RequiredArgumentBuilder)CommandDispatcher.a("entity", ArgumentEntitySummon.a()).suggests(CompletionProviders.d).executes((commandcontext) -> {
        ...
        })).then(CommandDispatcher.a("nbt", ArgumentNBTTag.a()).executes((commandcontext) -> {
