...
public class DispenseBehaviorItem implements IDispenseBehavior {
    ...
    public static void a(World world, ItemStack itemstack, int i, EnumDirection enumdirection, IPosition iposition) {
        ...
        entityitem.motX += world.random.nextGaussian() * (double)0.0075F * (double)i;
        entityitem.motY += world.random.nextGaussian() * (double)0.0075F * (double)i;
        entityitem.motZ += world.random.nextGaussian() * (double)0.0075F * (double)i;
