...
public class PacketPlayOutTitle implements Packet<PacketListenerPlayOut> {
    ...
    public PacketPlayOutTitle(PacketPlayOutTitle.EnumTitleAction packetplayouttitle$enumtitleaction, @Nullable IChatBaseComponent ichatbasecomponent, int i, int j, int k) {
        this.a = packetplayouttitle$enumtitleaction;
