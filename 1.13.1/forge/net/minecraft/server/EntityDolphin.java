...
public class EntityDolphin extends EntityWaterAnimal {
    ...
    public void g(BlockPosition blockposition) {
        this.datawatcher.set(b, blockposition);
    }

    public BlockPosition l() {
        return (BlockPosition)this.datawatcher.get(b);
    }
    ...
    protected void x_() {
        ...
        this.datawatcher.register(bC, 2400);
    }
    ...
    protected void n() {
        ...
        this.goalSelector.a(6, new PathfinderGoalMeleeAttack(this, (double)1.2F, true));
    ...
    protected void initAttributes() {
        ...
        this.getAttributeInstance(GenericAttributes.MOVEMENT_SPEED).setValue((double)1.2F);
    ...
    public void tick() {
        ...
        if (!this.isNoAI()) {
            ...
            if (this.world.isClientSide && this.isInWater() && this.motX * this.motX + this.motY * this.motY + this.motZ * this.motZ > 0.03D) {
                ...
                float f = MathHelper.cos(this.yaw * ((float)Math.PI / 180F)) * 0.3F;
                float f1 = MathHelper.sin(this.yaw * ((float)Math.PI / 180F)) * 0.3F;
    ...
    public EntityItem f(ItemStack itemstack) {
        if (itemstack.isEmpty()) {
            ...
            float f = 0.3F;
            entityitem.motX = (double)(-MathHelper.sin(this.yaw * ((float)Math.PI / 180F)) * MathHelper.cos(this.pitch * ((float)Math.PI / 180F)) * f);
            entityitem.motY = (double)(MathHelper.sin(this.pitch * ((float)Math.PI / 180F)) * f * 1.5F);
            entityitem.motZ = (double)(MathHelper.cos(this.yaw * ((float)Math.PI / 180F)) * MathHelper.cos(this.pitch * ((float)Math.PI / 180F)) * f);
    ...
    protected boolean dA() {
        ...
        if (blockposition != null) {
            return this.c(blockposition) < 144.0D;
        } else {
            return false;
        }
    }
        ...
        public void a() {
            ...
            if (this.h == ControllerMove.Operation.MOVE_TO && !this.i.getNavigation().p()) {
                ...
                if (d3 < (double)2.5000003E-7F) {
                    ...
                    if (this.i.isInWater()) {
                        this.i.o(f1 * 0.02F);
                        float f2 = -((float)(MathHelper.c(d1, (double)MathHelper.sqrt(d0 * d0 + d2 * d2)) * (double)(180F / (float)Math.PI)));
                        f2 = MathHelper.a(MathHelper.g(f2), -85.0F, 85.0F);
                        this.i.pitch = this.a(this.i.pitch, f2, 5.0F);
                        float f3 = MathHelper.cos(this.i.pitch * ((float)Math.PI / 180F));
                        float f4 = MathHelper.sin(this.i.pitch * ((float)Math.PI / 180F));
                        this.i.bj = f3 * f1;
                        this.i.bi = -f4 * f1;
                    } else {
                        this.i.o(f1 * 0.1F);
    ...
    static class b extends PathfinderGoal {
        ...
        public void e() {
            ...
            if (this.a.dA() || this.a.getNavigation().p()) {
                Vec3D vec3d = RandomPositionGenerator.a(this.a, 16, 1, new Vec3D((double)blockposition.getX(), (double)blockposition.getY(), (double)blockposition.getZ()), (double)((float)Math.PI / 8F));
                if (vec3d == null) {
                ...
                if (vec3d != null) {
                    ...
                    if (!world.b(blockposition1).a(TagsFluid.WATER) || !world.getType(blockposition1).a(world, blockposition1, PathMode.WATER)) {
    ...
    class d extends PathfinderGoal {
        ...
        public void c() {
            List list = EntityDolphin.this.world.a(EntityItem.class, EntityDolphin.this.getBoundingBox().grow(8.0D, 8.0D, 8.0D), EntityDolphin.a);
            if (!list.isEmpty()) {
                EntityDolphin.this.getNavigation().a((Entity)list.get(0), (double)1.2F);
