...
public class BlockFence extends BlockTall {
    ...
    public BlockFence(Block.Info block$info) {
        super(2.0F, 2.0F, 16.0F, 16.0F, 24.0F, block$info);
    ...
    public IBlockData getPlacedState(BlockActionContext blockactioncontext) {
        ...
        return (IBlockData)((IBlockData)((IBlockData)((IBlockData)((IBlockData)super.getPlacedState(blockactioncontext).set(NORTH, Boolean.valueOf(this.a(iblockdata, iblockdata.c(world, blockposition1, EnumDirection.SOUTH))))).set(EAST, Boolean.valueOf(this.a(iblockdata1, iblockdata1.c(world, blockposition2, EnumDirection.WEST))))).set(SOUTH, Boolean.valueOf(this.a(iblockdata2, iblockdata2.c(world, blockposition3, EnumDirection.NORTH))))).set(WEST, Boolean.valueOf(this.a(iblockdata3, iblockdata3.c(world, blockposition4, EnumDirection.EAST))))).set(p, Boolean.valueOf(fluid.c() == FluidTypes.c));
    }
