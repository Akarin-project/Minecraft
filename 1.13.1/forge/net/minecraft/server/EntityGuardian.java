...
public class EntityGuardian extends EntityMonster {
    ...
    public boolean dB() {
        return this.datawatcher.get(bF);
    }

    private void a(boolean flag) {
        this.datawatcher.set(bF, flag);
    }
    ...
    private void a(int i) {
        this.datawatcher.set(bG, i);
    }

    public boolean dC() {
        return this.datawatcher.get(bG) != 0;
    }
    ...
    public EntityLiving dD() {
        if (!this.dC()) {
            ...
            if (this.bH != null) {
                ...
                Entity entity = this.world.getEntity(this.datawatcher.get(bG));
        ...
        if (this.world.isClientSide) {
            ...
            if (this.dC()) {
                ...
                if (entityliving != null) {
                    ...
                    double d5 = (double)this.w(0.0F);
                    double d0 = entityliving.locX - this.locX;
                    double d1 = entityliving.locY + (double)(entityliving.length * 0.5F) - (this.locY + (double)this.getHeadHeight());
                    ...
                    while(d4 < d3) {
                        ...
                        this.world.addParticle(Particles.e, this.locX + d0 * d4, this.locY + d1 * d4 + (double)this.getHeadHeight(), this.locZ + d2 * d4, 0.0D, 0.0D, 0.0D);
                    }
                }
            }
        }
    ...
    static class ControllerMoveGuardian extends ControllerMove {
        ...
        public void a() {
            if (this.h == ControllerMove.Operation.MOVE_TO && !this.i.getNavigation().p()) {
                ...
                double d5 = Math.cos((double)(this.i.yaw * ((float)Math.PI / 180F)));
                double d6 = Math.sin((double)(this.i.yaw * ((float)Math.PI / 180F)));
                this.i.motX += d4 * d5;
                this.i.motZ += d4 * d6;
