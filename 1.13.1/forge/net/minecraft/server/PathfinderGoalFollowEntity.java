...
public class PathfinderGoalFollowEntity extends PathfinderGoal {
    ...
    public PathfinderGoalFollowEntity(EntityInsentient entityinsentient, double d0, float fx, float f1) {
        this.a = entityinsentient;
        this.b = (entityinsentient2) -> {
            return entityinsentient2 != null && entityinsentient.getClass() != entityinsentient2.getClass();
        };
        this.d = d0;
