...
public class ArgumentTag implements ArgumentType<ArgumentTag.a> {
    ...
    public ArgumentTag.a a(StringReader stringreader) throws CommandSyntaxException {
        if (stringreader.canRead() && stringreader.peek() == '#') {
            stringreader.skip();
            MinecraftKey minecraftkey1 = MinecraftKey.a(stringreader);
            return (commandcontext) -> {
                Tag tag = ((CommandListenerWrapper)commandcontext.getSource()).getServer().getFunctionData().g().a(minecraftkey1);
                if (tag == null) {
                    throw b.create(minecraftkey1.toString());
                } else {
                    return tag.a();
                }
            };
    ...
    public interface a {
        Collection<CustomFunction> create(CommandContext<CommandListenerWrapper> var1) throws CommandSyntaxException;
    }
}
