...
public abstract class DefinedStructurePiece extends StructurePiece {
    ...
    protected abstract void a(String var1, BlockPosition var2, GeneratorAccess var3, Random var4, StructureBoundingBox var5);
    ...
    private void b() {
        ...
        default:
            break;
        case FRONT_BACK:
            BlockPosition blockposition3 = BlockPosition.ZERO;
            if (enumblockrotation != EnumBlockRotation.CLOCKWISE_90 && enumblockrotation != EnumBlockRotation.COUNTERCLOCKWISE_90) {
                if (enumblockrotation == EnumBlockRotation.CLOCKWISE_180) {
                    blockposition3 = blockposition3.shift(EnumDirection.EAST, k);
                } else {
                    blockposition3 = blockposition3.shift(EnumDirection.WEST, k);
                }
            } else {
                blockposition3 = blockposition3.shift(enumblockrotation.a(EnumDirection.WEST), i1);
            }

            this.n.a(blockposition3.getX(), 0, blockposition3.getZ());
            break;
        case LEFT_RIGHT:
