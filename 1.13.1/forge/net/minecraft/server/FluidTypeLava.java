...
public abstract class FluidTypeLava extends FluidTypeFlowing {
    ...
    public void b(World world, BlockPosition blockposition, Fluid var3, Random random) {
    ...
    protected void a(GeneratorAccess generatoraccess, BlockPosition blockposition, IBlockData var3) {
    ...
    public boolean a(Fluid fluid, FluidType fluidtype, EnumDirection var3) {
    ...
    public int a(World world, Fluid fluid, Fluid fluid1) {
        int i = this.a(world);
        if (!fluid.e() && !fluid1.e() && !fluid.get(FALLING) && !fluid1.get(FALLING) && fluid1.f() > fluid.f() && world.m().nextInt(4) != 0) {
            i *= 4;
        }
