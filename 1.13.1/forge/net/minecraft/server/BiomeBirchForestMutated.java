...
public final class BiomeBirchForestMutated extends BiomeBase {
    public BiomeBirchForestMutated() {
        super((new BiomeBase.a()).a(new WorldGenSurfaceComposite(au, ai)).a(BiomeBase.Precipitation.RAIN).a(BiomeBase.Geography.FOREST).a(0.2F).b(0.4F).c(0.6F).d(0.6F).a(4159204).b(329011).a("birch_forest"));
