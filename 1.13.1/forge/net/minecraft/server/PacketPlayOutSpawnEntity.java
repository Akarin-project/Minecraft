...
public class PacketPlayOutSpawnEntity implements Packet<PacketListenerPlayOut> {
    ...
    public PacketPlayOutSpawnEntity(Entity entity, int ix) {
        this(entity, ix, 0);
    }

    public PacketPlayOutSpawnEntity(Entity entity, int ix, int jx) {
        this.a = entity.getId();
    ...
    public PacketPlayOutSpawnEntity(Entity entity, int ix, int jx, BlockPosition blockposition) {
        this(entity, ix, jx);
