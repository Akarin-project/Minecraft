...
public final class BiomeMesaPlateauMutated extends BiomeBase {
    public BiomeMesaPlateauMutated() {
        super((new BiomeBase.a()).a(new WorldGenSurfaceComposite(aB, aq)).a(BiomeBase.Precipitation.NONE).a(BiomeBase.Geography.MESA).a(0.45F).b(0.3F).c(2.0F).d(0.0F).a(4159204).b(329011).a("wooded_badlands_plateau"));
        this.a(WorldGenerator.f, new WorldGenMineshaftConfiguration(0.004D, WorldGenMineshaft.Type.MESA));
        ...
        this.a(WorldGenStage.Decoration.UNDERGROUND_ORES, a(WorldGenerator.an, new WorldGenFeatureOreConfiguration(WorldGenFeatureOreConfiguration.a, Blocks.GOLD_ORE.getBlockData(), 9), t, new WorldGenFeatureChanceDecoratorCountConfiguration(20, 32, 32, 80)));
        ...
        this.a(WorldGenStage.Decoration.VEGETAL_DECORATION, a(WorldGenerator.C, WorldGenFeatureConfiguration.e, s, new WorldGenDecoratorFrequencyExtraChanceConfiguration(5, 0.1F, 1)));
        ...
        this.a(WorldGenStage.Decoration.VEGETAL_DECORATION, a(WorldGenerator.P, WorldGenFeatureConfiguration.e, j, new WorldGenDecoratorFrequencyConfiguration(20)));
        ...
        this.a(WorldGenStage.Decoration.VEGETAL_DECORATION, a(WorldGenerator.Z, WorldGenFeatureConfiguration.e, j, new WorldGenDecoratorFrequencyConfiguration(13)));
        ...
        this.a(WorldGenStage.Decoration.VEGETAL_DECORATION, a(WorldGenerator.O, WorldGenFeatureConfiguration.e, j, new WorldGenDecoratorFrequencyConfiguration(5)));
