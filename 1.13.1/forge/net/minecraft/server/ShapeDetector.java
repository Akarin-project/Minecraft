...
public class ShapeDetector {
    ...
    public ShapeDetector.ShapeDetectorCollection a(IWorldReader iworldreader, BlockPosition blockposition) {
        ...
        for(BlockPosition blockposition1 : BlockPosition.a(blockposition, blockposition.a(i - 1, i - 1, i - 1))) {
            for(EnumDirection enumdirection : EnumDirection.values()) {
                for(EnumDirection enumdirection1 : EnumDirection.values()) {
                    if (enumdirection1 != enumdirection && enumdirection1 != enumdirection.opposite()) {
                        ShapeDetector.ShapeDetectorCollection shapedetector$shapedetectorcollection = this.a(blockposition1, enumdirection, enumdirection1, loadingcache);
