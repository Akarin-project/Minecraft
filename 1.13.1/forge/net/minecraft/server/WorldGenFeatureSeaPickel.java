...
public class WorldGenFeatureSeaPickel extends WorldGenerator<WorldGenFeatureKelpConfiguration> {
    public WorldGenFeatureSeaPickel() {
    }

    public boolean a(GeneratorAccess generatoraccess, ChunkGenerator<?> var2, Random random, BlockPosition blockposition, WorldGenFeatureKelpConfiguration worldgenfeaturekelpconfiguration) {
        int i = 0;
