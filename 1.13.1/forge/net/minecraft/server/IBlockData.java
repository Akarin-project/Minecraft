...
public interface IBlockData extends IBlockDataHolder<IBlockData> {
    ...
    default boolean a(IBlockAccess iblockaccess, BlockPosition blockposition) {
        ...
        Object2ByteMap object2bytemap = block.s() ? null : (Object2ByteMap)a.get();
    ...
    default int b(IBlockAccess iblockaccess, BlockPosition blockposition) {
        Block block = this.getBlock();
        Object2ByteMap object2bytemap = block.s() ? null : (Object2ByteMap)b.get();
        if (object2bytemap != null) {
            byte b0 = object2bytemap.getByte(this);
            if (b0 != object2bytemap.defaultReturnValue()) {
                return b0;
    ...
    default boolean f(IBlockAccess iblockaccess, BlockPosition blockposition) {
        Block block = this.getBlock();
        Object2ByteMap object2bytemap = block.s() ? null : (Object2ByteMap)c.get();
        if (object2bytemap != null) {
            byte b0 = object2bytemap.getByte(this);
            if (b0 != object2bytemap.defaultReturnValue()) {
                return b0 != 0;
    ...
    default void onPlace(World world, BlockPosition blockposition, IBlockData iblockdata1) {
        this.getBlock().onPlace(this, world, blockposition, iblockdata1);
    }

    default void remove(World world, BlockPosition blockposition, IBlockData iblockdata1, boolean flag) {
        this.getBlock().remove(this, world, blockposition, iblockdata1, flag);
    }
    ...
    default IBlockData updateState(EnumDirection enumdirection, IBlockData iblockdata1, GeneratorAccess generatoraccess, BlockPosition blockposition, BlockPosition blockposition1) {
        return this.getBlock().updateState(this, enumdirection, iblockdata1, generatoraccess, blockposition, blockposition1);
    }
