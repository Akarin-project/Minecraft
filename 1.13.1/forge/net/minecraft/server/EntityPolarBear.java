...
public class EntityPolarBear extends EntityAnimal {
    ...
    public boolean a(GeneratorAccess generatoraccess, boolean flag) {
        ...
        if (biomebase != Biomes.l && biomebase != Biomes.Z) {
            return super.a(generatoraccess, flag);
        } else {
            return generatoraccess.getLightLevel(blockposition, 0) > 8 && generatoraccess.getType(blockposition.down()).getBlock() == Blocks.ICE;
        }
    }
    ...
    public GroupDataEntity prepare(DifficultyDamageScaler var1, @Nullable GroupDataEntity object, @Nullable NBTTagCompound var3) {
        if (object instanceof EntityPolarBear.b) {
            ...
            EntityPolarBear.b entitypolarbear$b = new EntityPolarBear.b();
            entitypolarbear$b.a = true;
            object = entitypolarbear$b;
        }
    ...
    class a extends PathfinderGoalNearestAttackableTarget<EntityHuman> {
        ...
        public boolean a() {
            if (EntityPolarBear.this.isBaby()) {
                ...
                if (super.a()) {
                    for(EntityPolarBear entitypolarbear : EntityPolarBear.this.world.a(EntityPolarBear.class, EntityPolarBear.this.getBoundingBox().grow(8.0D, 4.0D, 8.0D))) {
