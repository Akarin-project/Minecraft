...
public class DebugReportCommands implements DebugReportProvider {
    ...
    public void a(HashCache var1) throws IOException {
        ...
        File file1 = new File(this.b.b().toFile(), "tmp");
        UserCache usercache = new UserCache(gameprofilerepository, new File(file1, MinecraftServer.a.getName()));
        DedicatedServer dedicatedserver = new DedicatedServer(file1, DataConverterRegistry.a(), yggdrasilauthenticationservice, minecraftsessionservice, gameprofilerepository, usercache);
