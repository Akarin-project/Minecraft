...
public class PathfinderGoalLookAtPlayer extends PathfinderGoal {
    ...
    public PathfinderGoalLookAtPlayer(EntityInsentient entityinsentient, Class<? extends Entity> oclass, float fx) {
        this(entityinsentient, oclass, fx, 0.02F);
    }

    public PathfinderGoalLookAtPlayer(EntityInsentient entityinsentient, Class<? extends Entity> oclass, float fx, float f1) {
