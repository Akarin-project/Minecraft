...
public class CommandExecute {
    ...
    public static void a(com.mojang.brigadier.CommandDispatcher<CommandListenerWrapper> commanddispatcher) {
        LiteralCommandNode literalcommandnode = commanddispatcher.register((LiteralArgumentBuilder)CommandDispatcher.a("execute").requires((commandlistenerwrapper) -> {
            return commandlistenerwrapper.hasPermission(2);
        }));
        commanddispatcher.register((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)CommandDispatcher.a("execute").requires((commandlistenerwrapper) -> {
            return commandlistenerwrapper.hasPermission(2);
        })).then(CommandDispatcher.a("run").redirect(commanddispatcher.getRoot()))).then(a(literalcommandnode, CommandDispatcher.a("if"), true))).then(a(literalcommandnode, CommandDispatcher.a("unless"), false))).then(CommandDispatcher.a("as").then(CommandDispatcher.a("targets", ArgumentEntity.b()).fork(literalcommandnode, (commandcontext) -> {
            ArrayList arraylist = Lists.newArrayList();

            for(Entity entity : ArgumentEntity.c(commandcontext, "targets")) {
                arraylist.add(((CommandListenerWrapper)commandcontext.getSource()).a(entity));
            }

            return arraylist;
        })))).then(CommandDispatcher.a("at").then(CommandDispatcher.a("targets", ArgumentEntity.b()).fork(literalcommandnode, (commandcontext) -> {
            ArrayList arraylist = Lists.newArrayList();
            ...
            return arraylist;
        }))))).then(((LiteralArgumentBuilder)CommandDispatcher.a("rotated").then(CommandDispatcher.a("rot", ArgumentRotation.a()).redirect(literalcommandnode, (commandcontext) -> {
            ...
            return arraylist;
        }))))).then(((LiteralArgumentBuilder)CommandDispatcher.a("facing").then(CommandDispatcher.a("entity").then(CommandDispatcher.a("targets", ArgumentEntity.b()).then(CommandDispatcher.a("anchor", ArgumentAnchor.a()).fork(literalcommandnode, (commandcontext) -> {
            ArrayList arraylist = Lists.newArrayList();
            ArgumentAnchor.Anchor argumentanchor$anchor = ArgumentAnchor.a(commandcontext, "anchor");

            for(Entity entity : ArgumentEntity.c(commandcontext, "targets")) {
                arraylist.add(((CommandListenerWrapper)commandcontext.getSource()).a(entity, argumentanchor$anchor));
            }

            return arraylist;
        }))))).then(CommandDispatcher.a("pos", ArgumentVec3.a()).redirect(literalcommandnode, (commandcontext) -> {
            return ((CommandListenerWrapper)commandcontext.getSource()).b(ArgumentVec3.a(commandcontext, "pos"));
        })))).then(CommandDispatcher.a("align").then(CommandDispatcher.a("axes", ArgumentRotationAxis.a()).redirect(literalcommandnode, (commandcontext) -> {
        ...
        })))).then(CommandDispatcher.a("anchored").then(CommandDispatcher.a("anchor", ArgumentAnchor.a()).redirect(literalcommandnode, (commandcontext) -> {
            return ((CommandListenerWrapper)commandcontext.getSource()).a(ArgumentAnchor.a(commandcontext, "anchor"));
        })))).then(CommandDispatcher.a("in").then(CommandDispatcher.a("dimension", ArgumentDimension.a()).redirect(literalcommandnode, (commandcontext) -> {
    ...
    private static ArgumentBuilder<CommandListenerWrapper, ?> a(LiteralCommandNode<CommandListenerWrapper> literalcommandnode, LiteralArgumentBuilder<CommandListenerWrapper> literalargumentbuilder, boolean flag) {
        literalargumentbuilder.then(CommandDispatcher.a("score").then(CommandDispatcher.a("targets", ArgumentScoreholder.b()).suggests(ArgumentScoreholder.a).then(CommandDispatcher.a("objective", ArgumentScoreboardObjective.a()).redirect(literalcommandnode, (commandcontext) -> {
        ...
        literalargumentbuilder.then(CommandDispatcher.a("bossbar").then(((RequiredArgumentBuilder)CommandDispatcher.a("id", ArgumentMinecraftKeyRegistered.a()).suggests(CommandBossBar.a).then(CommandDispatcher.a("value").redirect(literalcommandnode, (commandcontext) -> {
        ...
        for(CommandData.a commanddata$a : CommandData.a) {
            commanddata$a.a(literalargumentbuilder, (argumentbuilder) -> {
                return argumentbuilder.then(((RequiredArgumentBuilder)((RequiredArgumentBuilder)((RequiredArgumentBuilder)((RequiredArgumentBuilder)((RequiredArgumentBuilder)CommandDispatcher.a("path", ArgumentNBTKey.a()).then(CommandDispatcher.a("int").then(CommandDispatcher.a("scale", DoubleArgumentType.doubleArg()).redirect(literalcommandnode, (commandcontext) -> {
                    return a((CommandListenerWrapper)commandcontext.getSource(), commanddata$a.a(commandcontext), ArgumentNBTKey.a(commandcontext, "path"), (i) -> {
                        return new NBTTagInt((int)((double)i * DoubleArgumentType.getDouble(commandcontext, "scale")));
                    }, flag);
                })))).then(CommandDispatcher.a("float").then(CommandDispatcher.a("scale", DoubleArgumentType.doubleArg()).redirect(literalcommandnode, (commandcontext) -> {
                    return a((CommandListenerWrapper)commandcontext.getSource(), commanddata$a.a(commandcontext), ArgumentNBTKey.a(commandcontext, "path"), (i) -> {
                        return new NBTTagFloat((float)((double)i * DoubleArgumentType.getDouble(commandcontext, "scale")));
                    }, flag);
                })))).then(CommandDispatcher.a("short").then(CommandDispatcher.a("scale", DoubleArgumentType.doubleArg()).redirect(literalcommandnode, (commandcontext) -> {
                    return a((CommandListenerWrapper)commandcontext.getSource(), commanddata$a.a(commandcontext), ArgumentNBTKey.a(commandcontext, "path"), (i) -> {
                        return new NBTTagShort((short)((int)((double)i * DoubleArgumentType.getDouble(commandcontext, "scale"))));
                    }, flag);
                })))).then(CommandDispatcher.a("long").then(CommandDispatcher.a("scale", DoubleArgumentType.doubleArg()).redirect(literalcommandnode, (commandcontext) -> {
                    return a((CommandListenerWrapper)commandcontext.getSource(), commanddata$a.a(commandcontext), ArgumentNBTKey.a(commandcontext, "path"), (i) -> {
                        return new NBTTagLong((long)((double)i * DoubleArgumentType.getDouble(commandcontext, "scale")));
                    }, flag);
                })))).then(CommandDispatcher.a("double").then(CommandDispatcher.a("scale", DoubleArgumentType.doubleArg()).redirect(literalcommandnode, (commandcontext) -> {
                    return a((CommandListenerWrapper)commandcontext.getSource(), commanddata$a.a(commandcontext), ArgumentNBTKey.a(commandcontext, "path"), (i) -> {
                        return new NBTTagDouble((double)i * DoubleArgumentType.getDouble(commandcontext, "scale"));
                    }, flag);
                })))).then(CommandDispatcher.a("byte").then(CommandDispatcher.a("scale", DoubleArgumentType.doubleArg()).redirect(literalcommandnode, (commandcontext) -> {
                    return a((CommandListenerWrapper)commandcontext.getSource(), commanddata$a.a(commandcontext), ArgumentNBTKey.a(commandcontext, "path"), (i) -> {
    ...
    private static CommandListenerWrapper a(CommandListenerWrapper commandlistenerwrapper, Collection<String> collection, ScoreboardObjective scoreboardobjective, boolean flag) {
        ...
        return commandlistenerwrapper.a((var4, flag2, i) -> {
    ...
    private static CommandListenerWrapper a(CommandListenerWrapper commandlistenerwrapper, BossBattleCustom bossbattlecustom, boolean flag, boolean flag1) {
        return commandlistenerwrapper.a((var3, flag4, i) -> {
    ...
    private static CommandListenerWrapper a(CommandListenerWrapper commandlistenerwrapper, CommandDataAccessor commanddataaccessor, ArgumentNBTKey.c argumentnbtkey$c, IntFunction<NBTBase> intfunction, boolean flag) {
        return commandlistenerwrapper.a((var4, flag2, i) -> {
            try {
                NBTTagCompound nbttagcompound = commanddataaccessor.a();
                int j = flag ? i : (flag2 ? 1 : 0);
                argumentnbtkey$c.a(nbttagcompound, (NBTBase)intfunction.apply(j));
    ...
    private static ArgumentBuilder<CommandListenerWrapper, ?> a(CommandNode<CommandListenerWrapper> commandnode, LiteralArgumentBuilder<CommandListenerWrapper> literalargumentbuilder, boolean flag) {
        return ((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)literalargumentbuilder.then(CommandDispatcher.a("block").then(CommandDispatcher.a("pos", ArgumentPosition.a()).then(a(commandnode, CommandDispatcher.a("block", ArgumentBlockPredicate.a()), flag, (commandcontext) -> {
        ...
        }))))).then(CommandDispatcher.a("score").then(CommandDispatcher.a("target", ArgumentScoreholder.a()).suggests(ArgumentScoreholder.a).then(((RequiredArgumentBuilder)((RequiredArgumentBuilder)((RequiredArgumentBuilder)((RequiredArgumentBuilder)((RequiredArgumentBuilder)CommandDispatcher.a("targetObjective", ArgumentScoreboardObjective.a()).then(CommandDispatcher.a("=").then(CommandDispatcher.a("source", ArgumentScoreholder.a()).suggests(ArgumentScoreholder.a).then(a(commandnode, CommandDispatcher.a("sourceObjective", ArgumentScoreboardObjective.a()), flag, (commandcontext) -> {
            return a(commandcontext, Integer::equals);
        }))))).then(CommandDispatcher.a("<").then(CommandDispatcher.a("source", ArgumentScoreholder.a()).suggests(ArgumentScoreholder.a).then(a(commandnode, CommandDispatcher.a("sourceObjective", ArgumentScoreboardObjective.a()), flag, (commandcontext) -> {
        ...
        }))))).then(CommandDispatcher.a("matches").then(a(commandnode, CommandDispatcher.a("range", ArgumentCriterionValue.a()), flag, (commandcontext) -> {
            return a(commandcontext, ArgumentCriterionValue.b.a(commandcontext, "range"));
        }))))))).then(CommandDispatcher.a("blocks").then(CommandDispatcher.a("start", ArgumentPosition.a()).then(CommandDispatcher.a("end", ArgumentPosition.a()).then(((RequiredArgumentBuilder)CommandDispatcher.a("destination", ArgumentPosition.a()).then(a(commandnode, CommandDispatcher.a("all"), flag, false))).then(a(commandnode, CommandDispatcher.a("masked"), flag, true))))))).then(CommandDispatcher.a("entity").then(((RequiredArgumentBuilder)CommandDispatcher.a("entities", ArgumentEntity.b()).fork(commandnode, (commandcontext) -> {
    ...
    private static boolean a(CommandContext<CommandListenerWrapper> commandcontext, CriterionConditionValue.d criterionconditionvalue$d) throws CommandSyntaxException {
        String s = ArgumentScoreholder.a(commandcontext, "target");
        ScoreboardObjective scoreboardobjective = ArgumentScoreboardObjective.a(commandcontext, "targetObjective");
        ScoreboardServer scoreboardserver = ((CommandListenerWrapper)commandcontext.getSource()).getServer().getScoreboard();
        return !scoreboardserver.b(s, scoreboardobjective) ? false : criterionconditionvalue$d.d(scoreboardserver.getPlayerScoreForObjective(s, scoreboardobjective).getScore());
    }
    ...
    private static Collection<CommandListenerWrapper> a(CommandContext<CommandListenerWrapper> commandcontext, boolean flag, boolean flag1) {
        return (Collection<CommandListenerWrapper>)(flag1 == flag ? Collections.singleton(commandcontext.getSource()) : Collections.emptyList());
    }

    private static ArgumentBuilder<CommandListenerWrapper, ?> a(CommandNode<CommandListenerWrapper> commandnode, ArgumentBuilder<CommandListenerWrapper, ?> argumentbuilder, boolean flag, CommandExecute.a commandexecute$a) {
        return argumentbuilder.fork(commandnode, (commandcontext) -> {
            return a(commandcontext, flag, commandexecute$a.test(commandcontext));
        }).executes((commandcontext) -> {
            if (flag == commandexecute$a.test(commandcontext)) {
                ((CommandListenerWrapper)commandcontext.getSource()).sendMessage(new ChatMessage("commands.execute.conditional.pass", new Object[0]), false);
                return 1;
            } else {
                throw b.create();
    ...
    private static int b(CommandContext<CommandListenerWrapper> commandcontext, boolean flag) throws CommandSyntaxException {
        ...
        if (!optionalint.isPresent()) {
            ...
            throw c.create(optionalint.getAsInt());
        }
    }
