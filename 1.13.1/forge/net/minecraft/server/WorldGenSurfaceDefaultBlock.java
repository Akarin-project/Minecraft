...
public class WorldGenSurfaceDefaultBlock implements WorldGenSurface<WorldGenSurfaceConfigurationBase> {
    ...
    public void a(Random random, IChunkAccess ichunkaccess, BiomeBase biomebase, int i, int j, int k, double d0, IBlockData iblockdata, IBlockData iblockdata1, int l, long var12, WorldGenSurfaceConfigurationBase worldgensurfaceconfigurationbase) {
    ...
    protected void a(Random random, IChunkAccess ichunkaccess, BiomeBase biomebase, int i, int j, int k, double d0, IBlockData iblockdata, IBlockData iblockdata1, IBlockData iblockdata2, IBlockData iblockdata3, IBlockData iblockdata4, int l) {
        ...
        for(int i2 = k; i2 >= 0; --i2) {
            ...
            IBlockData iblockdata7 = ichunkaccess.getType(blockposition$mutableblockposition);
            if (iblockdata7.isAir()) {
                ...
                if (i1 == -1) {
                    ...
                    if (i2 < l && (iblockdata5 == null || iblockdata5.isAir())) {
                        if (biomebase.c(blockposition$mutableblockposition.c(i, i2, j)) < 0.15F) {
                    ...
                    if (i2 >= l - 1) {
                        ...
                        ichunkaccess.a(blockposition$mutableblockposition, iblockdata6, false);
                    }
                } else if (i1 > 0) {
                    --i1;
                    ichunkaccess.a(blockposition$mutableblockposition, iblockdata6, false);
