...
public class ScoreboardScore {
    public static final Comparator<ScoreboardScore> a = (scoreboardscore, scoreboardscore1) -> {
        if (scoreboardscore.getScore() > scoreboardscore1.getScore()) {
            return 1;
        } else {
            return scoreboardscore.getScore() < scoreboardscore1.getScore() ? -1 : scoreboardscore1.getPlayerName().compareToIgnoreCase(scoreboardscore.getPlayerName());
        }
    };
