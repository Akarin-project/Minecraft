...
public class BiomeWarmOcean extends BiomeBase {
    public BiomeWarmOcean() {
        super((new BiomeBase.a()).a(new WorldGenSurfaceComposite(au, an)).a(BiomeBase.Precipitation.RAIN).a(BiomeBase.Geography.OCEAN).a(-1.0F).b(0.1F).c(0.5F).d(0.5F).a(4445678).b(270131).a((String)null));
        ...
        this.a(WorldGenStage.Decoration.VEGETAL_DECORATION, a(WorldGenerator.aq, new WorldGenFeatureRandom2(new WorldGenerator[]{WorldGenerator.aA, WorldGenerator.aC, WorldGenerator.aB}, new WorldGenFeatureConfiguration[]{WorldGenFeatureConfiguration.e, WorldGenFeatureConfiguration.e, WorldGenFeatureConfiguration.e}), D, new WorldGenDecoratorNoiseConfiguration(20, 400.0D)));
        this.a(WorldGenStage.Decoration.VEGETAL_DECORATION, a(WorldGenerator.ay, new WorldGenFeatureSeaGrassConfiguration(80, 0.3D), B, WorldGenFeatureDecoratorConfiguration.e));
        this.a(WorldGenStage.Decoration.VEGETAL_DECORATION, a(WorldGenerator.aD, new WorldGenFeatureKelpConfiguration(20), r, new WorldGenDecoratorChanceConfiguration(16)));
