...
public abstract class WorldGenerator<C extends WorldGenFeatureConfiguration> {
    ...
    public static final Map<String, StructureGenerator<?>> aF = (Map)SystemUtils.a(Maps.newHashMap(), (hashmap) -> {
        hashmap.put("Village".toLowerCase(Locale.ROOT), e);
        hashmap.put("Mineshaft".toLowerCase(Locale.ROOT), f);
        hashmap.put("Mansion".toLowerCase(Locale.ROOT), g);
        hashmap.put("Jungle_Pyramid".toLowerCase(Locale.ROOT), h);
        hashmap.put("Desert_Pyramid".toLowerCase(Locale.ROOT), i);
        hashmap.put("Igloo".toLowerCase(Locale.ROOT), j);
        hashmap.put("Shipwreck".toLowerCase(Locale.ROOT), k);
        hashmap.put("Swamp_Hut".toLowerCase(Locale.ROOT), l);
        hashmap.put("Stronghold".toLowerCase(Locale.ROOT), m);
        hashmap.put("Monument".toLowerCase(Locale.ROOT), n);
        hashmap.put("Ocean_Ruin".toLowerCase(Locale.ROOT), o);
        hashmap.put("Fortress".toLowerCase(Locale.ROOT), p);
        hashmap.put("EndCity".toLowerCase(Locale.ROOT), q);
        hashmap.put("Buried_Treasure".toLowerCase(Locale.ROOT), r);
    });
    ...
    public abstract boolean generate(GeneratorAccess var1, ChunkGenerator<? extends GeneratorSettings> var2, Random var3, BlockPosition var4, C var5);
    ...
    public static boolean a(GeneratorAccess generatoraccess, String sx, BlockPosition blockposition) {
        return ((StructureGenerator)aF.get(sx.toLowerCase(Locale.ROOT))).c(generatoraccess, blockposition);
    }
}
