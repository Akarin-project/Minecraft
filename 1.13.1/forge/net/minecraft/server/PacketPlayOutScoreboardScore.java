...
public class PacketPlayOutScoreboardScore implements Packet<PacketListenerPlayOut> {
    ...
    public PacketPlayOutScoreboardScore(ScoreboardServer.Action scoreboardserver$action, @Nullable String s, String s1, int i) {
        if (scoreboardserver$action != ScoreboardServer.Action.REMOVE && s == null) {
            throw new IllegalArgumentException("Need an objective name");
        } else {
            this.a = s1;
            this.b = s;
            this.c = i;
            this.d = scoreboardserver$action;
        }
    }
