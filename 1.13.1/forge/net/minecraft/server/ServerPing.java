...
public class ServerPing {
    ...
    public void setPlayerSample(ServerPing.ServerPingPlayerSample serverping$serverpingplayersample) {
        this.b = serverping$serverpingplayersample;
    }
    ...
    public void setServerInfo(ServerPing.ServerData serverping$serverdata) {
        this.c = serverping$serverdata;
    }
    ...
    public static class Serializer implements JsonDeserializer<ServerPing>, JsonSerializer<ServerPing> {
        ...
        public ServerPing a(JsonElement jsonelement, Type var2, JsonDeserializationContext jsondeserializationcontext) throws JsonParseException {
        ...
        public JsonElement a(ServerPing serverping, Type var2, JsonSerializationContext jsonserializationcontext) {
    ...
    public static class ServerData {
        ...
        public static class Serializer implements JsonDeserializer<ServerPing.ServerData>, JsonSerializer<ServerPing.ServerData> {
            ...
            public ServerPing.ServerData a(JsonElement jsonelement, Type var2, JsonDeserializationContext var3) throws JsonParseException {
            ...
            public JsonElement a(ServerPing.ServerData serverping$serverdata, Type var2, JsonSerializationContext var3) {
                JsonObject jsonobject = new JsonObject();
                jsonobject.addProperty("name", serverping$serverdata.a());
                jsonobject.addProperty("protocol", serverping$serverdata.getProtocolVersion());
                return jsonobject;
            }
    ...
    public static class ServerPingPlayerSample {
        ...
        public static class Serializer implements JsonDeserializer<ServerPing.ServerPingPlayerSample>, JsonSerializer<ServerPing.ServerPingPlayerSample> {
            ...
            public ServerPing.ServerPingPlayerSample a(JsonElement jsonelement, Type var2, JsonDeserializationContext var3) throws JsonParseException {
                JsonObject jsonobject = ChatDeserializer.m(jsonelement, "players");
                ServerPing.ServerPingPlayerSample serverping$serverpingplayersample = new ServerPing.ServerPingPlayerSample(ChatDeserializer.n(jsonobject, "max"), ChatDeserializer.n(jsonobject, "online"));
            ...
            public JsonElement a(ServerPing.ServerPingPlayerSample serverping$serverpingplayersample, Type var2, JsonSerializationContext var3) {
                JsonObject jsonobject = new JsonObject();
                jsonobject.addProperty("max", serverping$serverpingplayersample.a());
                jsonobject.addProperty("online", serverping$serverpingplayersample.b());
                if (serverping$serverpingplayersample.c() != null && serverping$serverpingplayersample.c().length > 0) {
                    JsonArray jsonarray = new JsonArray();

                    for(int i = 0; i < serverping$serverpingplayersample.c().length; ++i) {
                        JsonObject jsonobject1 = new JsonObject();
                        UUID uuid = serverping$serverpingplayersample.c()[i].getId();
                        jsonobject1.addProperty("id", uuid == null ? "" : uuid.toString());
                        jsonobject1.addProperty("name", serverping$serverpingplayersample.c()[i].getName());
