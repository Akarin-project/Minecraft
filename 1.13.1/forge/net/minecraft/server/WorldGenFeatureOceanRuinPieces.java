...
public class WorldGenFeatureOceanRuinPieces {
    ...
    public static void a(DefinedStructureManager definedstructuremanager, BlockPosition blockposition, EnumBlockRotation enumblockrotation, List<StructurePiece> list, Random random, WorldGenFeatureOceanRuinConfiguration worldgenfeatureoceanruinconfiguration) {
        ...
        float fx = flag ? 0.9F : 0.8F;
        a(definedstructuremanager, blockposition, enumblockrotation, list, random, worldgenfeatureoceanruinconfiguration, flag, fx);
    ...
    private static void a(DefinedStructureManager definedstructuremanager, BlockPosition blockposition, EnumBlockRotation enumblockrotation, List<StructurePiece> list, Random random, WorldGenFeatureOceanRuinConfiguration worldgenfeatureoceanruinconfiguration, boolean flag, float fx) {
        if (worldgenfeatureoceanruinconfiguration.a == WorldGenFeatureOceanRuin.Temperature.WARM) {
            ...
            list.add(new WorldGenFeatureOceanRuinPieces.a(definedstructuremanager, minecraftkey, blockposition, enumblockrotation, fx, worldgenfeatureoceanruinconfiguration.a, flag));
        } else if (worldgenfeatureoceanruinconfiguration.a == WorldGenFeatureOceanRuin.Temperature.COLD) {
            MinecraftKey[] aminecraftkey2 = flag ? e : b;
            MinecraftKey[] aminecraftkey = flag ? g : c;
            MinecraftKey[] aminecraftkey1 = flag ? f : d;
            int i = random.nextInt(aminecraftkey2.length);
            list.add(new WorldGenFeatureOceanRuinPieces.a(definedstructuremanager, aminecraftkey2[i], blockposition, enumblockrotation, fx, worldgenfeatureoceanruinconfiguration.a, flag));
            list.add(new WorldGenFeatureOceanRuinPieces.a(definedstructuremanager, aminecraftkey[i], blockposition, enumblockrotation, 0.7F, worldgenfeatureoceanruinconfiguration.a, flag));
            list.add(new WorldGenFeatureOceanRuinPieces.a(definedstructuremanager, aminecraftkey1[i], blockposition, enumblockrotation, 0.5F, worldgenfeatureoceanruinconfiguration.a, flag));
        }
    ...
    public static class a extends DefinedStructurePiece {
        ...
        public a(DefinedStructureManager definedstructuremanager, MinecraftKey minecraftkey, BlockPosition blockposition, EnumBlockRotation enumblockrotation, float fx, WorldGenFeatureOceanRuin.Temperature worldgenfeatureoceanruin$temperature, boolean flag) {
            super(0);
            this.f = minecraftkey;
            this.c = blockposition;
            this.g = enumblockrotation;
            this.e = fx;
            this.d = worldgenfeatureoceanruin$temperature;
            this.h = flag;
        ...
        protected void a(String s, BlockPosition blockposition, GeneratorAccess generatoraccess, Random random, StructureBoundingBox var5) {
            if ("chest".equals(s)) {
        ...
        public boolean a(GeneratorAccess generatoraccess, Random random, StructureBoundingBox structureboundingbox, ChunkCoordIntPair chunkcoordintpair) {
            ...
            BlockPosition blockposition = DefinedStructure.a(new BlockPosition(this.a.a().getX() - 1, 0, this.a.a().getZ() - 1), EnumBlockMirror.NONE, this.g, new BlockPosition(0, 0, 0)).a(this.c);
            this.c = new BlockPosition(this.c.getX(), this.a(this.c, generatoraccess, blockposition), this.c.getZ());
        ...
        private int a(BlockPosition blockposition, IBlockAccess iblockaccess, BlockPosition blockposition1) {
            ...
            for(BlockPosition blockposition2 : BlockPosition.a(blockposition, blockposition1)) {
                int i1 = blockposition2.getX();
                int j1 = blockposition2.getZ();
                int k1 = blockposition.getY() - 1;
                BlockPosition.MutableBlockPosition blockposition$mutableblockposition = new BlockPosition.MutableBlockPosition(i1, k1, j1);
                IBlockData iblockdata = iblockaccess.getType(blockposition$mutableblockposition);

                for(Fluid fluid = iblockaccess.b(blockposition$mutableblockposition); (iblockdata.isAir() || fluid.a(TagsFluid.WATER) || iblockdata.getBlock().a(TagsBlock.ICE)) && k1 > 1; fluid = iblockaccess.b(blockposition$mutableblockposition)) {
                    --k1;
                    blockposition$mutableblockposition.c(i1, k1, j1);
