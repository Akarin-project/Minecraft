...
public class CommandDatapack {
    ...
    public static void a(com.mojang.brigadier.CommandDispatcher<CommandListenerWrapper> commanddispatcher) {
        commanddispatcher.register((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)CommandDispatcher.a("datapack").requires((commandlistenerwrapper) -> {
            return commandlistenerwrapper.hasPermission(2);
        })).then(CommandDispatcher.a("enable").then(((RequiredArgumentBuilder)((RequiredArgumentBuilder)((RequiredArgumentBuilder)((RequiredArgumentBuilder)CommandDispatcher.a("name", StringArgumentType.string()).suggests(e).executes((commandcontext) -> {
        ...
        })).then(CommandDispatcher.a("after").then(CommandDispatcher.a("existing", StringArgumentType.string()).suggests(d).executes((commandcontext) -> {
            return a((CommandListenerWrapper)commandcontext.getSource(), a(commandcontext, "name", true), (list, resourcepackloader) -> {
                list.add(list.indexOf(a(commandcontext, "existing", false)) + 1, resourcepackloader);
            });
        })))).then(CommandDispatcher.a("before").then(CommandDispatcher.a("existing", StringArgumentType.string()).suggests(d).executes((commandcontext) -> {
            return a((CommandListenerWrapper)commandcontext.getSource(), a(commandcontext, "name", true), (list, resourcepackloader) -> {
        ...
        }))))).then(CommandDispatcher.a("disable").then(CommandDispatcher.a("name", StringArgumentType.string()).suggests(d).executes((commandcontext) -> {
    ...
    private static int a(CommandListenerWrapper commandlistenerwrapper, ResourcePackLoader resourcepackloader, CommandDatapack.a commanddatapack$a) throws CommandSyntaxException {
        ...
        commanddatapack$a.apply(arraylist, resourcepackloader);
        resourcepackrepository.a(arraylist);
