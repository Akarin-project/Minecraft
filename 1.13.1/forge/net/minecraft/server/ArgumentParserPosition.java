...
public class ArgumentParserPosition {
    ...
    public boolean equals(Object object) {
        if (this == object) {
            ...
            ArgumentParserPosition argumentparserposition1 = (ArgumentParserPosition)object;
            if (this.c != argumentparserposition1.c) {
                return false;
            } else {
                return Double.compare(argumentparserposition1.d, this.d) == 0;
            }
        }
    }
