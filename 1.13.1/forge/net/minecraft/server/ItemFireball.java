...
public class ItemFireball extends Item {
    public ItemFireball(Item.Info item$info) {
        super(item$info);
    }
    ...
    public EnumInteractionResult a(ItemActionContext itemactioncontext) {
        ...
        if (world.isClientSide) {
            ...
            if (world.getType(blockposition).isAir()) {
                world.a((EntityHuman)null, blockposition, SoundEffects.ITEM_FIRECHARGE_USE, SoundCategory.BLOCKS, 1.0F, (i.nextFloat() - i.nextFloat()) * 0.2F + 1.0F);
