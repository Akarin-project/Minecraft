...
public class MobEffectList {
    ...
    public static int getId(MobEffectList mobeffectlist) {
        return IRegistry.MOB_EFFECT.a(mobeffectlist);
    }
    ...
    public void applyInstantEffect(@Nullable Entity entity, @Nullable Entity entity1, EntityLiving entityliving, int i, double d0) {
        if ((this != MobEffects.HEAL || entityliving.cp()) && (this != MobEffects.HARM || !entityliving.cp())) {
            if (this == MobEffects.HARM && !entityliving.cp() || this == MobEffects.HEAL && entityliving.cp()) {
                ...
                if (entity == null) {
                    entityliving.damageEntity(DamageSource.MAGIC, (float)k);
                } else {
                    entityliving.damageEntity(DamageSource.c(entity, entity1), (float)k);
                }
            } else {
    ...
    public void a(EntityLiving var1, AttributeMapBase attributemapbase, int var3) {
    ...
    public void b(EntityLiving var1, AttributeMapBase attributemapbase, int i) {
        for(Entry entry : this.a.entrySet()) {
            AttributeInstance attributeinstance = attributemapbase.a((IAttribute)entry.getKey());
            if (attributeinstance != null) {
    ...
    public static void m() {
        a(1, "speed", (new MobEffectList(false, 8171462)).b(0, 0).a(GenericAttributes.MOVEMENT_SPEED, "91AEAA56-376B-4498-935B-2F7F68070635", (double)0.2F, 2).l());
        a(2, "slowness", (new MobEffectList(true, 5926017)).b(1, 0).a(GenericAttributes.MOVEMENT_SPEED, "7107DE5E-7CE8-4030-940E-514C1F160890", (double)-0.15F, 2));
        a(3, "haste", (new MobEffectList(false, 14270531)).b(2, 0).a(1.5D).l().a(GenericAttributes.g, "AF8B6E3F-3328-4C0A-AA36-5BA2BB9DBEF3", (double)0.1F, 2));
        a(4, "mining_fatigue", (new MobEffectList(true, 4866583)).b(3, 0).a(GenericAttributes.g, "55FCED67-E92A-486E-9800-B47F202C4386", (double)-0.1F, 2));
