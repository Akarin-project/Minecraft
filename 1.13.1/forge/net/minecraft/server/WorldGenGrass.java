...
public class WorldGenGrass extends WorldGenerator<WorldGenFeatureTallGrassConfiguration> {
    ...
    public boolean a(GeneratorAccess generatoraccess, ChunkGenerator<? extends GeneratorSettings> var2, Random random, BlockPosition blockposition, WorldGenFeatureTallGrassConfiguration worldgenfeaturetallgrassconfiguration) {
