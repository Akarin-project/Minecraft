...
public class WorldGenDesertPyramidPiece extends WorldGenScatteredPiece {
    ...
    public boolean a(GeneratorAccess generatoraccess, Random random, StructureBoundingBox structureboundingbox, ChunkCoordIntPair var4) {
        ...
        for(int j1 = 0; j1 < this.a; ++j1) {
            for(int j = 0; j < this.c; ++j) {
                boolean flag = true;
                this.b(generatoraccess, Blocks.SANDSTONE.getBlockData(), j1, -5, j, structureboundingbox);
            }
        }

        IBlockData iblockdata1 = (IBlockData)Blocks.SANDSTONE_STAIRS.getBlockData().set(BlockStairs.FACING, EnumDirection.NORTH);
        IBlockData iblockdata2 = (IBlockData)Blocks.SANDSTONE_STAIRS.getBlockData().set(BlockStairs.FACING, EnumDirection.SOUTH);
        IBlockData iblockdata3 = (IBlockData)Blocks.SANDSTONE_STAIRS.getBlockData().set(BlockStairs.FACING, EnumDirection.EAST);
        IBlockData iblockdata = (IBlockData)Blocks.SANDSTONE_STAIRS.getBlockData().set(BlockStairs.FACING, EnumDirection.WEST);
        ...
        this.a(generatoraccess, iblockdata1, 2, 10, 0, structureboundingbox);
        this.a(generatoraccess, iblockdata2, 2, 10, 4, structureboundingbox);
        this.a(generatoraccess, iblockdata3, 0, 10, 2, structureboundingbox);
        this.a(generatoraccess, iblockdata, 4, 10, 2, structureboundingbox);
        ...
        this.a(generatoraccess, iblockdata1, this.a - 3, 10, 0, structureboundingbox);
        this.a(generatoraccess, iblockdata2, this.a - 3, 10, 4, structureboundingbox);
        this.a(generatoraccess, iblockdata3, this.a - 5, 10, 2, structureboundingbox);
        this.a(generatoraccess, iblockdata, this.a - 1, 10, 2, structureboundingbox);
        ...
        this.a(generatoraccess, iblockdata1, 2, 4, 5, structureboundingbox);
        this.a(generatoraccess, iblockdata1, 2, 3, 4, structureboundingbox);
        this.a(generatoraccess, iblockdata1, this.a - 3, 4, 5, structureboundingbox);
        this.a(generatoraccess, iblockdata1, this.a - 3, 3, 4, structureboundingbox);
        ...
        this.a(generatoraccess, iblockdata, 2, 1, 2, structureboundingbox);
        this.a(generatoraccess, iblockdata3, this.a - 3, 1, 2, structureboundingbox);
        ...
        for(int k1 = 0; k1 <= this.a - 1; k1 += this.a - 1) {
            this.a(generatoraccess, Blocks.CUT_SANDSTONE.getBlockData(), k1, 2, 1, structureboundingbox);
            this.a(generatoraccess, Blocks.ORANGE_TERRACOTTA.getBlockData(), k1, 2, 2, structureboundingbox);
            this.a(generatoraccess, Blocks.CUT_SANDSTONE.getBlockData(), k1, 2, 3, structureboundingbox);
            this.a(generatoraccess, Blocks.CUT_SANDSTONE.getBlockData(), k1, 3, 1, structureboundingbox);
            this.a(generatoraccess, Blocks.ORANGE_TERRACOTTA.getBlockData(), k1, 3, 2, structureboundingbox);
            this.a(generatoraccess, Blocks.CUT_SANDSTONE.getBlockData(), k1, 3, 3, structureboundingbox);
            this.a(generatoraccess, Blocks.ORANGE_TERRACOTTA.getBlockData(), k1, 4, 1, structureboundingbox);
            this.a(generatoraccess, Blocks.CHISELED_SANDSTONE.getBlockData(), k1, 4, 2, structureboundingbox);
            this.a(generatoraccess, Blocks.ORANGE_TERRACOTTA.getBlockData(), k1, 4, 3, structureboundingbox);
            this.a(generatoraccess, Blocks.CUT_SANDSTONE.getBlockData(), k1, 5, 1, structureboundingbox);
            this.a(generatoraccess, Blocks.ORANGE_TERRACOTTA.getBlockData(), k1, 5, 2, structureboundingbox);
            this.a(generatoraccess, Blocks.CUT_SANDSTONE.getBlockData(), k1, 5, 3, structureboundingbox);
            this.a(generatoraccess, Blocks.ORANGE_TERRACOTTA.getBlockData(), k1, 6, 1, structureboundingbox);
            this.a(generatoraccess, Blocks.CHISELED_SANDSTONE.getBlockData(), k1, 6, 2, structureboundingbox);
            this.a(generatoraccess, Blocks.ORANGE_TERRACOTTA.getBlockData(), k1, 6, 3, structureboundingbox);
            this.a(generatoraccess, Blocks.ORANGE_TERRACOTTA.getBlockData(), k1, 7, 1, structureboundingbox);
            this.a(generatoraccess, Blocks.ORANGE_TERRACOTTA.getBlockData(), k1, 7, 2, structureboundingbox);
            this.a(generatoraccess, Blocks.ORANGE_TERRACOTTA.getBlockData(), k1, 7, 3, structureboundingbox);
            this.a(generatoraccess, Blocks.CUT_SANDSTONE.getBlockData(), k1, 8, 1, structureboundingbox);
            this.a(generatoraccess, Blocks.CUT_SANDSTONE.getBlockData(), k1, 8, 2, structureboundingbox);
            this.a(generatoraccess, Blocks.CUT_SANDSTONE.getBlockData(), k1, 8, 3, structureboundingbox);
        }

        for(int l1 = 2; l1 <= this.a - 3; l1 += this.a - 3 - 2) {
            this.a(generatoraccess, Blocks.CUT_SANDSTONE.getBlockData(), l1 - 1, 2, 0, structureboundingbox);
            this.a(generatoraccess, Blocks.ORANGE_TERRACOTTA.getBlockData(), l1, 2, 0, structureboundingbox);
            this.a(generatoraccess, Blocks.CUT_SANDSTONE.getBlockData(), l1 + 1, 2, 0, structureboundingbox);
            this.a(generatoraccess, Blocks.CUT_SANDSTONE.getBlockData(), l1 - 1, 3, 0, structureboundingbox);
            this.a(generatoraccess, Blocks.ORANGE_TERRACOTTA.getBlockData(), l1, 3, 0, structureboundingbox);
            this.a(generatoraccess, Blocks.CUT_SANDSTONE.getBlockData(), l1 + 1, 3, 0, structureboundingbox);
            this.a(generatoraccess, Blocks.ORANGE_TERRACOTTA.getBlockData(), l1 - 1, 4, 0, structureboundingbox);
            this.a(generatoraccess, Blocks.CHISELED_SANDSTONE.getBlockData(), l1, 4, 0, structureboundingbox);
            this.a(generatoraccess, Blocks.ORANGE_TERRACOTTA.getBlockData(), l1 + 1, 4, 0, structureboundingbox);
            this.a(generatoraccess, Blocks.CUT_SANDSTONE.getBlockData(), l1 - 1, 5, 0, structureboundingbox);
            this.a(generatoraccess, Blocks.ORANGE_TERRACOTTA.getBlockData(), l1, 5, 0, structureboundingbox);
            this.a(generatoraccess, Blocks.CUT_SANDSTONE.getBlockData(), l1 + 1, 5, 0, structureboundingbox);
            this.a(generatoraccess, Blocks.ORANGE_TERRACOTTA.getBlockData(), l1 - 1, 6, 0, structureboundingbox);
            this.a(generatoraccess, Blocks.CHISELED_SANDSTONE.getBlockData(), l1, 6, 0, structureboundingbox);
            this.a(generatoraccess, Blocks.ORANGE_TERRACOTTA.getBlockData(), l1 + 1, 6, 0, structureboundingbox);
            this.a(generatoraccess, Blocks.ORANGE_TERRACOTTA.getBlockData(), l1 - 1, 7, 0, structureboundingbox);
            this.a(generatoraccess, Blocks.ORANGE_TERRACOTTA.getBlockData(), l1, 7, 0, structureboundingbox);
            this.a(generatoraccess, Blocks.ORANGE_TERRACOTTA.getBlockData(), l1 + 1, 7, 0, structureboundingbox);
            this.a(generatoraccess, Blocks.CUT_SANDSTONE.getBlockData(), l1 - 1, 8, 0, structureboundingbox);
            this.a(generatoraccess, Blocks.CUT_SANDSTONE.getBlockData(), l1, 8, 0, structureboundingbox);
            this.a(generatoraccess, Blocks.CUT_SANDSTONE.getBlockData(), l1 + 1, 8, 0, structureboundingbox);
        }
