...
public final class ProjectileHelper {
            ...
            if (flag) {
                ...
                for(int i = 0; i < list.size(); ++i) {
                    ...
                    if (entity3.isInteractable() && (flag1 || !entity3.s(entity1)) && !entity3.noclip) {
                        AxisAlignedBB axisalignedbb = entity3.getBoundingBox().g((double)0.3F);
    ...
    public static final void a(Entity entity, float f) {
        ...
        entity.yaw = (float)(MathHelper.c(d2, d0) * (double)(180F / (float)Math.PI)) + 90.0F;

        for(entity.pitch = (float)(MathHelper.c((double)f1, d1) * (double)(180F / (float)Math.PI)) - 90.0F; entity.pitch - entity.lastPitch < -180.0F; entity.lastPitch -= 360.0F) {
            ;
        }
