...
public abstract class LootSelectorEntry {
    ...
    public static class a implements JsonDeserializer<LootSelectorEntry>, JsonSerializer<LootSelectorEntry> {
        ...
        public LootSelectorEntry a(JsonElement jsonelement, Type var2, JsonDeserializationContext jsondeserializationcontext) throws JsonParseException {
        ...
        public JsonElement a(LootSelectorEntry lootselectorentry, Type var2, JsonSerializationContext jsonserializationcontext) {
