...
public class BiomeLukewarmDeepOcean extends BiomeBase {
    public BiomeLukewarmDeepOcean() {
        super((new BiomeBase.a()).a(new WorldGenSurfaceComposite(au, ao)).a(BiomeBase.Precipitation.RAIN).a(BiomeBase.Geography.OCEAN).a(-1.8F).b(0.1F).c(0.5F).d(0.5F).a(4566514).b(267827).a((String)null));
        this.a(WorldGenerator.o, new WorldGenFeatureOceanRuinConfiguration(WorldGenFeatureOceanRuin.Temperature.WARM, 0.3F, 0.9F));
        ...
        this.a(WorldGenStage.Decoration.VEGETAL_DECORATION, a(WorldGenerator.ay, new WorldGenFeatureSeaGrassConfiguration(80, 0.8D), B, WorldGenFeatureDecoratorConfiguration.e));
        ...
        this.a(WorldGenStage.Decoration.VEGETAL_DECORATION, a(WorldGenerator.az, WorldGenFeatureConfiguration.e, D, new WorldGenDecoratorNoiseConfiguration(80, 80.0D)));
