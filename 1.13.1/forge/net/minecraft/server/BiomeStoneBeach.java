...
public final class BiomeStoneBeach extends BiomeBase {
    public BiomeStoneBeach() {
        super((new BiomeBase.a()).a(new WorldGenSurfaceComposite(au, aj)).a(BiomeBase.Precipitation.RAIN).a(BiomeBase.Geography.NONE).a(0.1F).b(0.8F).c(0.2F).d(0.3F).a(4159204).b(329011).a((String)null));
