        ...
        if (this.d >= 0) {
            ...
            for(int l = this.n.c; l <= this.n.f; ++l) {
                for(int i1 = this.n.a; i1 <= this.n.d; ++i1) {
                    blockposition$mutableblockposition.c(i1, 64, l);
                    if (structureboundingbox.b(blockposition$mutableblockposition)) {
                        j += generatoraccess.getHighestBlockYAt(HeightMap.Type.MOTION_BLOCKING_NO_LEAVES, blockposition$mutableblockposition).getY();
                        ++k;
                    }
                }
            }
