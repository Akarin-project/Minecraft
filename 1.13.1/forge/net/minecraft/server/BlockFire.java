...
public class BlockFire extends Block {
    ...
    protected BlockFire(Block.Info block$info) {
        super(block$info);
        this.v((IBlockData)((IBlockData)((IBlockData)((IBlockData)((IBlockData)((IBlockData)(this.blockStateList.getBlockData()).set(AGE, Integer.valueOf(0))).set(NORTH, Boolean.valueOf(false))).set(EAST, Boolean.valueOf(false))).set(SOUTH, Boolean.valueOf(false))).set(WEST, Boolean.valueOf(false))).set(UPPER, Boolean.valueOf(false)));
    }
    ...
    public IBlockData updateState(IBlockData iblockdata, EnumDirection var2, IBlockData var3, GeneratorAccess generatoraccess, BlockPosition blockposition, BlockPosition var6) {
        return this.canPlace(iblockdata, generatoraccess, blockposition) ? (IBlockData)this.a((IBlockAccess)generatoraccess, blockposition).set(AGE, iblockdata.get(AGE)) : Blocks.AIR.getBlockData();
    }
    ...
    public IBlockData a(IBlockAccess iblockaccess, BlockPosition blockposition) {
        ...
        if (!iblockdata.q() && !this.k(iblockdata)) {
            ...
            for(EnumDirection enumdirection : EnumDirection.values()) {
                BlockStateBoolean blockstateboolean = (BlockStateBoolean)r.get(enumdirection);
    ...
    public void a(IBlockData iblockdata, World world, BlockPosition blockposition, Random random) {
        if (world.getGameRules().getBoolean("doFireTick")) {
            ...
            if (!flag && world.isRaining() && this.a(world, blockposition) && random.nextFloat() < 0.2F + (float)i * 0.03F) {
                ...
                if (i != j) {
                    iblockdata = (IBlockData)iblockdata.set(AGE, Integer.valueOf(j));
                    world.setTypeAndData(blockposition, iblockdata, 4);
                }

                if (!flag) {
                    world.J().a(blockposition, this, this.a(world) + random.nextInt(10));
                    ...
                    for(int i1 = -1; i1 <= 1; ++i1) {
                        for(int j1 = -1; j1 <= 4; ++j1) {
                            if (l != 0 || j1 != 0 || i1 != 0) {
                                ...
                                blockposition$mutableblockposition.g(blockposition).d(l, j1, i1);
                                int l1 = this.a((IWorldReader)world, blockposition$mutableblockposition);
                                if (l1 > 0) {
                                    ...
                                    if (i2 > 0 && random.nextInt(k1) <= i2 && (!world.isRaining() || !this.a(world, blockposition$mutableblockposition))) {
                                        int j2 = Math.min(15, i + random.nextInt(5) / 4);
                                        world.setTypeAndData(blockposition$mutableblockposition, (IBlockData)this.a((IBlockAccess)world, blockposition$mutableblockposition).set(AGE, Integer.valueOf(j2)), 3);
                                    }
                                }
                            }
                        }
    ...
    private void a(World world, BlockPosition blockposition, int i, Random random, int j) {
        ...
        if (random.nextInt(i) < k) {
            ...
            if (random.nextInt(j + 10) < 5 && !world.isRainingAt(blockposition)) {
                ...
                world.setTypeAndData(blockposition, (IBlockData)this.a((IBlockAccess)world, blockposition).set(AGE, Integer.valueOf(l)), 3);
            } else {
                world.setAir(blockposition);
            }
        ...
        if (iblockdata1.getBlock() != iblockdata.getBlock()) {
            if (world.worldProvider.getDimensionManager() != DimensionManager.OVERWORLD && world.worldProvider.getDimensionManager() != DimensionManager.NETHER || !((BlockPortal)Blocks.NETHER_PORTAL).a(world, blockposition)) {
                if (!iblockdata.canPlace(world, blockposition)) {
                    ...
                    world.J().a(blockposition, this, this.a(world) + world.random.nextInt(10));
                }
            }
        }
    }
    ...
    protected void a(BlockStateList.a<Block, IBlockData> blockstatelist$a) {
        blockstatelist$a.a(AGE, NORTH, EAST, SOUTH, WEST, UPPER);
    }
