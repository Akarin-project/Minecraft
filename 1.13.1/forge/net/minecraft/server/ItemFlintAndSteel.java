...
public class ItemFlintAndSteel extends Item {
    public ItemFlintAndSteel(Item.Info item$info) {
        super(item$info);
    }
    ...
    public EnumInteractionResult a(ItemActionContext itemactioncontext) {
        ...
        if (a(world, blockposition)) {
            world.a(entityhuman, blockposition, SoundEffects.ITEM_FLINTANDSTEEL_USE, SoundCategory.BLOCKS, 1.0F, i.nextFloat() * 0.4F + 0.8F);
