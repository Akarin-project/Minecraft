...
public class ChunkProviderServer implements IChunkProvider {
    ...
    public ChunkProviderServer(WorldServer worldserver, IChunkLoader ichunkloader, ChunkGenerator<?> chunkgenerator, IAsyncTaskHandler iasynctaskhandler) {
        ...
        this.batchScheduler = new SchedulerBatch<ChunkCoordIntPair, ChunkStatus, ProtoChunk>(this.chunkScheduler);
    }
    ...
    public Chunk getChunkAt(int i, int j, boolean flag, boolean flag1) {
        ...
        synchronized(this.chunkLoader) {
            ...
            if (flag) {
                try {
                    ...
                    a.error("Couldn't load chunk", exception);
                }
            }
        }
        ...
        if (chunk != null) {
            ...
            try {
                ...
                throw this.a(i, j, runtimeexception);
            }
        } else {
            return null;
        }
    ...
    public void saveChunk(IChunkAccess ichunkaccess) {
        try {
            ...
            a.error("Couldn't save chunk", ioexception);
        } catch (ExceptionWorldConflict exceptionworldconflict) {
            a.error("Couldn't save chunk; already in use by another instance of Minecraft?", exceptionworldconflict);
        }
    ...
    public void close() {
        try {
            ...
            a.error("Couldn't stop taskManager", interruptedexception);
        }
    ...
    public int a(World worldx, boolean flag, boolean flag1) {
        return this.chunkGenerator.a(worldx, flag, flag1);
    }

    @Nullable
    public BlockPosition a(World worldx, String s, BlockPosition blockposition, int i, boolean flag) {
        return this.chunkGenerator.findNearestMapFeature(worldx, s, blockposition, i, flag);
    }
