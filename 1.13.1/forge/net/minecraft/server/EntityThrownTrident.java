...
public class EntityThrownTrident extends EntityArrow {
    ...
    private ItemStack aw = new ItemStack(Items.TRIDENT);
    private boolean ax;
    public int g;
    ...
    public EntityThrownTrident(World world, EntityLiving entityliving, ItemStack itemstack) {
        ...
        this.datawatcher.set(h, (byte)EnchantmentManager.f(itemstack));
    }
    ...
    protected void b(MovingObjectPosition movingobjectposition) {
        ...
        this.motX *= (double)-0.01F;
        this.motY *= (double)-0.1F;
        this.motZ *= (double)-0.01F;
        float f1 = 1.0F;
    ...
    public void a(NBTTagCompound nbttagcompound) {
        ...
        this.datawatcher.set(h, (byte)EnchantmentManager.f(this.aw));
    }
