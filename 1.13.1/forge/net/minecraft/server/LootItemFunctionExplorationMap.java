...
public class LootItemFunctionExplorationMap extends LootItemFunction {
    ...
    public LootItemFunctionExplorationMap(LootItemCondition[] alootitemcondition, String s, MapIcon.Type mapicon$type, byte b0, int i, boolean flag) {
        ...
        if (itemstack.getItem() != Items.MAP) {
            ...
            if (blockposition == null) {
                ...
                if (blockposition1 != null) {
                    ...
                    ItemWorldMap.a(worldserver, itemstack1);
                    WorldMap.a(itemstack1, blockposition1, "+", this.c);
                    itemstack1.a(new ChatMessage("filled_map." + this.b.toLowerCase(Locale.ROOT), new Object[0]));
                    return itemstack1;
                } else {
                    return itemstack;
                }
    ...
    public static class a extends LootItemFunction.a<LootItemFunctionExplorationMap> {
        ...
        public LootItemFunctionExplorationMap a(JsonObject jsonobject, JsonDeserializationContext var2, LootItemCondition[] alootitemcondition) {
            ...
            MapIcon.Type mapicon$type = MapIcon.Type.MANSION;

            try {
                mapicon$type = MapIcon.Type.valueOf(s1.toUpperCase(Locale.ROOT));
            ...
            return new LootItemFunctionExplorationMap(alootitemcondition, s, mapicon$type, b0, i, flag);
        }
