...
public class EntityTypes<T extends Entity> {
    ...
    public static <T extends Entity> EntityTypes<T> a(String s, EntityTypes.a<T> entitytypes$a) {
        EntityTypes entitytypes = entitytypes$a.a(s);
        IRegistry.ENTITY_TYPE.a(new MinecraftKey(s), entitytypes);
        return entitytypes;
    }
    ...
    public static EntityTypes<?> a(String s) {
        return IRegistry.ENTITY_TYPE.get(MinecraftKey.a(s));
    }
    ...
    public T a(World world) {
        return (T)(this.aT.apply(world));
    }

    @Nullable
    public static Entity a(World world, MinecraftKey minecraftkey) {
        return a(world, IRegistry.ENTITY_TYPE.get(minecraftkey));
    }
    ...
    public static Entity a(NBTTagCompound nbttagcompound, World world) {
        ...
        if (entity == null) {
            aR.warn("Skipping Entity with id {}", minecraftkey);
        } else {
    ...
    public static class a<T extends Entity> {
        ...
        public static <T extends Entity> EntityTypes.a<T> a(Class<? extends T> oclass, Function<? super World, ? extends T> function) {
            return new EntityTypes.a<T>(oclass, function);
        }

        public static <T extends Entity> EntityTypes.a<T> a(Class<? extends T> oclass) {
            return new EntityTypes.a<T>(oclass, (var0) -> {
                return null;
            });
        }
        ...
        public EntityTypes<T> a(String s) {
            ...
            return new EntityTypes<T>(this.a, this.b, this.c, this.d, type);
        }
    }
}
