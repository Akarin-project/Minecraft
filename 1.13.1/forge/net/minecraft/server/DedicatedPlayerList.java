...
public class DedicatedPlayerList extends PlayerList {
    ...
    private void y() {
        try {
            ...
            f.warn("Failed to save ip banlist: ", ioexception);
        }
    ...
    private void z() {
        try {
            ...
            f.warn("Failed to save user banlist: ", ioexception);
        }
    ...
    private void A() {
        try {
            ...
            f.warn("Failed to load ip banlist: ", ioexception);
        }
    ...
    private void B() {
        try {
            ...
            f.warn("Failed to load user banlist: ", ioexception);
        }
    ...
    private void C() {
        try {
            ...
            f.warn("Failed to load operators list: ", exception);
        }
    ...
    private void D() {
        try {
            ...
            f.warn("Failed to save operators list: ", exception);
        }
    ...
    private void E() {
        try {
            ...
            f.warn("Failed to load white-list: ", exception);
        }
    ...
    private void F() {
        try {
            ...
            f.warn("Failed to save white-list: ", exception);
        }
