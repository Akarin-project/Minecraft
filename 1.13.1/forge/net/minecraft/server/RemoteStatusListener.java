...
public class RemoteStatusListener extends RemoteConnectionThread {
    ...
    private boolean a(DatagramPacket datagrampacket) throws IOException {
        ...
        int ix = datagrampacket.getLength();
        SocketAddress socketaddress = datagrampacket.getSocketAddress();
        this.a("Packet len " + ix + " [" + socketaddress + "]");
    ...
    private void d(DatagramPacket datagrampacket) throws IOException {
        RemoteStatusListener.RemoteStatusChallenge remotestatuslistener$remotestatuschallenge = new RemoteStatusListener.RemoteStatusChallenge(datagrampacket);
        this.t.put(datagrampacket.getSocketAddress(), remotestatuslistener$remotestatuschallenge);
        this.a(remotestatuslistener$remotestatuschallenge.b(), datagrampacket);
    }
        ...
        if (this.a) {
            ...
            if (ix >= this.h + 30000L) {
                ...
                while(iterator.hasNext()) {
                    ...
                    if (((RemoteStatusListener.RemoteStatusChallenge)entry.getValue()).a(ix)) {
                        iterator.remove();
                    }
                }
