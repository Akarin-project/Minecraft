...
public class Scoreboard {
    ...
    public ScoreboardObjective registerObjective(String s, IScoreboardCriteria iscoreboardcriteria, IChatBaseComponent ichatbasecomponent, IScoreboardCriteria.EnumScoreboardHealthDisplay iscoreboardcriteria$enumscoreboardhealthdisplay) {
        if (s.length() > 16) {
            ...
            ScoreboardObjective scoreboardobjective = new ScoreboardObjective(this, s, iscoreboardcriteria, ichatbasecomponent, iscoreboardcriteria$enumscoreboardhealthdisplay);
            ((List)this.objectivesByCriteria.computeIfAbsent(iscoreboardcriteria, (var0) -> {
    ...
    public ScoreboardScore getPlayerScoreForObjective(String s, ScoreboardObjective scoreboardobjective) {
        if (s.length() > 40) {
            ...
            Map map = (Map)this.playerScores.computeIfAbsent(s, (var0) -> {
    ...
    public void resetPlayerScores(String s, @Nullable ScoreboardObjective scoreboardobjective) {
        if (scoreboardobjective == null) {
            ...
            Map map2 = (Map)this.playerScores.get(s);
            if (map2 != null) {
                ScoreboardScore scoreboardscore = (ScoreboardScore)map2.remove(scoreboardobjective);
                if (map2.size() < 1) {
