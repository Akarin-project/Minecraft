...
public class GameProfileBanEntry extends ExpirableListEntry<GameProfile> {
    ...
    public GameProfileBanEntry(GameProfile gameprofile, @Nullable Date var2, @Nullable String s, @Nullable Date date, @Nullable String s1) {
        super(gameprofile, date, s, date, s1);
    }
