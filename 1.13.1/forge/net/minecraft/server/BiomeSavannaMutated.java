...
public final class BiomeSavannaMutated extends BiomeBase {
    public BiomeSavannaMutated() {
        super((new BiomeBase.a()).a(new WorldGenSurfaceComposite(aw, ai)).a(BiomeBase.Precipitation.NONE).a(BiomeBase.Geography.SAVANNA).a(0.3625F).b(1.225F).c(1.1F).d(0.0F).a(4159204).b(329011).a("savanna"));
