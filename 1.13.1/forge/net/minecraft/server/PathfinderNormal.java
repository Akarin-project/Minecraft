...
public class PathfinderNormal extends PathfinderAbstract {
    ...
    public PathPoint b() {
        ...
        if (this.b.a(pathtype1) < 0.0F) {
            ...
            for(BlockPosition blockposition1 : hashset) {
                PathType pathtype = this.a(this.b, blockposition1);
        ...
        return this.a(blockposition2.getX(), i, blockposition2.getZ());
    }
    ...
    public int a(PathPoint[] apathpoint, PathPoint pathpoint, PathPoint pathpoint1, float f) {
        ...
        if (this.b.a(pathtype) >= 0.0F) {
            jx = MathHelper.d(Math.max(1.0F, this.b.Q));
        }

        double d0 = a(this.a, new BlockPosition(pathpoint.a, pathpoint.b, pathpoint.c));
        PathPoint pathpoint2 = this.a(pathpoint.a, pathpoint.b, pathpoint.c + 1, jx, d0, EnumDirection.SOUTH);
        PathPoint pathpoint3 = this.a(pathpoint.a - 1, pathpoint.b, pathpoint.c, jx, d0, EnumDirection.WEST);
        PathPoint pathpoint4 = this.a(pathpoint.a + 1, pathpoint.b, pathpoint.c, jx, d0, EnumDirection.EAST);
        PathPoint pathpoint5 = this.a(pathpoint.a, pathpoint.b, pathpoint.c - 1, jx, d0, EnumDirection.NORTH);
        ...
        if (flag && flag3) {
            PathPoint pathpoint6 = this.a(pathpoint.a - 1, pathpoint.b, pathpoint.c - 1, jx, d0, EnumDirection.NORTH);
        ...
        if (flag && flag2) {
            PathPoint pathpoint7 = this.a(pathpoint.a + 1, pathpoint.b, pathpoint.c - 1, jx, d0, EnumDirection.NORTH);
        ...
        if (flag1 && flag3) {
            PathPoint pathpoint8 = this.a(pathpoint.a - 1, pathpoint.b, pathpoint.c + 1, jx, d0, EnumDirection.SOUTH);
        ...
        if (flag1 && flag2) {
            PathPoint pathpoint9 = this.a(pathpoint.a + 1, pathpoint.b, pathpoint.c + 1, jx, d0, EnumDirection.SOUTH);
    ...
    @Nullable
    private PathPoint a(int i, int jx, int k, int l, double d0, EnumDirection enumdirection) {
        ...
        if (d1 - d0 > 1.125D) {
            ...
            PathType pathtype = this.a(this.b, i, jx, k);
            float f = this.b.a(pathtype);
            double d2 = (double)this.b.width / 2.0D;
            if (f >= 0.0F) {
                pathpoint = this.a(i, jx, k);
            ...
            if (pathtype == PathType.WALKABLE) {
                ...
                if (pathpoint == null && l > 0 && pathtype != PathType.FENCE && pathtype != PathType.TRAPDOOR) {
                    pathpoint = this.a(i, jx + 1, k, l - 1, d0, enumdirection);
                    if (pathpoint != null && (pathpoint.m == PathType.OPEN || pathpoint.m == PathType.WALKABLE) && this.b.width < 1.0F) {
                        ...
                        AxisAlignedBB axisalignedbb = new AxisAlignedBB(d3 - d2, (double)jx + 0.001D, d4 - d2, d3 + d2, (double)this.b.length + a(this.a, blockposition.up()) - 0.002D, d4 + d2);
                ...
                if (pathtype == PathType.WATER && !this.e()) {
                    if (this.a(this.b, i, jx - 1, k) != PathType.WATER) {
                        return pathpoint;
                    }

                    while(jx > 0) {
                        --jx;
                        pathtype = this.a(this.b, i, jx, k);
                ...
                if (pathtype == PathType.OPEN) {
                    AxisAlignedBB axisalignedbb1 = new AxisAlignedBB((double)i - d2 + 0.5D, (double)jx + 0.001D, (double)k - d2 + 0.5D, (double)i + d2 + 0.5D, (double)((float)jx + this.b.length), (double)k + d2 + 0.5D);
                    if (!this.b.world.getCubes((Entity)null, axisalignedbb1)) {
                        return null;
                    }

                    if (this.b.width >= 1.0F) {
                        PathType pathtype1 = this.a(this.b, i, jx - 1, k);
                    ...
                    while(jx > 0 && pathtype == PathType.OPEN) {
                        --jx;
                        if (i1++ >= this.b.bn()) {
                            return null;
                        }
    ...
    public PathType a(IBlockAccess iblockaccess, int i, int jx, int k, EntityInsentient entityinsentient, int l, int i1, int j1, boolean flag, boolean flag1) {
        ...
        pathtype = this.a(iblockaccess, i, jx, k, l, i1, j1, flag, flag1, enumset, pathtype, blockposition);
    ...
    public PathType a(IBlockAccess iblockaccess, int i, int jx, int k, int l, int i1, int j1, boolean flag, boolean flag1, EnumSet<PathType> enumset, PathType pathtype, BlockPosition blockposition) {
    ...
    private PathType a(EntityInsentient entityinsentient, int i, int jx, int k) {
        return this.a(this.a, i, jx, k, entityinsentient, this.d, this.e, this.f, this.d(), this.c());
    }
    ...
    public PathType a(IBlockAccess iblockaccess, int i, int jx, int k) {
        ...
        pathtype = this.a(iblockaccess, i, jx, k, pathtype);
        return pathtype;
    }

    public PathType a(IBlockAccess iblockaccess, int i, int jx, int k, PathType pathtype) {
        if (pathtype == PathType.WALKABLE) {
    ...
    protected PathType b(IBlockAccess iblockaccess, int i, int jx, int k) {
        ...
        if (iblockdata.isAir()) {
            ...
            if (block == Blocks.FIRE) {
            ...
            } else if (block instanceof BlockDoor && material == Material.WOOD && !iblockdata.get(BlockDoor.OPEN)) {
                return PathType.DOOR_WOOD_CLOSED;
            } else if (block instanceof BlockDoor && material == Material.ORE && !iblockdata.get(BlockDoor.OPEN)) {
            ...
            } else if (!(block instanceof BlockFence) && !(block instanceof BlockCobbleWall) && (!(block instanceof BlockFenceGate) || iblockdata.get(BlockFenceGate.OPEN))) {
                ...
                if (fluid.a(TagsFluid.WATER)) {
                    ...
                    return iblockdata.a(iblockaccess, blockposition, PathMode.LAND) ? PathType.OPEN : PathType.BLOCKED;
                }
            } else {
                return PathType.FENCE;
            }
