    ...
    static class PathfinderGoalGhastMoveTowardsTarget extends PathfinderGoal {
        ...
        public void e() {
            if (this.a.getGoalTarget() == null) {
                this.a.yaw = -((float)MathHelper.c(this.a.motX, this.a.motZ)) * (180F / (float)Math.PI);
                ...
                if (entityliving.h(this.a) < 4096.0D) {
                    ...
                    this.a.yaw = -((float)MathHelper.c(d1, d2)) * (180F / (float)Math.PI);
                    this.a.aQ = this.a.yaw;
                }
            }
