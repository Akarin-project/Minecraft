...
public class ArgumentParserSelector {
    ...
    public static final BiConsumer<Vec3D, List<? extends Entity>> g = (var0, var1) -> {
    };
    ...
    public static final BiConsumer<Vec3D, List<? extends Entity>> j = (var0, list) -> {
        Collections.shuffle(list);
    };
    public static final BiFunction<SuggestionsBuilder, Consumer<SuggestionsBuilder>, CompletableFuture<Suggestions>> k = (suggestionsbuilder, var1) -> {
    ...
    public EntitySelector a() {
        ...
        if (this.v == null && this.w == null && this.x == null) {
            if (this.q.b() != null) {
                float fx = this.q.b();
                axisalignedbb = new AxisAlignedBB((double)(-fx), (double)(-fx), (double)(-fx), (double)(fx + 1.0F), (double)(fx + 1.0F), (double)(fx + 1.0F));
            } else {
                axisalignedbb = null;
            }
        } else {
    ...
    private Predicate<Entity> a(CriterionConditionRange criterionconditionrange, ToDoubleFunction<Entity> todoublefunction) {
        ...
        return (entity) -> {
            double d4 = MathHelper.g(todoublefunction.applyAsDouble(entity));
            if (d0 > d1) {
                return d4 >= d0 || d4 <= d1;
            } else {
                return d4 >= d0 && d4 <= d1;
    ...
    protected void b() throws CommandSyntaxException {
        ...
        if (!this.l.canRead()) {
            ...
            if (c0 == 'p') {
                ...
                if (c0 != 'e') {
                    this.l.setCursor(ix);
                    throw b.createWithContext(this.l, '@' + String.valueOf(c0));
                }
    ...
    protected void c() throws CommandSyntaxException {
        ...
        int ix = this.l.getCursor();
        String sx = this.l.readString();

        try {
            this.F = UUID.fromString(sx);
            this.o = true;
        } catch (IllegalArgumentException var4) {
            if (sx.isEmpty() || sx.length() > 16) {
                this.l.setCursor(ix);
    ...
    protected void d() throws CommandSyntaxException {
        ...
        while(true) {
            if (this.l.canRead() && this.l.peek() != ']') {
                ...
                int ix = this.l.getCursor();
                String sx = this.l.readString();
                PlayerSelector.a playerselector$a = PlayerSelector.a(this, sx, ix);
                this.l.skipWhitespace();
                if (!this.l.canRead() || this.l.peek() != '=') {
                    this.l.setCursor(ix);
                    throw f.createWithContext(this.l, sx);
                }

                this.l.skip();
                this.l.skipWhitespace();
                this.G = k;
                playerselector$a.handle(this);
                this.l.skipWhitespace();
                this.G = this::h;
                if (!this.l.canRead()) {
                    continue;
    ...
    public void a(CriterionConditionValue.c criterionconditionvalue$c) {
        this.q = criterionconditionvalue$c;
    }
    ...
    public void a(CriterionConditionValue.d criterionconditionvalue$d) {
        this.r = criterionconditionvalue$d;
    }
    ...
    private CompletableFuture<Suggestions> d(SuggestionsBuilder suggestionsbuilder, Consumer<SuggestionsBuilder> var2) {
    ...
    private CompletableFuture<Suggestions> e(SuggestionsBuilder suggestionsbuilder, Consumer<SuggestionsBuilder> var2) {
        suggestionsbuilder.suggest(String.valueOf('['));
        return suggestionsbuilder.buildFuture();
    }

    private CompletableFuture<Suggestions> f(SuggestionsBuilder suggestionsbuilder, Consumer<SuggestionsBuilder> var2) {
        suggestionsbuilder.suggest(String.valueOf(']'));
        PlayerSelector.a(this, suggestionsbuilder);
        return suggestionsbuilder.buildFuture();
    }

    private CompletableFuture<Suggestions> g(SuggestionsBuilder suggestionsbuilder, Consumer<SuggestionsBuilder> var2) {
        PlayerSelector.a(this, suggestionsbuilder);
        return suggestionsbuilder.buildFuture();
    }

    private CompletableFuture<Suggestions> h(SuggestionsBuilder suggestionsbuilder, Consumer<SuggestionsBuilder> var2) {
        suggestionsbuilder.suggest(String.valueOf(','));
        suggestionsbuilder.suggest(String.valueOf(']'));
        return suggestionsbuilder.buildFuture();
    }
