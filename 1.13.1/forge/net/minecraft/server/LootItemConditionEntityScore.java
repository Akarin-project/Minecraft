...
public class LootItemConditionEntityScore implements LootItemCondition {
    ...
    public LootItemConditionEntityScore(Map<String, LootValueBounds> map, LootTableInfo.EntityTarget loottableinfo$entitytarget) {
        this.a = map;
    ...
    public boolean a(Random var1, LootTableInfo loottableinfo) {
        ...
        if (entity == null) {
            ...
            for(Entry entry : this.a.entrySet()) {
                if (!this.a(entity, scoreboard, (String)entry.getKey(), (LootValueBounds)entry.getValue())) {
                    return false;
                }
            }
    ...
    public static class a extends LootItemCondition.a<LootItemConditionEntityScore> {
        ...
        public void a(JsonObject jsonobject, LootItemConditionEntityScore lootitemconditionentityscore, JsonSerializationContext jsonserializationcontext) {
            ...
            for(Entry entry : lootitemconditionentityscore.a.entrySet()) {
