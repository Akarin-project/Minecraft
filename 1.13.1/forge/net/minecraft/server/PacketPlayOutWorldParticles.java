...
public class PacketPlayOutWorldParticles implements Packet<PacketListenerPlayOut> {
    ...
    public <T extends ParticleParam> PacketPlayOutWorldParticles(T particleparam, boolean flag, float fx, float f1, float f2, float f3, float f4, float f5, float f6, int ix) {
        this.j = particleparam;
        this.i = flag;
        this.a = fx;
        this.b = f1;
        this.c = f2;
    ...
    public void a(PacketDataSerializer packetdataserializer) throws IOException {
        Object object = IRegistry.PARTICLE_TYPE.fromId(packetdataserializer.readInt());
        if (object == null) {
            object = Particles.c;
        }
    ...
    public void b(PacketDataSerializer packetdataserializer) throws IOException {
        packetdataserializer.writeInt(IRegistry.PARTICLE_TYPE.a(this.j.b()));
