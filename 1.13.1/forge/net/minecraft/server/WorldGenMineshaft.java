...
public class WorldGenMineshaft extends StructureGenerator<WorldGenMineshaftConfiguration> {
    ...
    public static class a extends StructureStart {
        ...
        public a(GeneratorAccess generatoraccess, ChunkGenerator<?> chunkgenerator, SeededRandom seededrandom, int i, int j, BiomeBase biomebase) {
            ...
            WorldGenMineshaftPieces.WorldGenMineshaftRoom worldgenmineshaftpieces$worldgenmineshaftroom = new WorldGenMineshaftPieces.WorldGenMineshaftRoom(0, seededrandom, (i << 4) + 2, (j << 4) + 2, this.e);
            this.a.add(worldgenmineshaftpieces$worldgenmineshaftroom);
            worldgenmineshaftpieces$worldgenmineshaftroom.a(worldgenmineshaftpieces$worldgenmineshaftroom, this.a, seededrandom);
