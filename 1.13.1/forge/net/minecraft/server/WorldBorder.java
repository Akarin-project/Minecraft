...
public class WorldBorder {
    ...
    public void transitionSizeBetween(double d0, double d1, long ix) {
        this.i = (WorldBorder.a)(d0 != d1 ? new WorldBorder.b(d0, d1, ix) : new WorldBorder.c(d1));

        for(IWorldBorderListener iworldborderlistener : this.k()) {
            iworldborderlistener.a(this, d0, d1, ix);
        }
    ...
    public void setWarningTime(int ix) {
        this.d = ix;

        for(IWorldBorderListener iworldborderlistener : this.k()) {
            iworldborderlistener.a(this, ix);
        }
    ...
    public void setWarningDistance(int ix) {
        this.e = ix;

        for(IWorldBorderListener iworldborderlistener : this.k()) {
            iworldborderlistener.b(this, ix);
        }
