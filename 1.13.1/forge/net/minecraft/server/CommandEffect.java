...
public class CommandEffect {
    ...
    public static void a(com.mojang.brigadier.CommandDispatcher<CommandListenerWrapper> commanddispatcher) {
        commanddispatcher.register((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)CommandDispatcher.a("effect").requires((commandlistenerwrapper) -> {
            return commandlistenerwrapper.hasPermission(2);
        })).then(CommandDispatcher.a("clear").then(((RequiredArgumentBuilder)CommandDispatcher.a("targets", ArgumentEntity.b()).executes((commandcontext) -> {
            return a((CommandListenerWrapper)commandcontext.getSource(), ArgumentEntity.b(commandcontext, "targets"));
        })).then(CommandDispatcher.a("effect", ArgumentMobEffect.a()).executes((commandcontext) -> {
        ...
        }))))).then(CommandDispatcher.a("give").then(CommandDispatcher.a("targets", ArgumentEntity.b()).then(((RequiredArgumentBuilder)CommandDispatcher.a("effect", ArgumentMobEffect.a()).executes((commandcontext) -> {
        ...
        })).then(((RequiredArgumentBuilder)CommandDispatcher.a("seconds", IntegerArgumentType.integer(1, 1000000)).executes((commandcontext) -> {
        ...
        })).then(((RequiredArgumentBuilder)CommandDispatcher.a("amplifier", IntegerArgumentType.integer(0, 255)).executes((commandcontext) -> {
        ...
        })).then(CommandDispatcher.a("hideParticles", BoolArgumentType.bool()).executes((commandcontext) -> {
