...
public final class BiomeJungleEdge extends BiomeBase {
    public BiomeJungleEdge() {
        super((new BiomeBase.a()).a(new WorldGenSurfaceComposite(au, ai)).a(BiomeBase.Precipitation.RAIN).a(BiomeBase.Geography.JUNGLE).a(0.1F).b(0.2F).c(0.95F).d(0.8F).a(4159204).b(329011).a((String)null));
        ...
        this.a(WorldGenStage.Decoration.VEGETAL_DECORATION, a(WorldGenerator.ap, new WorldGenFeatureRandomChoiceConfiguration(new WorldGenerator[]{WorldGenerator.s, WorldGenerator.v}, new WorldGenFeatureConfiguration[]{WorldGenFeatureConfiguration.e, WorldGenFeatureConfiguration.e}, new float[]{0.1F, 0.5F}, WorldGenerator.w, WorldGenFeatureConfiguration.e), s, new WorldGenDecoratorFrequencyExtraChanceConfiguration(2, 0.1F, 1)));
        this.a(WorldGenStage.Decoration.VEGETAL_DECORATION, a(WorldGenerator.G, i, new WorldGenDecoratorFrequencyConfiguration(4)));
        this.a(WorldGenStage.Decoration.VEGETAL_DECORATION, a(WorldGenerator.K, WorldGenFeatureConfiguration.e, j, new WorldGenDecoratorFrequencyConfiguration(25)));
        ...
        this.a(WorldGenStage.Decoration.VEGETAL_DECORATION, a(WorldGenerator.X, WorldGenFeatureConfiguration.e, j, new WorldGenDecoratorFrequencyConfiguration(1)));
        this.a(WorldGenStage.Decoration.VEGETAL_DECORATION, a(WorldGenerator.ab, WorldGenFeatureConfiguration.e, k, new WorldGenDecoratorFrequencyConfiguration(50)));
