...
public class ItemWorldMap extends ItemWorldMapBase {
    public ItemWorldMap(Item.Info item$info) {
        super(item$info);
    }
    ...
    public static WorldMap getSavedMap(ItemStack itemstack, World world) {
        WorldMap worldmap = a(world, "map_" + e(itemstack));
    ...
    private static WorldMap a(ItemStack itemstack, World world, int i, int j, int k, boolean flag, boolean flag1, DimensionManager dimensionmanager) {
        ...
        world.a(DimensionManager.OVERWORLD, worldmap.getId(), worldmap);
    ...
    public void a(World world, Entity entity, WorldMap worldmap) {
        if (world.worldProvider.getDimensionManager() == worldmap.map && entity instanceof EntityHuman) {
            ...
            WorldMap.WorldMapHumanTracker worldmap$worldmaphumantracker = worldmap.a((EntityHuman)entity);
                                        ...
                                        for(int j4 = 0; j4 < i; ++j4) {
                                            ...
                                            if (k4 <= 1) {
                                                ...
                                                while(true) {
                                                    ...
                                                    blockposition$mutableblockposition.c((chunk.locX << 4) + i4 + i3, k4, (chunk.locZ << 4) + j4 + j3);
                                                    if (iblockdata.d(world, blockposition$mutableblockposition) != MaterialMapColor.b || k4 <= 0) {
                                                        break;
                                                    }
                                                }
                                                ...
                                                if (k4 > 0 && !iblockdata.s().e()) {
                                                    ...
                                                    while(true) {
                                                        IBlockData iblockdata1 = chunk.getBlockData(i4 + i3, l4--, j4 + j3);
                                                        ++k3;
                                                        if (l4 <= 0 || iblockdata1.s().e()) {
                                                            break;
                                                        }
                                                    }

                                                    iblockdata = this.a(world, iblockdata, blockposition$mutableblockposition);
                                                }
                                            }

                                            worldmap.a(world, (chunk.locX << 4) + i4 + i3, (chunk.locZ << 4) + j4 + j3);
                                            d1 += (double)k4 / (double)(i * i);
                                            linkedhashmultiset.add(iblockdata.d(world, blockposition$mutableblockposition));
                                        }
                                    }
                                }
    ...
    public void a(ItemStack itemstack, World world, Entity entity, int var4, boolean flag) {
    ...
    public void b(ItemStack itemstack, World world, EntityHuman var3) {
        NBTTagCompound nbttagcompound = itemstack.getTag();
