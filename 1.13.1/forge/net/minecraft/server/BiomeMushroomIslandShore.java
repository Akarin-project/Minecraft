...
public final class BiomeMushroomIslandShore extends BiomeBase {
    public BiomeMushroomIslandShore() {
        super((new BiomeBase.a()).a(new WorldGenSurfaceComposite(au, ar)).a(BiomeBase.Precipitation.RAIN).a(BiomeBase.Geography.MUSHROOM).a(0.0F).b(0.025F).c(0.9F).d(1.0F).a(4159204).b(329011).a((String)null));
        ...
        this.a(WorldGenStage.Decoration.VEGETAL_DECORATION, a(WorldGenerator.ar, new WorldGenFeatureChoiceConfiguration(WorldGenerator.T, WorldGenFeatureConfiguration.e, WorldGenerator.U, WorldGenFeatureConfiguration.e), g, new WorldGenDecoratorFrequencyConfiguration(1)));
