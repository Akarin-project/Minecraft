...
public class EntityTropicalFish extends EntityFish {
    ...
    private static int a(EntityTropicalFish.Variant entitytropicalfish$variant, EnumColor enumcolor, EnumColor enumcolor1) {
        return entitytropicalfish$variant.a() & 255 | (entitytropicalfish$variant.b() & 255) << 8 | (enumcolor.getColorIndex() & 255) << 16 | (enumcolor1.getColorIndex() & 255) << 24;
    }
    ...
    public GroupDataEntity prepare(DifficultyDamageScaler difficultydamagescaler, @Nullable GroupDataEntity groupdataentity, @Nullable NBTTagCompound nbttagcompound) {
        ...
        if (nbttagcompound != null && nbttagcompound.hasKeyOfType("BucketVariantTag", 3)) {
            ...
            int k;
            int l;
            if (groupdataentity instanceof EntityTropicalFish.b) {
                EntityTropicalFish.b entitytropicalfish$b = (EntityTropicalFish.b)groupdataentity;
                i = entitytropicalfish$b.a;
                j = entitytropicalfish$b.b;
                k = entitytropicalfish$b.c;
                l = entitytropicalfish$b.d;
            } else if ((double)this.random.nextFloat() < 0.9D) {
                int i1 = b[this.random.nextInt(b.length)];
                i = i1 & 255;
                j = (i1 & '\uff00') >> 8;
                k = (i1 & 16711680) >> 16;
                l = (i1 & -16777216) >> 24;
                groupdataentity = new EntityTropicalFish.b(i, j, k, l);
            } else {
                this.bF = false;
