...
public class ArgumentVectorPosition implements IVectorPosition {
    ...
    public Vec3D a(CommandListenerWrapper commandlistenerwrapper) {
        ...
        float f = MathHelper.cos((vec2f.j + 90.0F) * ((float)Math.PI / 180F));
        float f1 = MathHelper.sin((vec2f.j + 90.0F) * ((float)Math.PI / 180F));
        float f2 = MathHelper.cos(-vec2f.i * ((float)Math.PI / 180F));
        float f3 = MathHelper.sin(-vec2f.i * ((float)Math.PI / 180F));
        float f4 = MathHelper.cos((-vec2f.i + 90.0F) * ((float)Math.PI / 180F));
        float f5 = MathHelper.sin((-vec2f.i + 90.0F) * ((float)Math.PI / 180F));
    ...
    public Vec2F b(CommandListenerWrapper var1) {
        return Vec2F.a;
    }
    ...
    public boolean equals(Object object) {
        if (this == object) {
            ...
            ArgumentVectorPosition argumentvectorposition1 = (ArgumentVectorPosition)object;
            return this.a == argumentvectorposition1.a && this.b == argumentvectorposition1.b && this.c == argumentvectorposition1.c;
        }
    }
