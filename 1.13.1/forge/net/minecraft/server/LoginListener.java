...
public class LoginListener implements PacketLoginInListener, ITickable {
    ...
    public void disconnect(IChatBaseComponent ichatbasecomponent) {
        try {
            c.info("Disconnecting {}: {}", this.c(), ichatbasecomponent.getString());
    ...
    public void b() {
        ...
        if (ichatbasecomponent != null) {
            ...
            if (this.server.aw() >= 0 && !this.networkManager.isLocal()) {
                this.networkManager.sendPacket(new PacketLoginOutSetCompression(this.server.aw()), (var1) -> {
    ...
    public void a(IChatBaseComponent ichatbasecomponent) {
        c.info("{} lost connection: {}", this.c(), ichatbasecomponent.getString());
    }
