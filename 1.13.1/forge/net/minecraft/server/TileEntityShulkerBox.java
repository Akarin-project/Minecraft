...
public class TileEntityShulkerBox extends TileEntityLootable implements IWorldInventory, ITickable {
    ...
    public TileEntityShulkerBox(@Nullable EnumColor enumcolor) {
        ...
        this.e = NonNullList.<ItemStack>a(27, ItemStack.a);
    ...
    public void f(NBTTagCompound nbttagcompound) {
        this.e = NonNullList.<ItemStack>a(this.getSize(), ItemStack.a);
    ...
    public boolean canPlaceItemThroughFace(int var1, ItemStack itemstack, @Nullable EnumDirection var3) {
    ...
    public float a(float fx) {
        return this.m + (this.l - this.m) * fx;
    }
