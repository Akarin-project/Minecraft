...
public final class BiomeSavanna extends BiomeBase {
    protected BiomeSavanna() {
        super((new BiomeBase.a()).a(new WorldGenSurfaceComposite(au, ai)).a(BiomeBase.Precipitation.NONE).a(BiomeBase.Geography.SAVANNA).a(0.125F).b(0.05F).c(1.2F).d(0.0F).a(4159204).b(329011).a((String)null));
        this.a(WorldGenerator.e, new WorldGenFeatureVillageConfiguration(0, WorldGenVillagePieces.Material.ACACIA));
        ...
        this.a(WorldGenStage.Decoration.VEGETAL_DECORATION, a(WorldGenerator.aj, new WorldGenFeatureDoublePlantConfiguration(Blocks.TALL_GRASS.getBlockData()), i, new WorldGenDecoratorFrequencyConfiguration(7)));
