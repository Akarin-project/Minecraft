...
public class WorldGenNether extends StructureGenerator<WorldGenNetherConfiguration> {
    ...
    public static class a extends StructureStart {
        ...
        public a(GeneratorAccess generatoraccess, SeededRandom seededrandom, int i, int j, BiomeBase biomebase) {
            ...
            WorldGenNetherPieces.WorldGenNetherPiece15 worldgennetherpieces$worldgennetherpiece15 = new WorldGenNetherPieces.WorldGenNetherPiece15(seededrandom, (i << 4) + 2, (j << 4) + 2);
            this.a.add(worldgennetherpieces$worldgennetherpiece15);
            worldgennetherpieces$worldgennetherpiece15.a(worldgennetherpieces$worldgennetherpiece15, this.a, seededrandom);
            List list = worldgennetherpieces$worldgennetherpiece15.d;

            while(!list.isEmpty()) {
                int k = seededrandom.nextInt(list.size());
                StructurePiece structurepiece = (StructurePiece)list.remove(k);
                structurepiece.a(worldgennetherpieces$worldgennetherpiece15, this.a, seededrandom);
            }
