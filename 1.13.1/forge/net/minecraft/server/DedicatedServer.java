...
public class DedicatedServer extends MinecraftServer implements IMinecraftServer {
    ...
    public DedicatedServer(File file1, DataFixer datafixer, YggdrasilAuthenticationService yggdrasilauthenticationservice, MinecraftSessionService minecraftsessionservice, GameProfileRepository gameprofilerepository, UserCache usercache) {
        super(file1, Proxy.NO_PROXY, datafixer, new CommandDispatcher(true), yggdrasilauthenticationservice, minecraftsessionservice, gameprofilerepository, usercache);
    ...
    protected boolean init() throws IOException {
            ...
            public void run() {
                ...
                try {
                    while(!DedicatedServer.this.isStopped() && DedicatedServer.this.isRunning() && (s4 = bufferedreader.readLine()) != null) {
                        DedicatedServer.this.issueCommand(s4, DedicatedServer.this.getServerCommandListener());
                    }
        ...
        thread.start();
        LOGGER.info("Starting minecraft server version 1.13.1");
        ...
        if (!this.n.a()) {
            ...
            LOGGER.info("Starting Minecraft server on {}:{}", this.getServerIp().isEmpty() ? "*" : this.getServerIp(), this.F());
            ...
            if (!NameReferencingFileConverter.a(this.propertyManager)) {
                ...
                LOGGER.info("Preparing level \"{}\"", this.getWorld());
                ...
                if (this.aY() > 0L) {
                    ...
                    thread1.setUncaughtExceptionHandler(new ThreadNamedUncaughtExceptionHandler(LOGGER));
    ...
    public String aT() {
        ...
        if (!s.isEmpty() && !h.matcher(s).matches()) {
    ...
    public boolean a(EnumGamemode var1, boolean var2, int var3) {
        return false;
    }
    ...
    public boolean a(World world, BlockPosition blockposition, EntityHuman entityhuman) {
        if (world.worldProvider.getDimensionManager() != DimensionManager.OVERWORLD) {
            ...
            int jx = MathHelper.a(blockposition.getZ() - blockposition1.getZ());
            int k = Math.max(i, jx);
