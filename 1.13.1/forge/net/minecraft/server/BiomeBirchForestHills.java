...
public final class BiomeBirchForestHills extends BiomeBase {
    public BiomeBirchForestHills() {
        super((new BiomeBase.a()).a(new WorldGenSurfaceComposite(au, ai)).a(BiomeBase.Precipitation.RAIN).a(BiomeBase.Geography.FOREST).a(0.45F).b(0.3F).c(0.6F).d(0.6F).a(4159204).b(329011).a((String)null));
        ...
        this.a(WorldGenStage.Decoration.VEGETAL_DECORATION, a(WorldGenerator.t, WorldGenFeatureConfiguration.e, s, new WorldGenDecoratorFrequencyExtraChanceConfiguration(10, 0.1F, 1)));
