...
public class EntityChicken extends EntityAnimal {
    ...
    protected void n() {
        ...
        this.goalSelector.a(3, new PathfinderGoalTempt(this, 1.0D, false, bK));
    ...
    public void k(Entity entity) {
        super.k(entity);
        float f = MathHelper.sin(this.aQ * ((float)Math.PI / 180F));
        float f1 = MathHelper.cos(this.aQ * ((float)Math.PI / 180F));
        float f2 = 0.1F;
        float f3 = 0.0F;
