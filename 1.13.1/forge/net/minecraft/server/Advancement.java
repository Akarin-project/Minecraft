...
public class Advancement {
    ...
    public Advancement(MinecraftKey minecraftkey, @Nullable Advancement advancement1, @Nullable AdvancementDisplay advancementdisplay, AdvancementRewards advancementrewards, Map<String, Criterion> map, String[][] astring) {
        this.d = minecraftkey;
    ...
    public void a(Advancement advancement1) {
        this.g.add(advancement1);
    }
    ...
    public boolean equals(Object object) {
        if (this == object) {
            ...
            Advancement advancement1 = (Advancement)object;
            return this.d.equals(advancement1.d);
        }
    }
    ...
    public static class SerializedAdvancement {
        ...
        public Advancement.SerializedAdvancement a(AdvancementRewards.a advancementrewards$a) {
            return this.a(advancementrewards$a.a());
        }
        ...
        public void a(PacketDataSerializer packetdataserializer) {
            ...
            for(String[] astring : this.f) {
                packetdataserializer.d(astring.length);
