...
public class StructureBoundingBox {
    ...
    public StructureBoundingBox(StructureBoundingBox structureboundingbox1) {
        this.a = structureboundingbox1.a;
        this.b = structureboundingbox1.b;
        this.c = structureboundingbox1.c;
        this.d = structureboundingbox1.d;
        this.e = structureboundingbox1.e;
        this.f = structureboundingbox1.f;
    }
    ...
    public boolean a(StructureBoundingBox structureboundingbox1) {
        return this.d >= structureboundingbox1.a && this.a <= structureboundingbox1.d && this.f >= structureboundingbox1.c && this.c <= structureboundingbox1.f && this.e >= structureboundingbox1.b && this.b <= structureboundingbox1.e;
    }
    ...
    public void b(StructureBoundingBox structureboundingbox1) {
        this.a = Math.min(this.a, structureboundingbox1.a);
        this.b = Math.min(this.b, structureboundingbox1.b);
        this.c = Math.min(this.c, structureboundingbox1.c);
        this.d = Math.max(this.d, structureboundingbox1.d);
        this.e = Math.max(this.e, structureboundingbox1.e);
        this.f = Math.max(this.f, structureboundingbox1.f);
    }
