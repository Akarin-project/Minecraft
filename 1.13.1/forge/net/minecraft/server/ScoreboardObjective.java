...
public class ScoreboardObjective {
    ...
    public ScoreboardObjective(Scoreboard scoreboard, String s, IScoreboardCriteria iscoreboardcriteria, IChatBaseComponent ichatbasecomponent, IScoreboardCriteria.EnumScoreboardHealthDisplay iscoreboardcriteria$enumscoreboardhealthdisplay) {
        this.a = scoreboard;
        this.b = s;
        this.c = iscoreboardcriteria;
        this.displayName = ichatbasecomponent;
        this.e = iscoreboardcriteria$enumscoreboardhealthdisplay;
    }
    ...
    public void a(IScoreboardCriteria.EnumScoreboardHealthDisplay iscoreboardcriteria$enumscoreboardhealthdisplay) {
        this.e = iscoreboardcriteria$enumscoreboardhealthdisplay;
        this.a.handleObjectiveChanged(this);
    }
}
