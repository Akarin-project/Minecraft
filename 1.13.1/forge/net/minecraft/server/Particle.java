...
public class Particle<T extends ParticleParam> {
    ...
    protected Particle(MinecraftKey minecraftkey, boolean flag, ParticleParam.a<T> particleparam$a) {
        this.a = minecraftkey;
        this.b = flag;
        this.c = particleparam$a;
    }
    ...
    private static void a(String s, boolean flag) {
        IRegistry.PARTICLE_TYPE.a(new MinecraftKey(s), new ParticleType(new MinecraftKey(s), flag));
    }

    private static <T extends ParticleParam> void a(String s, boolean flag, ParticleParam.a<T> particleparam$a) {
        IRegistry.PARTICLE_TYPE.a(new MinecraftKey(s), new Particle<ParticleParam>(new MinecraftKey(s), flag, particleparam$a));
    }
}
