...
public class EntityEnderman extends EntityMonster {
    ...
    private static final AttributeModifier b = (new AttributeModifier(a, "Attacking speed boost", (double)0.15F, 0)).a(false);
    ...
    protected void x_() {
        super.x_();
        this.datawatcher.register(c, Optional.empty());
    ...
    public void a(DataWatcherObject<?> datawatcherobject) {
        if (bC.equals(datawatcherobject) && this.dB() && this.world.isClientSide) {
            this.l();
        }
    ...
    public void setCarried(@Nullable IBlockData iblockdata) {
        this.datawatcher.set(c, Optional.ofNullable(iblockdata));
    }

    @Nullable
    public IBlockData getCarried() {
        return (IBlockData)((Optional)this.datawatcher.get(c)).orElse((Object)null);
    }
    ...
    static class PathfinderGoalEndermanPlaceBlock extends PathfinderGoal {
        ...
        public boolean a() {
            if (this.a.getCarried() == null) {
                return false;
            } else if (!this.a.world.getGameRules().getBoolean("mobGriefing")) {
                return false;
            } else {
                return this.a.getRandom().nextInt(2000) == 0;
            }
        }
