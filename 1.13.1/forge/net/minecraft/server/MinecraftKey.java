...
public class MinecraftKey implements Comparable<MinecraftKey> {
    ...
    public boolean equals(Object object) {
        if (this == object) {
            ...
            MinecraftKey minecraftkey1 = (MinecraftKey)object;
            return this.a.equals(minecraftkey1.a) && this.b.equals(minecraftkey1.b);
        }
    }
    ...
    public int a(MinecraftKey minecraftkey1) {
        int i = this.b.compareTo(minecraftkey1.b);
        if (i == 0) {
            i = this.a.compareTo(minecraftkey1.a);
        }
    ...
    public static class a implements JsonDeserializer<MinecraftKey>, JsonSerializer<MinecraftKey> {
        ...
        public MinecraftKey a(JsonElement jsonelement, Type var2, JsonDeserializationContext var3) throws JsonParseException {
            return new MinecraftKey(ChatDeserializer.a(jsonelement, "location"));
        }

        public JsonElement a(MinecraftKey minecraftkey, Type var2, JsonSerializationContext var3) {
