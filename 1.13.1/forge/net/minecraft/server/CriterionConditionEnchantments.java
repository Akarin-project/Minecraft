...
public class CriterionConditionEnchantments {
    ...
    public CriterionConditionEnchantments(@Nullable Enchantment enchantment, CriterionConditionValue.d criterionconditionvalue$d) {
        this.b = enchantment;
        this.c = criterionconditionvalue$d;
    }
    ...
    public static CriterionConditionEnchantments a(@Nullable JsonElement jsonelement) {
        if (jsonelement != null && !jsonelement.isJsonNull()) {
            ...
            if (jsonobject.has("enchantment")) {
                ...
                enchantment = IRegistry.ENCHANTMENT.get(minecraftkey);
                if (enchantment == null) {
            ...
            return new CriterionConditionEnchantments(enchantment, criterionconditionvalue$d);
        } else {
            return a;
        }
    }
