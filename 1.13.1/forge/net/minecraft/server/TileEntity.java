...
public abstract class TileEntity {
    ...
    public void setWorld(World worldx) {
        this.world = worldx;
    }
    ...
    public static TileEntity create(NBTTagCompound nbttagcompound) {
        ...
        try {
            ...
            a.error("Failed to create block entity {}", s, throwable1);
        }
        ...
        if (tileentity != null) {
            try {
                ...
                a.error("Failed to load data for block entity {}", s, throwable);
                tileentity = null;
            }
        } else {
            a.warn("Skipping BlockEntity with id {}", s);
        }
    ...
    public void a(EnumBlockRotation var1) {
    }

    public void a(EnumBlockMirror var1) {
    }
