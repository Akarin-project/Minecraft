...
public class BiomeCache {
    ...
    private final LoadingCache<ChunkCoordIntPair, BiomeCache.a> b = CacheBuilder.newBuilder().expireAfterAccess(30000L, TimeUnit.MILLISECONDS).build(new CacheLoader<ChunkCoordIntPair, BiomeCache.a>() {
