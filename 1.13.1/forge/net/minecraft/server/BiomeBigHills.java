...
public final class BiomeBigHills extends BiomeBase {
    protected BiomeBigHills() {
        super((new BiomeBase.a()).a(new WorldGenSurfaceComposite(av, ai)).a(BiomeBase.Precipitation.RAIN).a(BiomeBase.Geography.EXTREME_HILLS).a(1.0F).b(0.5F).c(0.2F).d(0.3F).a(4159204).b(329011).a((String)null));
