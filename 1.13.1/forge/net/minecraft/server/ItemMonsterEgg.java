...
public class ItemMonsterEgg extends Item {
    ...
    public ItemMonsterEgg(EntityTypes<?> entitytypes, int i, int j, Item.Info item$info) {
        super(item$info);
        this.d = entitytypes;
        this.b = i;
        this.c = j;
        ...
        if (world.isClientSide) {
            ...
            if (block == Blocks.SPAWNER) {
                ...
                if (tileentity instanceof TileEntityMobSpawner) {
                    ...
                    if (entitytypes1 != null) {
                        mobspawnerabstract.setMobName(entitytypes1);
                        tileentity.update();
            ...
            if (entitytypes == null || entitytypes.a(world, itemstack, itemactioncontext.getEntity(), blockposition1, true, !Objects.equals(blockposition, blockposition1) && enumdirection == EnumDirection.UP) != null) {
                itemstack.subtract(1);
            }
