...
public class ItemMinecart extends Item {
    ...
    public ItemMinecart(EntityMinecartAbstract.EnumMinecartType entityminecartabstract$enumminecarttype, Item.Info item$info) {
        super(item$info);
        this.b = entityminecartabstract$enumminecarttype;
