...
public class ItemAxe extends ItemTool {
    ...
    protected ItemAxe(ToolMaterial toolmaterial, float f, float f1, Item.Info item$info) {
        super(f, f1, toolmaterial, e, item$info);
    }

    public float getDestroySpeed(ItemStack itemstack, IBlockData iblockdata) {
        Material material = iblockdata.getMaterial();
        return material != Material.WOOD && material != Material.PLANT && material != Material.REPLACEABLE_PLANT ? super.getDestroySpeed(itemstack, iblockdata) : this.b;
    }
    ...
    public EnumInteractionResult a(ItemActionContext itemactioncontext) {
        ...
        Block block = (Block)a.get(iblockdata.getBlock());
        if (block != null) {
