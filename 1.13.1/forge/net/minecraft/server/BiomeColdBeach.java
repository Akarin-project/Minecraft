...
public final class BiomeColdBeach extends BiomeBase {
    public BiomeColdBeach() {
        super((new BiomeBase.a()).a(new WorldGenSurfaceComposite(au, ap)).a(BiomeBase.Precipitation.SNOW).a(BiomeBase.Geography.BEACH).a(0.0F).b(0.025F).c(0.05F).d(0.3F).a(4020182).b(329011).a((String)null));
        this.a(WorldGenerator.f, new WorldGenMineshaftConfiguration(0.004D, WorldGenMineshaft.Type.NORMAL));
        this.a(WorldGenerator.r, new WorldGenBuriedTreasureConfiguration(0.01F));
        this.a(WorldGenerator.k, new WorldGenFeatureShipwreckConfiguration(true));
