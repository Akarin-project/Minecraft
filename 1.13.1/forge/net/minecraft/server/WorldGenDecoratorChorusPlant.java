...
public class WorldGenDecoratorChorusPlant extends WorldGenDecorator<WorldGenFeatureDecoratorEmptyConfiguration> {
    ...
    public <C extends WorldGenFeatureConfiguration> boolean a(GeneratorAccess generatoraccess, ChunkGenerator<? extends GeneratorSettings> chunkgenerator, Random random, BlockPosition blockposition, WorldGenFeatureDecoratorEmptyConfiguration var5, WorldGenerator<C> worldgenerator, C worldgenfeatureconfiguration) {
        ...
        for(int j = 0; j < i; ++j) {
            ...
            if (i1 > 0) {
                int j1 = i1 - 1;
                flag |= worldgenerator.generate(generatoraccess, chunkgenerator, random, new BlockPosition(blockposition.getX() + k, j1, blockposition.getZ() + l), worldgenfeatureconfiguration);
            }
        }
