...
public class DebugReportRecipeShapeless {
    ...
    public void a(Consumer<DebugReportRecipeData> consumer, MinecraftKey minecraftkey) {
        this.a(minecraftkey);
        this.e.a(new MinecraftKey("minecraft:recipes/root")).a("has_the_recipe", new CriterionTriggerRecipeUnlocked.b(minecraftkey)).a(AdvancementRewards.a.c(minecraftkey)).a(AdvancementRequirements.OR);
    ...
    public static class a implements DebugReportRecipeData {
        ...
        public a(MinecraftKey minecraftkey, Item item, int i, String s, List<RecipeItemStack> list, Advancement.SerializedAdvancement advancement$serializedadvancement, MinecraftKey minecraftkey1) {
            this.a = minecraftkey;
            this.b = item;
            this.c = i;
            this.d = s;
            this.e = list;
            this.f = advancement$serializedadvancement;
        ...
        public JsonObject a() {
            ...
            for(RecipeItemStack recipeitemstack : this.e) {
