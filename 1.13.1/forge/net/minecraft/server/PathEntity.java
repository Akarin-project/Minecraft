...
public class PathEntity {
    ...
    public boolean a(PathEntity pathentity1) {
        if (pathentity1 == null) {
            return false;
        } else if (pathentity1.a.length != this.a.length) {
            return false;
        } else {
            for(int i = 0; i < this.a.length; ++i) {
                if (this.a[i].a != pathentity1.a[i].a || this.a[i].b != pathentity1.a[i].b || this.a[i].c != pathentity1.a[i].c) {
                    return false;
                }
            }
