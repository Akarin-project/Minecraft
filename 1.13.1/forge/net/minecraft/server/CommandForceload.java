...
public class CommandForceload {
    ...
    public static void a(com.mojang.brigadier.CommandDispatcher<CommandListenerWrapper> commanddispatcher) {
        commanddispatcher.register((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)CommandDispatcher.a("forceload").requires((commandlistenerwrapper) -> {
            return commandlistenerwrapper.hasPermission(4);
        })).then(CommandDispatcher.a("add").then(((RequiredArgumentBuilder)CommandDispatcher.a("from", ArgumentVec2I.a()).executes((commandcontext) -> {
        ...
        })).then(CommandDispatcher.a("to", ArgumentVec2I.a()).executes((commandcontext) -> {
        ...
        }))))).then(((LiteralArgumentBuilder)CommandDispatcher.a("remove").then(((RequiredArgumentBuilder)CommandDispatcher.a("from", ArgumentVec2I.a()).executes((commandcontext) -> {
        ...
        })).then(CommandDispatcher.a("pos", ArgumentVec2I.a()).executes((commandcontext) -> {
            return a((CommandListenerWrapper)commandcontext.getSource(), ArgumentVec2I.a(commandcontext, "pos"));
        }))));
    }

    private static int a(CommandListenerWrapper commandlistenerwrapper, ArgumentVec2I.a argumentvec2i$a) throws CommandSyntaxException {
        ChunkCoordIntPair chunkcoordintpair = new ChunkCoordIntPair(argumentvec2i$a.a >> 4, argumentvec2i$a.b >> 4);
    ...
    private static int a(CommandListenerWrapper commandlistenerwrapper, ArgumentVec2I.a argumentvec2i$a, ArgumentVec2I.a argumentvec2i$a1, boolean flag) throws CommandSyntaxException {
        int i = Math.min(argumentvec2i$a.a, argumentvec2i$a1.a);
        int j = Math.min(argumentvec2i$a.b, argumentvec2i$a1.b);
        int k = Math.max(argumentvec2i$a.a, argumentvec2i$a1.a);
        int l = Math.max(argumentvec2i$a.b, argumentvec2i$a1.b);
