...
public abstract class BlockMinecartTrackAbstract extends Block {
    ...
    protected BlockMinecartTrackAbstract(boolean flag, Block.Info block$info) {
        super(block$info);
        this.c = flag;
    }
    ...
    public VoxelShape a(IBlockData iblockdata, IBlockAccess var2, BlockPosition var3) {
        ...
        return blockpropertytrackposition != null && blockpropertytrackposition.c() ? b : a;
    }
    ...
    protected void a(IBlockData var1, World var2, BlockPosition var3, Block var4) {
    }
