...
public class EntityPufferFish extends EntityFish {
    ...
    private static final Predicate<EntityLiving> bD = (entityliving) -> {
        if (entityliving == null) {
            return false;
        } else if (!(entityliving instanceof EntityHuman) || !((EntityHuman)entityliving).isSpectator() && !((EntityHuman)entityliving).u()) {
    ...
    public void k() {
        super.k();
        if (this.getPuffState() > 0) {
            for(EntityInsentient entityinsentient : this.world.a(EntityInsentient.class, this.getBoundingBox().g(0.3D), bD)) {
