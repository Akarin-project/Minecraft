...
public class CriterionConditionDamageSource {
    ...
    public boolean a(EntityPlayer entityplayer, DamageSource damagesource) {
        if (this == a) {
            return true;
        } else if (this.b != null && this.b != damagesource.b()) {
            return false;
        } else if (this.c != null && this.c != damagesource.isExplosion()) {
            return false;
        } else if (this.d != null && this.d != damagesource.ignoresArmor()) {
            return false;
        } else if (this.e != null && this.e != damagesource.ignoresInvulnerability()) {
            return false;
        } else if (this.f != null && this.f != damagesource.isStarvation()) {
            return false;
        } else if (this.g != null && this.g != damagesource.p()) {
            return false;
        } else if (this.h != null && this.h != damagesource.isMagic()) {
            return false;
        } else if (!this.i.a(entityplayer, damagesource.j())) {
            return false;
        } else {
            return this.j.a(entityplayer, damagesource.getEntity());
        }
    }
    ...
    public static class a {
        ...
        private Boolean f;
        private Boolean g;
        private CriterionConditionEntity h = CriterionConditionEntity.a;
        private CriterionConditionEntity i = CriterionConditionEntity.a;
        ...
        public CriterionConditionDamageSource.a a(CriterionConditionEntity.a criterionconditionentity$a) {
            this.h = criterionconditionentity$a.b();
            return this;
        }
