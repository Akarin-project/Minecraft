...
public class PathfinderGoalWaterJump extends PathfinderGoal {
    ...
    public boolean a() {
        if (this.b.getRandom().nextInt(this.c) != 0) {
            ...
            for(int k : a) {
                if (!this.a(blockposition, i, j, k) || !this.b(blockposition, i, j, k)) {
                    return false;
                }
            }
    ...
    public boolean b() {
        return (!(this.b.motY * this.b.motY < (double)0.03F) || this.b.pitch == 0.0F || !(Math.abs(this.b.pitch) < 10.0F) || !this.b.isInWater()) && !this.b.onGround;
    }
    ...
    public void e() {
        ...
        if (this.b.motY * this.b.motY < (double)0.03F && this.b.pitch != 0.0F) {
            this.b.pitch = this.a(this.b.pitch, 0.0F, 0.2F);
        } else {
            double d2 = Math.sqrt(this.b.motX * this.b.motX + this.b.motY * this.b.motY + this.b.motZ * this.b.motZ);
            double d0 = Math.sqrt(this.b.motX * this.b.motX + this.b.motZ * this.b.motZ);
            double d1 = Math.signum(-this.b.motY) * Math.acos(d0 / d2) * (double)(180F / (float)Math.PI);
