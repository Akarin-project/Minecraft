...
public class EntityEvoker extends EntityIllagerWizard {
    ...
    public boolean r(Entity entity) {
        if (entity == null) {
            ...
            return true;
        } else if (super.r(entity)) {
            return true;
        } else if (entity instanceof EntityVex) {
            return this.r(((EntityVex)entity).l());
    ...
    class a extends EntityIllagerWizard.c {
        ...
        protected void j() {
            ...
            if (EntityEvoker.this.h(entityliving) < 9.0D) {
                ...
                for(int k = 0; k < 8; ++k) {
                    ...
                    this.a(EntityEvoker.this.locX + (double)MathHelper.cos(f2) * 2.5D, EntityEvoker.this.locZ + (double)MathHelper.sin(f2) * 2.5D, d0, d1, f2, 3);
                }
            } else {
                for(int l = 0; l < 16; ++l) {
        ...
        private void a(double d0, double d1, double d2, double d3, float f, int i) {
            ...
            while(true) {
                ...
                if (blockposition.getY() < MathHelper.floor(d2) - 1) {
                    break;
                }
            }
