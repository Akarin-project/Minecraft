...
public final class BiomeMushrooms extends BiomeBase {
    public BiomeMushrooms() {
        super((new BiomeBase.a()).a(new WorldGenSurfaceComposite(au, ar)).a(BiomeBase.Precipitation.RAIN).a(BiomeBase.Geography.MUSHROOM).a(0.2F).b(0.3F).c(0.9F).d(1.0F).a(4159204).b(329011).a((String)null));
