...
public final class BiomeSunflowerPlains extends BiomeBase {
    protected BiomeSunflowerPlains() {
        super((new BiomeBase.a()).a(new WorldGenSurfaceComposite(au, ai)).a(BiomeBase.Precipitation.RAIN).a(BiomeBase.Geography.PLAINS).a(0.125F).b(0.05F).c(0.8F).d(0.4F).a(4159204).b(329011).a("plains"));
        ...
        this.a(WorldGenStage.Decoration.VEGETAL_DECORATION, a(WorldGenerator.aj, new WorldGenFeatureDoublePlantConfiguration(Blocks.TALL_GRASS.getBlockData()), l, new WorldGenFeatureDecoratorNoiseConfiguration(-0.8D, 0, 7)));
        this.a(WorldGenStage.Decoration.VEGETAL_DECORATION, a(WorldGenerator.aj, new WorldGenFeatureDoublePlantConfiguration(Blocks.SUNFLOWER.getBlockData()), i, new WorldGenDecoratorFrequencyConfiguration(10)));
        ...
        this.a(WorldGenStage.Decoration.VEGETAL_DECORATION, a(WorldGenerator.ap, new WorldGenFeatureRandomChoiceConfiguration(new WorldGenerator[]{WorldGenerator.s}, new WorldGenFeatureConfiguration[]{WorldGenFeatureConfiguration.e}, new float[]{0.33333334F}, WorldGenerator.C, WorldGenFeatureConfiguration.e), s, new WorldGenDecoratorFrequencyExtraChanceConfiguration(0, 0.05F, 1)));
        this.a(WorldGenStage.Decoration.VEGETAL_DECORATION, a(WorldGenerator.I, l, new WorldGenFeatureDecoratorNoiseConfiguration(-0.8D, 15, 4)));
        this.a(WorldGenStage.Decoration.VEGETAL_DECORATION, a(WorldGenerator.M, new WorldGenFeatureTallGrassConfiguration(Blocks.GRASS.getBlockData()), m, new WorldGenFeatureDecoratorNoiseConfiguration(-0.8D, 5, 10)));
