...
public class PathfinderGoalLlamaFollow extends PathfinderGoal {
    ...
    public boolean a() {
        if (!this.a.isLeashed() && !this.a.em()) {
            ...
            for(EntityLlama entityllama1 : list) {
                if (entityllama1.em() && !entityllama1.el()) {
                    double d1 = this.a.h(entityllama1);
                    if (!(d1 > d0)) {
                        d0 = d1;
            ...
            if (entityllama == null) {
                for(EntityLlama entityllama2 : list) {
                    if (entityllama2.isLeashed() && !entityllama2.el()) {
                        double d2 = this.a.h(entityllama2);
                        if (!(d2 > d0)) {
                            d0 = d2;
    ...
    public void e() {
        if (this.a.em()) {
            EntityLlama entityllama = this.a.en();
            double d0 = (double)this.a.g(entityllama);
            float f = 2.0F;
    ...
    private boolean a(EntityLlama entityllama, int i) {
        if (i > 8) {
            return false;
        } else if (entityllama.em()) {
            if (entityllama.en().isLeashed()) {
                return true;
            } else {
                EntityLlama entityllama1 = entityllama.en();
                ++i;
