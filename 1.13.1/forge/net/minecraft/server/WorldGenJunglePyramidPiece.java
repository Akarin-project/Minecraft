...
public class WorldGenJunglePyramidPiece extends WorldGenScatteredPiece {
    ...
    public WorldGenJunglePyramidPiece(Random random, int ix, int j) {
        super(random, ix, 64, j, 12, 10, 15);
    }
    ...
    public boolean a(GeneratorAccess generatoraccess, Random random, StructureBoundingBox structureboundingbox, ChunkCoordIntPair var4) {
        if (!this.a(generatoraccess, structureboundingbox, 0)) {
            ...
            this.a(generatoraccess, structureboundingbox, 0, -4, 0, this.a - 1, 0, this.c - 1, false, random, i);
            this.a(generatoraccess, structureboundingbox, 2, 1, 2, 9, 2, 2, false, random, i);
            this.a(generatoraccess, structureboundingbox, 2, 1, 12, 9, 2, 12, false, random, i);
            this.a(generatoraccess, structureboundingbox, 2, 1, 3, 2, 2, 11, false, random, i);
            this.a(generatoraccess, structureboundingbox, 9, 1, 3, 9, 2, 11, false, random, i);
            this.a(generatoraccess, structureboundingbox, 1, 3, 1, 10, 6, 1, false, random, i);
            this.a(generatoraccess, structureboundingbox, 1, 3, 13, 10, 6, 13, false, random, i);
            this.a(generatoraccess, structureboundingbox, 1, 3, 2, 1, 6, 12, false, random, i);
            this.a(generatoraccess, structureboundingbox, 10, 3, 2, 10, 6, 12, false, random, i);
            this.a(generatoraccess, structureboundingbox, 2, 3, 2, 9, 3, 12, false, random, i);
            this.a(generatoraccess, structureboundingbox, 2, 6, 2, 9, 6, 12, false, random, i);
            this.a(generatoraccess, structureboundingbox, 3, 7, 3, 8, 7, 11, false, random, i);
            this.a(generatoraccess, structureboundingbox, 4, 8, 4, 7, 8, 10, false, random, i);
            ...
            for(int ix = 0; ix <= 14; ix += 14) {
                this.a(generatoraccess, structureboundingbox, 2, 4, ix, 2, 5, ix, false, random, i);
                this.a(generatoraccess, structureboundingbox, 4, 4, ix, 4, 5, ix, false, random, i);
                this.a(generatoraccess, structureboundingbox, 7, 4, ix, 7, 5, ix, false, random, i);
                this.a(generatoraccess, structureboundingbox, 9, 4, ix, 9, 5, ix, false, random, i);
            }

            this.a(generatoraccess, structureboundingbox, 5, 6, 0, 6, 6, 0, false, random, i);

            for(int l = 0; l <= 11; l += 11) {
                for(int j = 2; j <= 12; j += 2) {
                    this.a(generatoraccess, structureboundingbox, l, 4, j, l, 5, j, false, random, i);
                }

                this.a(generatoraccess, structureboundingbox, l, 6, 5, l, 6, 5, false, random, i);
                this.a(generatoraccess, structureboundingbox, l, 6, 9, l, 6, 9, false, random, i);
            }

            this.a(generatoraccess, structureboundingbox, 2, 7, 2, 2, 9, 2, false, random, i);
            this.a(generatoraccess, structureboundingbox, 9, 7, 2, 9, 9, 2, false, random, i);
            this.a(generatoraccess, structureboundingbox, 2, 7, 12, 2, 9, 12, false, random, i);
            this.a(generatoraccess, structureboundingbox, 9, 7, 12, 9, 9, 12, false, random, i);
            this.a(generatoraccess, structureboundingbox, 4, 9, 4, 4, 9, 4, false, random, i);
            this.a(generatoraccess, structureboundingbox, 7, 9, 4, 7, 9, 4, false, random, i);
            this.a(generatoraccess, structureboundingbox, 4, 9, 10, 4, 9, 10, false, random, i);
            this.a(generatoraccess, structureboundingbox, 7, 9, 10, 7, 9, 10, false, random, i);
            this.a(generatoraccess, structureboundingbox, 5, 9, 7, 6, 9, 7, false, random, i);
            IBlockData iblockdata3 = (IBlockData)Blocks.COBBLESTONE_STAIRS.getBlockData().set(BlockStairs.FACING, EnumDirection.EAST);
            IBlockData iblockdata4 = (IBlockData)Blocks.COBBLESTONE_STAIRS.getBlockData().set(BlockStairs.FACING, EnumDirection.WEST);
            IBlockData iblockdata = (IBlockData)Blocks.COBBLESTONE_STAIRS.getBlockData().set(BlockStairs.FACING, EnumDirection.SOUTH);
            IBlockData iblockdata1 = (IBlockData)Blocks.COBBLESTONE_STAIRS.getBlockData().set(BlockStairs.FACING, EnumDirection.NORTH);
            this.a(generatoraccess, iblockdata1, 5, 9, 6, structureboundingbox);
            this.a(generatoraccess, iblockdata1, 6, 9, 6, structureboundingbox);
            this.a(generatoraccess, iblockdata, 5, 9, 8, structureboundingbox);
            this.a(generatoraccess, iblockdata, 6, 9, 8, structureboundingbox);
            this.a(generatoraccess, iblockdata1, 4, 0, 0, structureboundingbox);
            this.a(generatoraccess, iblockdata1, 5, 0, 0, structureboundingbox);
            this.a(generatoraccess, iblockdata1, 6, 0, 0, structureboundingbox);
            this.a(generatoraccess, iblockdata1, 7, 0, 0, structureboundingbox);
            this.a(generatoraccess, iblockdata1, 4, 1, 8, structureboundingbox);
            this.a(generatoraccess, iblockdata1, 4, 2, 9, structureboundingbox);
            this.a(generatoraccess, iblockdata1, 4, 3, 10, structureboundingbox);
            this.a(generatoraccess, iblockdata1, 7, 1, 8, structureboundingbox);
            this.a(generatoraccess, iblockdata1, 7, 2, 9, structureboundingbox);
            this.a(generatoraccess, iblockdata1, 7, 3, 10, structureboundingbox);
            this.a(generatoraccess, structureboundingbox, 4, 1, 9, 4, 1, 9, false, random, i);
            this.a(generatoraccess, structureboundingbox, 7, 1, 9, 7, 1, 9, false, random, i);
            this.a(generatoraccess, structureboundingbox, 4, 1, 10, 7, 2, 10, false, random, i);
            this.a(generatoraccess, structureboundingbox, 5, 4, 5, 6, 4, 5, false, random, i);
            this.a(generatoraccess, iblockdata3, 4, 4, 5, structureboundingbox);
            this.a(generatoraccess, iblockdata4, 7, 4, 5, structureboundingbox);

            for(int k = 0; k < 4; ++k) {
                this.a(generatoraccess, iblockdata, 5, 0 - k, 6 + k, structureboundingbox);
                this.a(generatoraccess, iblockdata, 6, 0 - k, 6 + k, structureboundingbox);
            ...
            for(int i1 = 1; i1 <= 13; i1 += 2) {
                this.a(generatoraccess, structureboundingbox, 1, -3, i1, 1, -2, i1, false, random, i);
            }

            for(int j1 = 2; j1 <= 12; j1 += 2) {
                this.a(generatoraccess, structureboundingbox, 1, -1, j1, 3, -1, j1, false, random, i);
            }

            this.a(generatoraccess, structureboundingbox, 2, -2, 1, 5, -2, 1, false, random, i);
            this.a(generatoraccess, structureboundingbox, 7, -2, 1, 9, -2, 1, false, random, i);
            this.a(generatoraccess, structureboundingbox, 6, -3, 1, 6, -3, 1, false, random, i);
            this.a(generatoraccess, structureboundingbox, 6, -1, 1, 6, -1, 1, false, random, i);
            ...
            IBlockData iblockdata5 = (IBlockData)((IBlockData)Blocks.REDSTONE_WIRE.getBlockData().set(BlockRedstoneWire.NORTH, BlockPropertyRedstoneSide.SIDE)).set(BlockRedstoneWire.SOUTH, BlockPropertyRedstoneSide.SIDE);
            ...
            this.a(generatoraccess, iblockdata5, 5, -3, 6, structureboundingbox);
            this.a(generatoraccess, iblockdata5, 5, -3, 5, structureboundingbox);
            this.a(generatoraccess, iblockdata5, 5, -3, 4, structureboundingbox);
            this.a(generatoraccess, iblockdata5, 5, -3, 3, structureboundingbox);
            this.a(generatoraccess, iblockdata5, 5, -3, 2, structureboundingbox);
            ...
            this.a(generatoraccess, structureboundingbox, 9, -1, 1, 9, -1, 5, false, random, i);
            ...
            IBlockData iblockdata2 = (IBlockData)((IBlockData)Blocks.LEVER.getBlockData().set(BlockLever.FACING, EnumDirection.NORTH)).set(BlockLever.FACE, BlockPropertyAttachPosition.WALL);
            this.a(generatoraccess, iblockdata2, 8, -2, 12, structureboundingbox);
            this.a(generatoraccess, iblockdata2, 9, -2, 12, structureboundingbox);
            this.a(generatoraccess, iblockdata2, 10, -2, 12, structureboundingbox);
            this.a(generatoraccess, structureboundingbox, 8, -3, 8, 8, -3, 10, false, random, i);
            this.a(generatoraccess, structureboundingbox, 10, -3, 8, 10, -3, 10, false, random, i);
    ...
    static class a extends StructurePiece.StructurePieceBlockSelector {
        ...
        public void a(Random random, int var2, int var3, int var4, boolean var5) {
