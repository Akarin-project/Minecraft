...
public class ArgumentBlockPredicate implements ArgumentType<ArgumentBlockPredicate.b> {
    ...
    public ArgumentBlockPredicate.b a(StringReader stringreader) throws CommandSyntaxException {
        ...
        if (argumentblock.b() != null) {
            ArgumentBlockPredicate.a argumentblockpredicate$a = new ArgumentBlockPredicate.a(argumentblock.b(), argumentblock.a().keySet(), argumentblock.c());
            return (var1) -> {
    ...
    public interface b {
        Predicate<ShapeDetectorBlock> create(TagRegistry var1) throws CommandSyntaxException;
    }
