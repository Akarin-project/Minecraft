...
public class DataConverterRegistry {
    ...
    private static final DataFixer d = b();

    private static DataFixer b() {
        ExecutorService executorservice = Executors.newCachedThreadPool((new ThreadFactoryBuilder()).setUncaughtExceptionHandler((var0, throwable) -> {
            a.error("Unable to build datafixers", throwable);
    ...
    private static void a(DataFixerBuilder datafixerbuilder) {
        ...
        Schema schema2 = datafixerbuilder.addSchema(101, b);
        ...
        Schema schema4 = datafixerbuilder.addSchema(105, b);
        ...
        Schema schema14 = datafixerbuilder.addSchema(147, b);
        datafixerbuilder.addFixer(new DataConverterArmorStand(schema14, true));
        Schema schema15 = datafixerbuilder.addSchema(165, b);
        ...
        Schema schema17 = datafixerbuilder.addSchema(502, b);
        ...
        Schema schema18 = datafixerbuilder.addSchema(505, b);
        ...
        Schema schema25 = datafixerbuilder.addSchema(804, c);
        datafixerbuilder.addFixer(new DataConverterBanner(schema25, true));
        Schema schema26 = datafixerbuilder.addSchema(806, c);
        ...
        Schema schema28 = datafixerbuilder.addSchema(808, 1, c);
        datafixerbuilder.addFixer(new DataConverterShulker(schema28, false));
        Schema schema29 = datafixerbuilder.addSchema(813, c);
        ...
        Schema schema30 = datafixerbuilder.addSchema(816, c);
        datafixerbuilder.addFixer(new DataConverterLang(schema30, false));
        Schema schema31 = datafixerbuilder.addSchema(820, c);
        ...
        Schema schema34 = datafixerbuilder.addSchema(1344, c);
        datafixerbuilder.addFixer(new DataConverterKeybind(schema34, false));
        Schema schema35 = datafixerbuilder.addSchema(1446, c);
        datafixerbuilder.addFixer(new DataConverterKeybind2(schema35, false));
        Schema schema36 = datafixerbuilder.addSchema(1450, c);
        ...
        Schema schema45 = datafixerbuilder.addSchema(1451, 7, c);
        datafixerbuilder.addFixer(new DataConverterVillagerTrade(schema45, false));
        Schema schema46 = datafixerbuilder.addSchema(1456, c);
        datafixerbuilder.addFixer(new DataConverterItemFrame(schema46, false));
        Schema schema47 = datafixerbuilder.addSchema(1458, c);
        ...
        Schema schema51 = datafixerbuilder.addSchema(1474, c);
        ...
        Schema schema52 = datafixerbuilder.addSchema(1475, c);
        ...
        Schema schema53 = datafixerbuilder.addSchema(1480, c);
        ...
        Schema schema56 = datafixerbuilder.addSchema(1484, c);
        ...
        Schema schema58 = datafixerbuilder.addSchema(1487, c);
        ...
        Schema schema59 = datafixerbuilder.addSchema(1488, c);
        ...
        Schema schema60 = datafixerbuilder.addSchema(1490, c);
        ...
        Schema schema70 = datafixerbuilder.addSchema(1514, c);
        ...
        Schema schema71 = datafixerbuilder.addSchema(1515, c);
        ...
        Schema schema72 = datafixerbuilder.addSchema(1624, c);
