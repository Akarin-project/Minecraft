...
public class WorldChunkManagerTheEnd extends WorldChunkManager {
    ...
    private final BiomeBase[] e = new BiomeBase[]{Biomes.k, Biomes.R, Biomes.Q, Biomes.P, Biomes.S};
    ...
    private BiomeBase a(int i, int j) {
        if ((long)i * (long)i + (long)j * (long)j <= 4096L) {
            ...
            if (f > 40.0F) {
                ...
                return f < -20.0F ? Biomes.P : Biomes.S;
            }
        }
    }
    ...
    public float c(int i, int j, int k, int l) {
        ...
        for(int i1 = -12; i1 <= 12; ++i1) {
            for(int j1 = -12; j1 <= 12; ++j1) {
                long k1 = (long)(i + i1);
                long l1 = (long)(j + j1);
                if (k1 * k1 + l1 * l1 > 4096L && this.c.a((double)k1, (double)l1) < (double)-0.9F) {
    ...
    public boolean a(StructureGenerator<?> structuregenerator) {
        return this.a.computeIfAbsent(structuregenerator, (structuregenerator1) -> {
            for(BiomeBase biomebase : this.e) {
